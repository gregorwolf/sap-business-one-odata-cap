 ...
 */
export declare class BusinessPlaces extends Entity implements BusinessPlacesType {
    /**
...
export declare namespace BusinessPlaces {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BUSINESS_PLACE_IE_NUMBERS: CollectionField<BusinessPlaces>;
    /**
     * Static representation of the [[businessPlaceTributaryInfos]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const BUSINESS_PLACE_TRIBUTARY_INFOS: CollectionField<BusinessPlaces>;
    /**
