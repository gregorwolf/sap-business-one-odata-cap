...
var ServiceGroups = /** @class */ (function (_super) {
    ...
    ServiceGroups.builder = function () {
        return v4_1.Entity.entityBuilder(ServiceGroups);
    };
    /**
    ...
    ServiceGroups.customField = function (fieldName) {
        return v4_1.Entity.customFieldSelector(fieldName, ServiceGroups);
    };
    /**
     ...
     */
    ServiceGroups._serviceName = 'SAPB1';
    /**
     * Default url path for the according service.
     */
    ServiceGroups._defaultServicePath = 'VALUE_IS_UNDEFINED';
...
(function (ServiceGroups) {
     ...
     */
    ServiceGroups.ABS_ENTRY = new v4_1.NumberField('AbsEntry', ServiceGroups, 'Edm.Int32');
    /**
     * Static representation of the [[serviceGroupCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ServiceGroups.SERVICE_GROUP_CODE = new v4_1.StringField('ServiceGroupCode', ServiceGroups, 'Edm.String');
    /**
     * Static representation of the [[description]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ServiceGroups.DESCRIPTION = new v4_1.StringField('Description', ServiceGroups, 'Edm.String');
    /**
     * Static representation of the one-to-many navigation property [[items]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ServiceGroups.ITEMS = new v4_1.OneToManyLink('Items', ServiceGroups, Items_1.Items);
    /**
     ...
     * All fields selector.
     */
    ServiceGroups.ALL_FIELDS = new v4_1.AllFields('*', ServiceGroups);
    /**
