...
var KnowledgeBaseSolutionParamsField = /** @class */ (function (_super) {
     ...
     */
    function KnowledgeBaseSolutionParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, KnowledgeBaseSolutionParams) || this;
        /**
         * Representation of the [[KnowledgeBaseSolutionParams.solutionCode]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.solutionCode = new core_1.ComplexTypeNumberPropertyField('SolutionCode', _this, 'Edm.Int32');
        return _this;
    }
...
(function (KnowledgeBaseSolutionParams) {
     ...
     */
    KnowledgeBaseSolutionParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, KnowledgeBaseSolutionParams);
    }
