...
var ProjectsRequestBuilder = /** @class */ (function (_super) {
    ...
    ProjectsRequestBuilder.prototype.getByKey = function (code) {
        return new core_1.GetByKeyRequestBuilderV4(Projects_1.Projects, { Code: code });
    };
    /**
    ...
    ProjectsRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(Projects_1.Projects);
    };
    /**
    ...
    ProjectsRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(Projects_1.Projects, entity);
    };
    /**
    ...
    ProjectsRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(Projects_1.Projects, entity);
    };
    ProjectsRequestBuilder.prototype.delete = function (codeOrEntity) {
        return new core_1.DeleteRequestBuilderV4(Projects_1.Projects, codeOrEntity instanceof Projects_1.Projects ? codeOrEntity : { Code: codeOrEntity });
    };
