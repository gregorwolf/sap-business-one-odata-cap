...
var TaxCodeDeterminations = /** @class */ (function (_super) {
    ...
    TaxCodeDeterminations.builder = function () {
        return v4_1.Entity.entityBuilder(TaxCodeDeterminations);
    };
    /**
    ...
    TaxCodeDeterminations.customField = function (fieldName) {
        return v4_1.Entity.customFieldSelector(fieldName, TaxCodeDeterminations);
    };
    /**
     ...
     */
    TaxCodeDeterminations._serviceName = 'SAPB1';
    /**
     * Default url path for the according service.
     */
    TaxCodeDeterminations._defaultServicePath = 'VALUE_IS_UNDEFINED';
...
(function (TaxCodeDeterminations) {
     ...
     */
    TaxCodeDeterminations.DOC_ENTRY = new v4_1.NumberField('DocEntry', TaxCodeDeterminations, 'Edm.Int32');
    /**
     * Static representation of the [[lineNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.LINE_NUMBER = new v4_1.NumberField('LineNumber', TaxCodeDeterminations, 'Edm.Int32');
    /**
     * Static representation of the [[udfTable1]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.UDF_TABLE_1 = new v4_1.StringField('UDFTable1', TaxCodeDeterminations, 'Edm.String');
    /**
     * Static representation of the [[numberValue1]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.NUMBER_VALUE_1 = new v4_1.NumberField('NumberValue1', TaxCodeDeterminations, 'Edm.Int32');
    /**
     * Static representation of the [[stringValue1]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.STRING_VALUE_1 = new v4_1.StringField('StringValue1', TaxCodeDeterminations, 'Edm.String');
    /**
     * Static representation of the [[moneyValue1]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.MONEY_VALUE_1 = new v4_1.NumberField('MoneyValue1', TaxCodeDeterminations, 'Edm.Double');
    /**
     * Static representation of the [[udfTable2]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.UDF_TABLE_2 = new v4_1.StringField('UDFTable2', TaxCodeDeterminations, 'Edm.String');
    /**
     * Static representation of the [[numberValue2]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.NUMBER_VALUE_2 = new v4_1.NumberField('NumberValue2', TaxCodeDeterminations, 'Edm.Int32');
    /**
     * Static representation of the [[stringValue2]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.STRING_VALUE_2 = new v4_1.StringField('StringValue2', TaxCodeDeterminations, 'Edm.String');
    /**
     * Static representation of the [[moneyValue2]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.MONEY_VALUE_2 = new v4_1.NumberField('MoneyValue2', TaxCodeDeterminations, 'Edm.Double');
    /**
     * Static representation of the [[udfTable3]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.UDF_TABLE_3 = new v4_1.StringField('UDFTable3', TaxCodeDeterminations, 'Edm.String');
    /**
     * Static representation of the [[numberValue3]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.NUMBER_VALUE_3 = new v4_1.NumberField('NumberValue3', TaxCodeDeterminations, 'Edm.Int32');
    /**
     * Static representation of the [[stringValue3]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.STRING_VALUE_3 = new v4_1.StringField('StringValue3', TaxCodeDeterminations, 'Edm.String');
    /**
     * Static representation of the [[moneyValue3]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.MONEY_VALUE_3 = new v4_1.NumberField('MoneyValue3', TaxCodeDeterminations, 'Edm.Double');
    /**
     * Static representation of the [[udfTable4]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.UDF_TABLE_4 = new v4_1.StringField('UDFTable4', TaxCodeDeterminations, 'Edm.String');
    /**
     * Static representation of the [[numberValue4]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.NUMBER_VALUE_4 = new v4_1.NumberField('NumberValue4', TaxCodeDeterminations, 'Edm.Int32');
    /**
     * Static representation of the [[stringValue4]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.STRING_VALUE_4 = new v4_1.StringField('StringValue4', TaxCodeDeterminations, 'Edm.String');
    /**
     * Static representation of the [[moneyValue4]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.MONEY_VALUE_4 = new v4_1.NumberField('MoneyValue4', TaxCodeDeterminations, 'Edm.Double');
    /**
     * Static representation of the [[udfTable5]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.UDF_TABLE_5 = new v4_1.StringField('UDFTable5', TaxCodeDeterminations, 'Edm.String');
    /**
     * Static representation of the [[numberValue5]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.NUMBER_VALUE_5 = new v4_1.NumberField('NumberValue5', TaxCodeDeterminations, 'Edm.Int32');
    /**
     * Static representation of the [[stringValue5]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.STRING_VALUE_5 = new v4_1.StringField('StringValue5', TaxCodeDeterminations, 'Edm.String');
    /**
     * Static representation of the [[moneyValue5]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.MONEY_VALUE_5 = new v4_1.NumberField('MoneyValue5', TaxCodeDeterminations, 'Edm.Double');
    /**
     * Static representation of the [[description]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.DESCRIPTION = new v4_1.StringField('Description', TaxCodeDeterminations, 'Edm.String');
    /**
     * Static representation of the [[taxCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.TAX_CODE = new v4_1.StringField('TaxCode', TaxCodeDeterminations, 'Edm.String');
    /**
     * Static representation of the [[freightRowTax]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.FREIGHT_ROW_TAX = new v4_1.StringField('FreightRowTax', TaxCodeDeterminations, 'Edm.String');
    /**
     * Static representation of the [[freightHeaderTax]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.FREIGHT_HEADER_TAX = new v4_1.StringField('FreightHeaderTax', TaxCodeDeterminations, 'Edm.String');
    /**
     * Static representation of the [[udfAlias1]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.UDF_ALIAS_1 = new v4_1.StringField('UDFAlias1', TaxCodeDeterminations, 'Edm.String');
    /**
     * Static representation of the [[udfAlias2]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.UDF_ALIAS_2 = new v4_1.StringField('UDFAlias2', TaxCodeDeterminations, 'Edm.String');
    /**
     * Static representation of the [[udfAlias3]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.UDF_ALIAS_3 = new v4_1.StringField('UDFAlias3', TaxCodeDeterminations, 'Edm.String');
    /**
     * Static representation of the [[udfAlias4]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.UDF_ALIAS_4 = new v4_1.StringField('UDFAlias4', TaxCodeDeterminations, 'Edm.String');
    /**
     * Static representation of the [[udfAlias5]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TaxCodeDeterminations.UDF_ALIAS_5 = new v4_1.StringField('UDFAlias5', TaxCodeDeterminations, 'Edm.String');
    /**
     ...
     * All fields selector.
     */
    TaxCodeDeterminations.ALL_FIELDS = new v4_1.AllFields('*', TaxCodeDeterminations);
    /**
