...
var CreditCardPaymentParamsField = /** @class */ (function (_super) {
     ...
     */
    function CreditCardPaymentParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, CreditCardPaymentParams) || this;
        /**
         * Representation of the [[CreditCardPaymentParams.dueDateCode]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.dueDateCode = new core_1.ComplexTypeStringPropertyField('DueDateCode', _this, 'Edm.String');
        return _this;
    }
...
(function (CreditCardPaymentParams) {
     ...
     */
    CreditCardPaymentParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, CreditCardPaymentParams);
    }
