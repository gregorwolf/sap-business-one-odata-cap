...
var TechnicianSettingsGroupParamsField = /** @class */ (function (_super) {
     ...
     */
    function TechnicianSettingsGroupParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, TechnicianSettingsGroupParams) || this;
        /**
...
(function (TechnicianSettingsGroupParams) {
     ...
     */
    TechnicianSettingsGroupParams._propertyMetadata = [{
            originalName: 'Code',
            name: 'code',
            type: 'Edm.Int32',
            isCollection: false
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, TechnicianSettingsGroupParams);
    }
