...
var AssetManualDepreciationRequestBuilder = /** @class */ (function (_super) {
    ...
    AssetManualDepreciationRequestBuilder.prototype.getByKey = function (docEntry) {
        return new core_1.GetByKeyRequestBuilderV4(AssetManualDepreciation_1.AssetManualDepreciation, { DocEntry: docEntry });
    };
    /**
    ...
    AssetManualDepreciationRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(AssetManualDepreciation_1.AssetManualDepreciation);
    };
    /**
    ...
    AssetManualDepreciationRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(AssetManualDepreciation_1.AssetManualDepreciation, entity);
    };
    /**
    ...
    AssetManualDepreciationRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(AssetManualDepreciation_1.AssetManualDepreciation, entity);
    };
    AssetManualDepreciationRequestBuilder.prototype.delete = function (docEntryOrEntity) {
        return new core_1.DeleteRequestBuilderV4(AssetManualDepreciation_1.AssetManualDepreciation, docEntryOrEntity instanceof AssetManualDepreciation_1.AssetManualDepreciation ? docEntryOrEntity : { DocEntry: docEntryOrEntity });
    };
