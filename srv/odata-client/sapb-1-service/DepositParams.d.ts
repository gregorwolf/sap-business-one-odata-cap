 ...
 */
export declare class DepositParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, DepositParams> {
    /**
...
export declare namespace DepositParams {
     ...
     */
    const _propertyMetadata: PropertyMetadata<DepositParams>[];
    /**
