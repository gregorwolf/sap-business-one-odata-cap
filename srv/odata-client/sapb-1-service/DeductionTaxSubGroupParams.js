...
var DeductionTaxSubGroupParamsField = /** @class */ (function (_super) {
     ...
     */
    function DeductionTaxSubGroupParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, DeductionTaxSubGroupParams) || this;
        /**
...
(function (DeductionTaxSubGroupParams) {
     ...
     */
    DeductionTaxSubGroupParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, DeductionTaxSubGroupParams);
    }
