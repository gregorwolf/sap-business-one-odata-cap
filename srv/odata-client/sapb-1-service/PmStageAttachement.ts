 ...
 */
export class PmStageAttachementField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, PmStageAttachement> {
  /**
  ...
  constructor(fieldName: string, fieldOf: ConstructorOrField<EntityT>) {
    super(fieldName, fieldOf, PmStageAttachement);
  }
}
...
export namespace PmStageAttachement {
  ...
  export function build(json: { [keys: string]: FieldType }): PmStageAttachement {
    return deserializeComplexTypeV4(json, PmStageAttachement);
  }
}
