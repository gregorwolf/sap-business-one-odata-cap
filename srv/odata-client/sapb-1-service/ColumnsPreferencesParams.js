...
var ColumnsPreferencesParamsField = /** @class */ (function (_super) {
     ...
     */
    function ColumnsPreferencesParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, ColumnsPreferencesParams) || this;
        /**
...
(function (ColumnsPreferencesParams) {
     ...
     */
    ColumnsPreferencesParams._propertyMetadata = [{
            originalName: 'User',
            name: 'user',
            type: 'Edm.Int32',
            isCollection: false
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, ColumnsPreferencesParams);
    }
