...
var SalesOpportunitiesReasonField = /** @class */ (function (_super) {
     ...
     */
    function SalesOpportunitiesReasonField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, SalesOpportunitiesReason) || this;
        /**
         ...
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.reason = new core_1.ComplexTypeNumberPropertyField('Reason', _this, 'Edm.Int32');
        return _this;
    }
...
(function (SalesOpportunitiesReason) {
     ...
     */
    SalesOpportunitiesReason._propertyMetadata = [{
            originalName: 'RowNo',
            name: 'rowNo',
            type: 'Edm.Int32',
            isCollection: false
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, SalesOpportunitiesReason);
    }
