 ...
 */
export declare class ManufacturerParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, ManufacturerParams> {
    /**
...
export declare namespace ManufacturerParams {
     ...
     */
    const _propertyMetadata: PropertyMetadata<ManufacturerParams>[];
    /**
