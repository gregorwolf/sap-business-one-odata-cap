...
var WarehouseSublevelCodeParamsField = /** @class */ (function (_super) {
    ...
    function WarehouseSublevelCodeParamsField() {
         ...
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.warehouseSublevel = new v4_1.ComplexTypeNumberPropertyField('WarehouseSublevel', _this, 'Edm.Int32');
        /**
...
(function (WarehouseSublevelCodeParams) {
    function build(json) {
        return v4_1.createComplexType(json, {
            ...
            WarehouseSublevel: function (warehouseSublevel) { return ({ warehouseSublevel: v4_1.edmToTs(warehouseSublevel, 'Edm.Int32') }); },
