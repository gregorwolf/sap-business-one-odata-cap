...
var SalesOpportunitiesParamsField = /** @class */ (function (_super) {
    ...
    function SalesOpportunitiesParamsField() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        /**
         * Representation of the [[SalesOpportunitiesParams.sequentialNo]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.sequentialNo = new v4_1.ComplexTypeNumberPropertyField('SequentialNo', _this, 'Edm.Int32');
        return _this;
    }
...
(function (SalesOpportunitiesParams) {
    function build(json) {
        return v4_1.createComplexType(json, {
            SequentialNo: function (sequentialNo) { return ({ sequentialNo: v4_1.edmToTs(sequentialNo, 'Edm.Int32') }); }
        });
    }
