 ...
 */
export function createAssetGroupParams(json: any): AssetGroupParams {
 ...
 */
export class AssetGroupParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, AssetGroupParams> {
  /**
  ...
  constructor(fieldName: string, fieldOf: ConstructorOrField<EntityT>) {
    super(fieldName, fieldOf, AssetGroupParams);
  }
}

export namespace AssetGroupParams {
  /**
   * Metadata information on all properties of the `AssetGroupParams` complex type.
   */
  export const _propertyMetadata: PropertyMetadata<AssetGroupParams>[] = [{
    originalName: 'Code',
    name: 'code',
    type: 'Edm.String',
    isCollection: false
   ...
   */
  export function build(json: { [keys: string]: FieldType }): AssetGroupParams {
    return deserializeComplexTypeV4(json, AssetGroupParams);
  }
}
