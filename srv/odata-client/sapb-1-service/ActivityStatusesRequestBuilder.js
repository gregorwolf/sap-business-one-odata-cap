...
var ActivityStatusesRequestBuilder = /** @class */ (function (_super) {
    ...
    ActivityStatusesRequestBuilder.prototype.getByKey = function (statusId) {
        return new core_1.GetByKeyRequestBuilderV4(ActivityStatuses_1.ActivityStatuses, { StatusId: statusId });
    };
    /**
    ...
    ActivityStatusesRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(ActivityStatuses_1.ActivityStatuses);
    };
    /**
    ...
    ActivityStatusesRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(ActivityStatuses_1.ActivityStatuses, entity);
    };
    /**
    ...
    ActivityStatusesRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(ActivityStatuses_1.ActivityStatuses, entity);
    };
    ActivityStatusesRequestBuilder.prototype.delete = function (statusIdOrEntity) {
        return new core_1.DeleteRequestBuilderV4(ActivityStatuses_1.ActivityStatuses, statusIdOrEntity instanceof ActivityStatuses_1.ActivityStatuses ? statusIdOrEntity : { StatusId: statusIdOrEntity });
    };
