...
var WeightMeasuresRequestBuilder = /** @class */ (function (_super) {
    ...
    WeightMeasuresRequestBuilder.prototype.getByKey = function (unitCode) {
        return new v4_1.GetByKeyRequestBuilder(WeightMeasures_1.WeightMeasures, { UnitCode: unitCode });
    };
    /**
    ...
    WeightMeasuresRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(WeightMeasures_1.WeightMeasures);
    };
    /**
    ...
    WeightMeasuresRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(WeightMeasures_1.WeightMeasures, entity);
    };
    /**
    ...
    WeightMeasuresRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(WeightMeasures_1.WeightMeasures, entity);
    };
    WeightMeasuresRequestBuilder.prototype.delete = function (unitCodeOrEntity) {
        return new v4_1.DeleteRequestBuilder(WeightMeasures_1.WeightMeasures, unitCodeOrEntity instanceof WeightMeasures_1.WeightMeasures ? unitCodeOrEntity : { UnitCode: unitCodeOrEntity });
    };
