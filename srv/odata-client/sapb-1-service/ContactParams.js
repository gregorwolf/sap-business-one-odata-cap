...
var ContactParamsField = /** @class */ (function (_super) {
     ...
     */
    function ContactParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, ContactParams) || this;
        /**
         * Representation of the [[ContactParams.contactCode]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.contactCode = new core_1.ComplexTypeNumberPropertyField('ContactCode', _this, 'Edm.Int32');
        return _this;
    }
...
(function (ContactParams) {
     ...
     */
    ContactParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, ContactParams);
    }
