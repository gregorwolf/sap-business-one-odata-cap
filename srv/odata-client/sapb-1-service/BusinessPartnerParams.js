...
var BusinessPartnerParamsField = /** @class */ (function (_super) {
     ...
     */
    function BusinessPartnerParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, BusinessPartnerParams) || this;
        /**
...
(function (BusinessPartnerParams) {
     ...
     */
    BusinessPartnerParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, BusinessPartnerParams);
    }
