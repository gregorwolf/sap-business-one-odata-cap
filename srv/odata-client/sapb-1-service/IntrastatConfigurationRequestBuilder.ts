...
export class IntrastatConfigurationRequestBuilder extends RequestBuilder<IntrastatConfiguration> {
  ...
  getByKey(absEntry: number): GetByKeyRequestBuilder<IntrastatConfiguration> {
    return new GetByKeyRequestBuilder(IntrastatConfiguration, { AbsEntry: absEntry });
  }
  ...
  getAll(): GetAllRequestBuilder<IntrastatConfiguration> {
    return new GetAllRequestBuilder(IntrastatConfiguration);
  }
  ...
  create(entity: IntrastatConfiguration): CreateRequestBuilder<IntrastatConfiguration> {
    return new CreateRequestBuilder(IntrastatConfiguration, entity);
  }
  ...
  update(entity: IntrastatConfiguration): UpdateRequestBuilder<IntrastatConfiguration> {
    return new UpdateRequestBuilder(IntrastatConfiguration, entity);
  }
  ...
  delete(absEntryOrEntity: any): DeleteRequestBuilder<IntrastatConfiguration> {
    return new DeleteRequestBuilder(IntrastatConfiguration, absEntryOrEntity instanceof IntrastatConfiguration ? absEntryOrEntity : { AbsEntry: absEntryOrEntity! });
  }
}
