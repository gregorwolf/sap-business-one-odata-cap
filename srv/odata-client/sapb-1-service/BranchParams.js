...
var BranchParamsField = /** @class */ (function (_super) {
     ...
     */
    function BranchParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, BranchParams) || this;
        /**
...
(function (BranchParams) {
     ...
     */
    BranchParams._propertyMetadata = [{
            originalName: 'Code',
            name: 'code',
            type: 'Edm.Int32',
            isCollection: false
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, BranchParams);
    }
