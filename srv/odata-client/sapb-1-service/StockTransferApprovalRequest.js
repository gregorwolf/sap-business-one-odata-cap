...
var StockTransferApprovalRequestField = /** @class */ (function (_super) {
     ...
     */
    function StockTransferApprovalRequestField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, StockTransferApprovalRequest) || this;
        /**
...
(function (StockTransferApprovalRequest) {
     ...
     */
    StockTransferApprovalRequest._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, StockTransferApprovalRequest);
    }
