...
var AssetCapitalizationRequestBuilder = /** @class */ (function (_super) {
    ...
    AssetCapitalizationRequestBuilder.prototype.getByKey = function (docEntry) {
        return new v4_1.GetByKeyRequestBuilder(AssetCapitalization_1.AssetCapitalization, { DocEntry: docEntry });
    };
    /**
    ...
    AssetCapitalizationRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(AssetCapitalization_1.AssetCapitalization);
    };
    /**
    ...
    AssetCapitalizationRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(AssetCapitalization_1.AssetCapitalization, entity);
    };
    /**
    ...
    AssetCapitalizationRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(AssetCapitalization_1.AssetCapitalization, entity);
    };
    AssetCapitalizationRequestBuilder.prototype.delete = function (docEntryOrEntity) {
        return new v4_1.DeleteRequestBuilder(AssetCapitalization_1.AssetCapitalization, docEntryOrEntity instanceof AssetCapitalization_1.AssetCapitalization ? docEntryOrEntity : { DocEntry: docEntryOrEntity });
    };
