...
var PurchaseInvoicesRequestBuilder = /** @class */ (function (_super) {
    ...
    PurchaseInvoicesRequestBuilder.prototype.getByKey = function (docEntry) {
        return new core_1.GetByKeyRequestBuilderV4(PurchaseInvoices_1.PurchaseInvoices, { DocEntry: docEntry });
    };
    /**
    ...
    PurchaseInvoicesRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(PurchaseInvoices_1.PurchaseInvoices);
    };
    /**
    ...
    PurchaseInvoicesRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(PurchaseInvoices_1.PurchaseInvoices, entity);
    };
    /**
    ...
    PurchaseInvoicesRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(PurchaseInvoices_1.PurchaseInvoices, entity);
    };
    PurchaseInvoicesRequestBuilder.prototype.delete = function (docEntryOrEntity) {
        return new core_1.DeleteRequestBuilderV4(PurchaseInvoices_1.PurchaseInvoices, docEntryOrEntity instanceof PurchaseInvoices_1.PurchaseInvoices ? docEntryOrEntity : { DocEntry: docEntryOrEntity });
    };
