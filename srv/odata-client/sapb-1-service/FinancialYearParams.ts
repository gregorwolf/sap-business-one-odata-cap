 ...
 */
export class FinancialYearParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, FinancialYearParams> {
  /**
  ...
  constructor(fieldName: string, fieldOf: ConstructorOrField<EntityT>) {
    super(fieldName, fieldOf, FinancialYearParams);
  }
}
...
export namespace FinancialYearParams {
  ...
  export function build(json: { [keys: string]: FieldType }): FinancialYearParams {
    return deserializeComplexTypeV4(json, FinancialYearParams);
  }
}
