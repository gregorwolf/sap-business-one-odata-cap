...
var BpPrioritiesRequestBuilder = /** @class */ (function (_super) {
    ...
    BpPrioritiesRequestBuilder.prototype.getByKey = function (priority) {
        return new v4_1.GetByKeyRequestBuilder(BpPriorities_1.BpPriorities, { Priority: priority });
    };
    /**
    ...
    BpPrioritiesRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(BpPriorities_1.BpPriorities);
    };
    /**
    ...
    BpPrioritiesRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(BpPriorities_1.BpPriorities, entity);
    };
    /**
    ...
    BpPrioritiesRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(BpPriorities_1.BpPriorities, entity);
    };
    BpPrioritiesRequestBuilder.prototype.delete = function (priorityOrEntity) {
        return new v4_1.DeleteRequestBuilder(BpPriorities_1.BpPriorities, priorityOrEntity instanceof BpPriorities_1.BpPriorities ? priorityOrEntity : { Priority: priorityOrEntity });
    };
