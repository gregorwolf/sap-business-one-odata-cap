...
var EmployeeInfoParamsField = /** @class */ (function (_super) {
     ...
     */
    function EmployeeInfoParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, EmployeeInfoParams) || this;
        /**
...
(function (EmployeeInfoParams) {
     ...
     */
    EmployeeInfoParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, EmployeeInfoParams);
    }
