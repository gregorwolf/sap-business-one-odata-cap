...
var BrazilStringIndexersRequestBuilder = /** @class */ (function (_super) {
    ...
    BrazilStringIndexersRequestBuilder.prototype.getByKey = function (id) {
        return new core_1.GetByKeyRequestBuilderV4(BrazilStringIndexers_1.BrazilStringIndexers, { ID: id });
    };
    /**
    ...
    BrazilStringIndexersRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(BrazilStringIndexers_1.BrazilStringIndexers);
    };
    /**
    ...
    BrazilStringIndexersRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(BrazilStringIndexers_1.BrazilStringIndexers, entity);
    };
    /**
    ...
    BrazilStringIndexersRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(BrazilStringIndexers_1.BrazilStringIndexers, entity);
    };
    BrazilStringIndexersRequestBuilder.prototype.delete = function (idOrEntity) {
        return new core_1.DeleteRequestBuilderV4(BrazilStringIndexers_1.BrazilStringIndexers, idOrEntity instanceof BrazilStringIndexers_1.BrazilStringIndexers ? idOrEntity : { ID: idOrEntity });
    };
