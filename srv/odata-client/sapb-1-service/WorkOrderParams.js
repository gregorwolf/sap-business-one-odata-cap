...
var WorkOrderParamsField = /** @class */ (function (_super) {
     ...
     */
    function WorkOrderParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, WorkOrderParams) || this;
        /**
         * Representation of the [[WorkOrderParams.orderNum]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.orderNum = new core_1.ComplexTypeNumberPropertyField('OrderNum', _this, 'Edm.Int32');
        return _this;
    }
...
(function (WorkOrderParams) {
     ...
     */
    WorkOrderParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, WorkOrderParams);
    }
