...
var PmsOpenIssueDataField = /** @class */ (function (_super) {
     ...
     */
    function PmsOpenIssueDataField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, PmsOpenIssueData) || this;
        /**
...
(function (PmsOpenIssueData) {
     ...
     */
    PmsOpenIssueData._propertyMetadata = [{
            originalName: 'LineID',
            name: 'lineId',
            type: 'Edm.Int32',
            isCollection: false
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, PmsOpenIssueData);
    }
