...
var ServiceGroupParamsField = /** @class */ (function (_super) {
    ...
    function ServiceGroupParamsField() {
         ...
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.serviceGroupCode = new v4_1.ComplexTypeStringPropertyField('ServiceGroupCode', _this, 'Edm.String');
        return _this;
    }
...
(function (ServiceGroupParams) {
    function build(json) {
        return v4_1.createComplexType(json, {
            ...
            ServiceGroupCode: function (serviceGroupCode) { return ({ serviceGroupCode: v4_1.edmToTs(serviceGroupCode, 'Edm.String') }); }
        });
    }
