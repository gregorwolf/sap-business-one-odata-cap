...
var PaymentBlockParamsField = /** @class */ (function (_super) {
     ...
     */
    function PaymentBlockParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, PaymentBlockParams) || this;
        /**
         ...
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.paymentBlockCode = new core_1.ComplexTypeStringPropertyField('PaymentBlockCode', _this, 'Edm.String');
        return _this;
    }
...
(function (PaymentBlockParams) {
     ...
     */
    PaymentBlockParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, PaymentBlockParams);
    }
