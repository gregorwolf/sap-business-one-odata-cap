...
var BillOfExchangeTransactionParamsField = /** @class */ (function (_super) {
     ...
     */
    function BillOfExchangeTransactionParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, BillOfExchangeTransactionParams) || this;
        /**
         ...
         */
        _this.boeTransactionkey = new core_1.ComplexTypeNumberPropertyField('BOETransactionkey', _this, 'Edm.Int32');
        return _this;
    }
...
(function (BillOfExchangeTransactionParams) {
     ...
     */
    BillOfExchangeTransactionParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, BillOfExchangeTransactionParams);
    }
