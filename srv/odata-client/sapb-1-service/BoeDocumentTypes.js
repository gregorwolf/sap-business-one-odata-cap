...
var BoeDocumentTypes = /** @class */ (function (_super) {
    ...
    BoeDocumentTypes.builder = function () {
        return core_1.EntityV4.entityBuilder(BoeDocumentTypes);
    };
    /**
    ...
    BoeDocumentTypes.customField = function (fieldName) {
        return core_1.EntityV4.customFieldSelector(fieldName, BoeDocumentTypes);
    };
    /**
     ...
     */
    BoeDocumentTypes._defaultServicePath = '/b1s/v2/';
...
(function (BoeDocumentTypes) {
     ...
     */
    BoeDocumentTypes.DOC_ENTRY = new core_1.NumberField('DocEntry', BoeDocumentTypes, 'Edm.Int32');
    /**
     * Static representation of the [[docType]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BoeDocumentTypes.DOC_TYPE = new core_1.StringField('DocType', BoeDocumentTypes, 'Edm.String');
    /**
     * Static representation of the [[docDescription]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BoeDocumentTypes.DOC_DESCRIPTION = new core_1.StringField('DocDescription', BoeDocumentTypes, 'Edm.String');
    /**
     ...
     * All fields selector.
     */
    BoeDocumentTypes.ALL_FIELDS = new core_1.AllFields('*', BoeDocumentTypes);
    /**
