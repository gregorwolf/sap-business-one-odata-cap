...
var SalesTaxAuthoritiesRequestBuilder = /** @class */ (function (_super) {
    ...
    SalesTaxAuthoritiesRequestBuilder.prototype.getByKey = function (type, code) {
        return new v4_1.GetByKeyRequestBuilder(SalesTaxAuthorities_1.SalesTaxAuthorities, {
            Type: type,
            Code: code
        });
    };
    ...
    SalesTaxAuthoritiesRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(SalesTaxAuthorities_1.SalesTaxAuthorities);
    };
    /**
    ...
    SalesTaxAuthoritiesRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(SalesTaxAuthorities_1.SalesTaxAuthorities, entity);
    };
    /**
    ...
    SalesTaxAuthoritiesRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(SalesTaxAuthorities_1.SalesTaxAuthorities, entity);
    };
    SalesTaxAuthoritiesRequestBuilder.prototype.delete = function (typeOrEntity, code) {
        return new v4_1.DeleteRequestBuilder(SalesTaxAuthorities_1.SalesTaxAuthorities, typeOrEntity instanceof SalesTaxAuthorities_1.SalesTaxAuthorities ? typeOrEntity : {
            Type: typeOrEntity,
            Code: code
        });
    };
