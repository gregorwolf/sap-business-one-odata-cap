 ...
 */
export declare class ItemLocalizationInfoField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, ItemLocalizationInfo> {
    /**
...
export declare namespace ItemLocalizationInfo {
     ...
     */
    const _propertyMetadata: PropertyMetadata<ItemLocalizationInfo>[];
    /**
