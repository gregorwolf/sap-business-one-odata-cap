 ...
 */
export declare class ItemAttributeGroupsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, ItemAttributeGroups> {
    /**
...
export declare namespace ItemAttributeGroups {
     ...
     */
    const _propertyMetadata: PropertyMetadata<ItemAttributeGroups>[];
    /**
