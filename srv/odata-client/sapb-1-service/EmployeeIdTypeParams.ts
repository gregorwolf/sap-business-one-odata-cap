 ...
 */
export class EmployeeIdTypeParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, EmployeeIdTypeParams> {
  /**
  ...
  constructor(fieldName: string, fieldOf: ConstructorOrField<EntityT>) {
    super(fieldName, fieldOf, EmployeeIdTypeParams);
  }
}
...
export namespace EmployeeIdTypeParams {
  ...
  export function build(json: { [keys: string]: FieldType }): EmployeeIdTypeParams {
    return deserializeComplexTypeV4(json, EmployeeIdTypeParams);
  }
}
