...
var StockTransferParamsField = /** @class */ (function (_super) {
     ...
     */
    function StockTransferParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, StockTransferParams) || this;
        /**
...
(function (StockTransferParams) {
     ...
     */
    StockTransferParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, StockTransferParams);
    }
