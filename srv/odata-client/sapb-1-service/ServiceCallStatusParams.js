...
var ServiceCallStatusParamsField = /** @class */ (function (_super) {
     ...
     */
    function ServiceCallStatusParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, ServiceCallStatusParams) || this;
        /**
...
(function (ServiceCallStatusParams) {
     ...
     */
    ServiceCallStatusParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, ServiceCallStatusParams);
    }
