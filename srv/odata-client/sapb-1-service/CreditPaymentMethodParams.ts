 ...
 */
export class CreditPaymentMethodParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, CreditPaymentMethodParams> {
  /**
  ...
  constructor(fieldName: string, fieldOf: ConstructorOrField<EntityT>) {
    super(fieldName, fieldOf, CreditPaymentMethodParams);
  }
}
...
export namespace CreditPaymentMethodParams {
  ...
  export function build(json: { [keys: string]: FieldType }): CreditPaymentMethodParams {
    return deserializeComplexTypeV4(json, CreditPaymentMethodParams);
  }
}
