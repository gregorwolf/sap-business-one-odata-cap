...
var SalesStageParamsField = /** @class */ (function (_super) {
     ...
     */
    function SalesStageParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, SalesStageParams) || this;
        /**
...
(function (SalesStageParams) {
     ...
     */
    SalesStageParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, SalesStageParams);
    }
