...
var StockTakingsRequestBuilder = /** @class */ (function (_super) {
    ...
    StockTakingsRequestBuilder.prototype.getByKey = function (itemCode, warehouseCode) {
        return new core_1.GetByKeyRequestBuilderV4(StockTakings_1.StockTakings, {
            ItemCode: itemCode,
    ...
    StockTakingsRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(StockTakings_1.StockTakings);
    };
    /**
    ...
    StockTakingsRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(StockTakings_1.StockTakings, entity);
    };
    /**
    ...
    StockTakingsRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(StockTakings_1.StockTakings, entity);
    };
    StockTakingsRequestBuilder.prototype.delete = function (itemCodeOrEntity, warehouseCode) {
        return new core_1.DeleteRequestBuilderV4(StockTakings_1.StockTakings, itemCodeOrEntity instanceof StockTakings_1.StockTakings ? itemCodeOrEntity : {
