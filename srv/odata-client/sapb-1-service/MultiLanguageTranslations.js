...
var MultiLanguageTranslations = /** @class */ (function (_super) {
    ...
    MultiLanguageTranslations.builder = function () {
        return v4_1.Entity.entityBuilder(MultiLanguageTranslations);
    };
    /**
    ...
    MultiLanguageTranslations.customField = function (fieldName) {
        return v4_1.Entity.customFieldSelector(fieldName, MultiLanguageTranslations);
    };
    /**
     ...
     */
    MultiLanguageTranslations._serviceName = 'SAPB1';
    /**
     * Default url path for the according service.
     */
    MultiLanguageTranslations._defaultServicePath = 'VALUE_IS_UNDEFINED';
...
(function (MultiLanguageTranslations) {
     ...
     */
    MultiLanguageTranslations.NUMERATOR = new v4_1.NumberField('Numerator', MultiLanguageTranslations, 'Edm.Int32');
    /**
     * Static representation of the [[tableName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    MultiLanguageTranslations.TABLE_NAME = new v4_1.StringField('TableName', MultiLanguageTranslations, 'Edm.String');
    /**
     * Static representation of the [[fieldAlias]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    MultiLanguageTranslations.FIELD_ALIAS = new v4_1.StringField('FieldAlias', MultiLanguageTranslations, 'Edm.String');
    /**
     * Static representation of the [[primaryKeyofobject]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    MultiLanguageTranslations.PRIMARY_KEYOFOBJECT = new v4_1.StringField('PrimaryKeyofobject', MultiLanguageTranslations, 'Edm.String');
    /**
     * Static representation of the [[translationsInUserLanguages]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    MultiLanguageTranslations.TRANSLATIONS_IN_USER_LANGUAGES = new v4_1.CollectionField('TranslationsInUserLanguages', MultiLanguageTranslations, new TranslationsInUserLanguage_1.TranslationsInUserLanguageField('', MultiLanguageTranslations));
    /**
     ...
     * All fields selector.
     */
    MultiLanguageTranslations.ALL_FIELDS = new v4_1.AllFields('*', MultiLanguageTranslations);
    /**
