...
var UserPermissionTreeParamsField = /** @class */ (function (_super) {
     ...
     */
    function UserPermissionTreeParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, UserPermissionTreeParams) || this;
        /**
...
(function (UserPermissionTreeParams) {
     ...
     */
    UserPermissionTreeParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, UserPermissionTreeParams);
    }
