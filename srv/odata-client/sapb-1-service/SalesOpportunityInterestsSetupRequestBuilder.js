...
var SalesOpportunityInterestsSetupRequestBuilder = /** @class */ (function (_super) {
    ...
    SalesOpportunityInterestsSetupRequestBuilder.prototype.getByKey = function (sequenceNo) {
        return new v4_1.GetByKeyRequestBuilder(SalesOpportunityInterestsSetup_1.SalesOpportunityInterestsSetup, { SequenceNo: sequenceNo });
    };
    /**
    ...
    SalesOpportunityInterestsSetupRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(SalesOpportunityInterestsSetup_1.SalesOpportunityInterestsSetup);
    };
    /**
    ...
    SalesOpportunityInterestsSetupRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(SalesOpportunityInterestsSetup_1.SalesOpportunityInterestsSetup, entity);
    };
    /**
    ...
    SalesOpportunityInterestsSetupRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(SalesOpportunityInterestsSetup_1.SalesOpportunityInterestsSetup, entity);
    };
    SalesOpportunityInterestsSetupRequestBuilder.prototype.delete = function (sequenceNoOrEntity) {
        return new v4_1.DeleteRequestBuilder(SalesOpportunityInterestsSetup_1.SalesOpportunityInterestsSetup, sequenceNoOrEntity instanceof SalesOpportunityInterestsSetup_1.SalesOpportunityInterestsSetup ? sequenceNoOrEntity : { SequenceNo: sequenceNoOrEntity });
    };
