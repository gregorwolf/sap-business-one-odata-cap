...
var TrackingNoteParamsField = /** @class */ (function (_super) {
     ...
     */
    function TrackingNoteParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, TrackingNoteParams) || this;
        /**
...
(function (TrackingNoteParams) {
     ...
     */
    TrackingNoteParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, TrackingNoteParams);
    }
