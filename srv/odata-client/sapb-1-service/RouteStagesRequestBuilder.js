...
var RouteStagesRequestBuilder = /** @class */ (function (_super) {
    ...
    RouteStagesRequestBuilder.prototype.getByKey = function (internalNumber) {
        return new core_1.GetByKeyRequestBuilderV4(RouteStages_1.RouteStages, { InternalNumber: internalNumber });
    };
    /**
    ...
    RouteStagesRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(RouteStages_1.RouteStages);
    };
    /**
    ...
    RouteStagesRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(RouteStages_1.RouteStages, entity);
    };
    /**
    ...
    RouteStagesRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(RouteStages_1.RouteStages, entity);
    };
    RouteStagesRequestBuilder.prototype.delete = function (internalNumberOrEntity) {
        return new core_1.DeleteRequestBuilderV4(RouteStages_1.RouteStages, internalNumberOrEntity instanceof RouteStages_1.RouteStages ? internalNumberOrEntity : { InternalNumber: internalNumberOrEntity });
    };
