...
var DocumentLinesBinAllocationField = /** @class */ (function (_super) {
     ...
     */
    function DocumentLinesBinAllocationField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, DocumentLinesBinAllocation) || this;
        /**
...
(function (DocumentLinesBinAllocation) {
     ...
     */
    DocumentLinesBinAllocation._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, DocumentLinesBinAllocation);
    }
