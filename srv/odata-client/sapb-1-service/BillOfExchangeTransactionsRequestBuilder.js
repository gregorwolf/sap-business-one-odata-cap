...
var BillOfExchangeTransactionsRequestBuilder = /** @class */ (function (_super) {
    ...
    BillOfExchangeTransactionsRequestBuilder.prototype.getByKey = function (boeTransactionkey) {
        return new core_1.GetByKeyRequestBuilderV4(BillOfExchangeTransactions_1.BillOfExchangeTransactions, { BOETransactionkey: boeTransactionkey });
    };
    /**
    ...
    BillOfExchangeTransactionsRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(BillOfExchangeTransactions_1.BillOfExchangeTransactions);
    };
    /**
    ...
    BillOfExchangeTransactionsRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(BillOfExchangeTransactions_1.BillOfExchangeTransactions, entity);
    };
    /**
    ...
    BillOfExchangeTransactionsRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(BillOfExchangeTransactions_1.BillOfExchangeTransactions, entity);
    };
    BillOfExchangeTransactionsRequestBuilder.prototype.delete = function (boeTransactionkeyOrEntity) {
        return new core_1.DeleteRequestBuilderV4(BillOfExchangeTransactions_1.BillOfExchangeTransactions, boeTransactionkeyOrEntity instanceof BillOfExchangeTransactions_1.BillOfExchangeTransactions ? boeTransactionkeyOrEntity : { BOETransactionkey: boeTransactionkeyOrEntity });
    };
