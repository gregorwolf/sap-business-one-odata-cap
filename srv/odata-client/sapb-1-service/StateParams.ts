 ...
 */
export class StateParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, StateParams> {
  /**
  ...
  constructor(fieldName: string, fieldOf: ConstructorOrField<EntityT>) {
    super(fieldName, fieldOf, StateParams);
  }
}
...
export namespace StateParams {
  ...
  export function build(json: { [keys: string]: FieldType }): StateParams {
    return deserializeComplexTypeV4(json, StateParams);
  }
}
