 ...
 */
export class TaxReportAccountField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, TaxReportAccount> {
  /**
  ...
  constructor(fieldName: string, fieldOf: ConstructorOrField<EntityT>) {
    super(fieldName, fieldOf, TaxReportAccount);
  }
}
...
export namespace TaxReportAccount {
   ...
   */
  export const _propertyMetadata: PropertyMetadata<TaxReportAccount>[] = [{
    originalName: 'Code',
    name: 'code',
    type: 'Edm.String',
    isCollection: false
  ...
  export function build(json: { [keys: string]: FieldType }): TaxReportAccount {
    return deserializeComplexTypeV4(json, TaxReportAccount);
  }
}
