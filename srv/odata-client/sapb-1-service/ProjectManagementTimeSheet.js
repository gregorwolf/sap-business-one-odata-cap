...
var ProjectManagementTimeSheet = /** @class */ (function (_super) {
    ...
    ProjectManagementTimeSheet.builder = function () {
        return v4_1.Entity.entityBuilder(ProjectManagementTimeSheet);
    };
    /**
    ...
    ProjectManagementTimeSheet.customField = function (fieldName) {
        return v4_1.Entity.customFieldSelector(fieldName, ProjectManagementTimeSheet);
    };
    /**
     ...
     */
    ProjectManagementTimeSheet._serviceName = 'SAPB1';
    /**
     * Default url path for the according service.
     */
    ProjectManagementTimeSheet._defaultServicePath = 'VALUE_IS_UNDEFINED';
...
(function (ProjectManagementTimeSheet) {
     ...
     */
    ProjectManagementTimeSheet.ABS_ENTRY = new v4_1.NumberField('AbsEntry', ProjectManagementTimeSheet, 'Edm.Int32');
    /**
     * Static representation of the [[docNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ProjectManagementTimeSheet.DOC_NUMBER = new v4_1.NumberField('DocNumber', ProjectManagementTimeSheet, 'Edm.Int32');
    /**
     * Static representation of the [[userId]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ProjectManagementTimeSheet.USER_ID = new v4_1.NumberField('UserID', ProjectManagementTimeSheet, 'Edm.Int32');
    /**
     * Static representation of the [[lastName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ProjectManagementTimeSheet.LAST_NAME = new v4_1.StringField('LastName', ProjectManagementTimeSheet, 'Edm.String');
    /**
     * Static representation of the [[firstName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ProjectManagementTimeSheet.FIRST_NAME = new v4_1.StringField('FirstName', ProjectManagementTimeSheet, 'Edm.String');
    /**
     * Static representation of the [[department]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ProjectManagementTimeSheet.DEPARTMENT = new v4_1.NumberField('Department', ProjectManagementTimeSheet, 'Edm.Int32');
    /**
     * Static representation of the [[dateFrom]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ProjectManagementTimeSheet.DATE_FROM = new v4_1.DateField('DateFrom', ProjectManagementTimeSheet, 'Edm.DateTimeOffset');
    /**
     * Static representation of the [[dateTo]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ProjectManagementTimeSheet.DATE_TO = new v4_1.DateField('DateTo', ProjectManagementTimeSheet, 'Edm.DateTimeOffset');
    /**
     * Static representation of the [[pmTimeSheetLineDataCollection]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ProjectManagementTimeSheet.PM_TIME_SHEET_LINE_DATA_COLLECTION = new v4_1.CollectionField('PM_TimeSheetLineDataCollection', ProjectManagementTimeSheet, new PmTimeSheetLineData_1.PmTimeSheetLineDataField('', ProjectManagementTimeSheet));
    /**
     * Static representation of the one-to-one navigation property [[employeeInfo]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ProjectManagementTimeSheet.EMPLOYEE_INFO = new v4_1.OneToOneLink('EmployeeInfo', ProjectManagementTimeSheet, EmployeesInfo_1.EmployeesInfo);
    /**
     ...
     * All fields selector.
     */
    ProjectManagementTimeSheet.ALL_FIELDS = new v4_1.AllFields('*', ProjectManagementTimeSheet);
    /**
