 ...
 */
export class ElectronicSeriesParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, ElectronicSeriesParams> {
  /**
  ...
  constructor(fieldName: string, fieldOf: ConstructorOrField<EntityT>) {
    super(fieldName, fieldOf, ElectronicSeriesParams);
  }
}
...
export namespace ElectronicSeriesParams {
  ...
  export function build(json: { [keys: string]: FieldType }): ElectronicSeriesParams {
    return deserializeComplexTypeV4(json, ElectronicSeriesParams);
  }
}
