...
var SalesForecastParamsField = /** @class */ (function (_super) {
     ...
     */
    function SalesForecastParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, SalesForecastParams) || this;
        /**
...
(function (SalesForecastParams) {
     ...
     */
    SalesForecastParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, SalesForecastParams);
    }
