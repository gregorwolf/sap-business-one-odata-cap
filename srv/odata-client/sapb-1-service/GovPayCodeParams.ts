 ...
 */
export class GovPayCodeParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, GovPayCodeParams> {
  /**
  ...
  constructor(fieldName: string, fieldOf: ConstructorOrField<EntityT>) {
    super(fieldName, fieldOf, GovPayCodeParams);
  }
}
...
export namespace GovPayCodeParams {
  ...
  export function build(json: { [keys: string]: FieldType }): GovPayCodeParams {
    return deserializeComplexTypeV4(json, GovPayCodeParams);
  }
}
