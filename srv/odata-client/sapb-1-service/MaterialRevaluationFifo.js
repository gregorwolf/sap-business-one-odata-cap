...
var MaterialRevaluationFifoField = /** @class */ (function (_super) {
     ...
     */
    function MaterialRevaluationFifoField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, MaterialRevaluationFifo) || this;
        /**
         * Representation of the [[MaterialRevaluationFifo.layers]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.layers = new core_1.CollectionField('Layers', _this, Layer_1.Layer);
        return _this;
    }
...
(function (MaterialRevaluationFifo) {
     ...
     */
    MaterialRevaluationFifo._propertyMetadata = [{
            originalName: 'Layers',
            name: 'layers',
            type: Layer_1.Layer,
            isCollection: true
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, MaterialRevaluationFifo);
    }
