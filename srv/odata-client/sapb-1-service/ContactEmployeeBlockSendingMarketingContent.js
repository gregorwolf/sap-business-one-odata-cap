...
var ContactEmployeeBlockSendingMarketingContentField = /** @class */ (function (_super) {
     ...
     */
    function ContactEmployeeBlockSendingMarketingContentField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, ContactEmployeeBlockSendingMarketingContent) || this;
        /**
         ...
         */
        _this.contactEmployeeAbsEntry = new core_1.ComplexTypeNumberPropertyField('ContactEmployeeAbsEntry', _this, 'Edm.Int32');
        /**
...
(function (ContactEmployeeBlockSendingMarketingContent) {
     ...
     */
    ContactEmployeeBlockSendingMarketingContent._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, ContactEmployeeBlockSendingMarketingContent);
    }
