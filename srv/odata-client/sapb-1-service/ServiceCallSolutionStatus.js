...
var ServiceCallSolutionStatus = /** @class */ (function (_super) {
    ...
    ServiceCallSolutionStatus.builder = function () {
        return core_1.EntityV4.entityBuilder(ServiceCallSolutionStatus);
    };
    /**
    ...
    ServiceCallSolutionStatus.customField = function (fieldName) {
        return core_1.EntityV4.customFieldSelector(fieldName, ServiceCallSolutionStatus);
    };
    /**
     ...
     */
    ServiceCallSolutionStatus._defaultServicePath = '/b1s/v2/';
...
(function (ServiceCallSolutionStatus) {
     ...
     */
    ServiceCallSolutionStatus.STATUS_ID = new core_1.NumberField('StatusId', ServiceCallSolutionStatus, 'Edm.Int32');
    /**
     * Static representation of the [[name]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ServiceCallSolutionStatus.NAME = new core_1.StringField('Name', ServiceCallSolutionStatus, 'Edm.String');
    /**
     * Static representation of the [[description]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ServiceCallSolutionStatus.DESCRIPTION = new core_1.StringField('Description', ServiceCallSolutionStatus, 'Edm.String');
    /**
     * Static representation of the one-to-many navigation property [[knowledgeBaseSolutions]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ServiceCallSolutionStatus.KNOWLEDGE_BASE_SOLUTIONS = new core_1.OneToManyLink('KnowledgeBaseSolutions', ServiceCallSolutionStatus, KnowledgeBaseSolutions_1.KnowledgeBaseSolutions);
    /**
     ...
     * All fields selector.
     */
    ServiceCallSolutionStatus.ALL_FIELDS = new core_1.AllFields('*', ServiceCallSolutionStatus);
    /**
