...
var AccountSegmentations = /** @class */ (function (_super) {
    ...
    AccountSegmentations.builder = function () {
        return v4_1.Entity.entityBuilder(AccountSegmentations);
    };
    /**
    ...
    AccountSegmentations.customField = function (fieldName) {
        return v4_1.Entity.customFieldSelector(fieldName, AccountSegmentations);
    };
    /**
     ...
     */
    AccountSegmentations._serviceName = 'SAPB1';
    /**
     * Default url path for the according service.
     */
    AccountSegmentations._defaultServicePath = 'VALUE_IS_UNDEFINED';
...
(function (AccountSegmentations) {
     ...
     */
    AccountSegmentations.NUMERATOR = new v4_1.NumberField('Numerator', AccountSegmentations, 'Edm.Int32');
    /**
     * Static representation of the [[name]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AccountSegmentations.NAME = new v4_1.StringField('Name', AccountSegmentations, 'Edm.String');
    /**
     * Static representation of the [[size]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AccountSegmentations.SIZE = new v4_1.NumberField('Size', AccountSegmentations, 'Edm.Int32');
    /**
     * Static representation of the [[accountSegmentationsCategories]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AccountSegmentations.ACCOUNT_SEGMENTATIONS_CATEGORIES = new v4_1.CollectionField('AccountSegmentationsCategories', AccountSegmentations, new AccountSegmentationsCategory_1.AccountSegmentationsCategoryField('', AccountSegmentations));
    /**
     * Static representation of the one-to-many navigation property [[accountSegmentationCategories]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AccountSegmentations.ACCOUNT_SEGMENTATION_CATEGORIES = new v4_1.OneToManyLink('AccountSegmentationCategories', AccountSegmentations, AccountSegmentationCategories_1.AccountSegmentationCategories);
    /**
     ...
     * All fields selector.
     */
    AccountSegmentations.ALL_FIELDS = new v4_1.AllFields('*', AccountSegmentations);
    /**
