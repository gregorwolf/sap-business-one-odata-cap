...
var EmployeePositionRequestBuilder = /** @class */ (function (_super) {
    ...
    EmployeePositionRequestBuilder.prototype.getByKey = function (positionId) {
        return new core_1.GetByKeyRequestBuilderV4(EmployeePosition_1.EmployeePosition, { PositionID: positionId });
    };
    /**
    ...
    EmployeePositionRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(EmployeePosition_1.EmployeePosition);
    };
    /**
    ...
    EmployeePositionRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(EmployeePosition_1.EmployeePosition, entity);
    };
    /**
    ...
    EmployeePositionRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(EmployeePosition_1.EmployeePosition, entity);
    };
    EmployeePositionRequestBuilder.prototype.delete = function (positionIdOrEntity) {
        return new core_1.DeleteRequestBuilderV4(EmployeePosition_1.EmployeePosition, positionIdOrEntity instanceof EmployeePosition_1.EmployeePosition ? positionIdOrEntity : { PositionID: positionIdOrEntity });
    };
