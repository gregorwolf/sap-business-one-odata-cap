...
var UserParamsField = /** @class */ (function (_super) {
     ...
     */
    function UserParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, UserParams) || this;
        /**
...
(function (UserParams) {
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, UserParams);
    }
