 ...
 */
export class SalesTaxAuthoritiesTypeParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, SalesTaxAuthoritiesTypeParams> {
  /**
  ...
  constructor(fieldName: string, fieldOf: ConstructorOrField<EntityT>) {
    super(fieldName, fieldOf, SalesTaxAuthoritiesTypeParams);
  }
}
...
export namespace SalesTaxAuthoritiesTypeParams {
   ...
   */
  export const _propertyMetadata: PropertyMetadata<SalesTaxAuthoritiesTypeParams>[] = [{
  ...
  export function build(json: { [keys: string]: FieldType }): SalesTaxAuthoritiesTypeParams {
    return deserializeComplexTypeV4(json, SalesTaxAuthoritiesTypeParams);
  }
}
