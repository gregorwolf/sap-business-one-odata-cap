 ...
 */
export class CostElementParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, CostElementParams> {
  /**
  ...
  constructor(fieldName: string, fieldOf: ConstructorOrField<EntityT>) {
    super(fieldName, fieldOf, CostElementParams);
  }
}
...
export namespace CostElementParams {
  ...
  export function build(json: { [keys: string]: FieldType }): CostElementParams {
    return deserializeComplexTypeV4(json, CostElementParams);
  }
}
