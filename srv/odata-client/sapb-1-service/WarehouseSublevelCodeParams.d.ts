 ...
 */
export declare class WarehouseSublevelCodeParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, WarehouseSublevelCodeParams> {
    /**
...
export declare namespace WarehouseSublevelCodeParams {
     ...
     */
    const _propertyMetadata: PropertyMetadata<WarehouseSublevelCodeParams>[];
    /**
