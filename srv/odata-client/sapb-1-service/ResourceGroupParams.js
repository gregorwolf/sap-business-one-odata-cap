...
var ResourceGroupParamsField = /** @class */ (function (_super) {
     ...
     */
    function ResourceGroupParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, ResourceGroupParams) || this;
        /**
...
(function (ResourceGroupParams) {
     ...
     */
    ResourceGroupParams._propertyMetadata = [{
            originalName: 'Code',
            name: 'code',
            type: 'Edm.Int32',
            isCollection: false
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, ResourceGroupParams);
    }
