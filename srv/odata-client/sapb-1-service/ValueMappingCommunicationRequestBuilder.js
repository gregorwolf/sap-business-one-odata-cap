...
var ValueMappingCommunicationRequestBuilder = /** @class */ (function (_super) {
    ...
    ValueMappingCommunicationRequestBuilder.prototype.getByKey = function (absEntry) {
        return new v4_1.GetByKeyRequestBuilder(ValueMappingCommunication_1.ValueMappingCommunication, { AbsEntry: absEntry });
    };
    /**
    ...
    ValueMappingCommunicationRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(ValueMappingCommunication_1.ValueMappingCommunication);
    };
    /**
    ...
    ValueMappingCommunicationRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(ValueMappingCommunication_1.ValueMappingCommunication, entity);
    };
    /**
    ...
    ValueMappingCommunicationRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(ValueMappingCommunication_1.ValueMappingCommunication, entity);
    };
    ValueMappingCommunicationRequestBuilder.prototype.delete = function (absEntryOrEntity) {
        return new v4_1.DeleteRequestBuilder(ValueMappingCommunication_1.ValueMappingCommunication, absEntryOrEntity instanceof ValueMappingCommunication_1.ValueMappingCommunication ? absEntryOrEntity : { AbsEntry: absEntryOrEntity });
    };
