...
var FiscalPrinterParamsField = /** @class */ (function (_super) {
     ...
     */
    function FiscalPrinterParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, FiscalPrinterParams) || this;
        /**
         * Representation of the [[FiscalPrinterParams.equipmentNo]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.equipmentNo = new core_1.ComplexTypeStringPropertyField('EquipmentNo', _this, 'Edm.String');
        return _this;
    }
...
(function (FiscalPrinterParams) {
     ...
     */
    FiscalPrinterParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, FiscalPrinterParams);
    }
