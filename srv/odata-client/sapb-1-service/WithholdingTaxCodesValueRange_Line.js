...
var WithholdingTaxCodesValueRange_LineField = /** @class */ (function (_super) {
     ...
     */
    function WithholdingTaxCodesValueRange_LineField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, WithholdingTaxCodesValueRange_Line) || this;
        /**
         ...
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.wTaxToBeDeductible = new core_1.ComplexTypeNumberPropertyField('WTaxToBeDeductible', _this, 'Edm.Double');
        /**
...
(function (WithholdingTaxCodesValueRange_Line) {
     ...
     */
    WithholdingTaxCodesValueRange_Line._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, WithholdingTaxCodesValueRange_Line);
    }
