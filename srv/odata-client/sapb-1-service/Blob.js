...
exports.Blob = exports.BlobField = exports.createBlob = void 0;
/*
...
var BlobField = /** @class */ (function (_super) {
     ...
     */
    function BlobField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, Blob) || this;
        /**
         * Representation of the [[Blob.content]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.content = new core_1.ComplexTypeStringPropertyField('Content', _this, 'Edm.String');
        return _this;
    }
    return BlobField;
...
(function (Blob) {
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, Blob);
    }
    Blob.build = build;
