...
var TargetGroupsRequestBuilder = /** @class */ (function (_super) {
    ...
    TargetGroupsRequestBuilder.prototype.getByKey = function (targetGroupCode) {
        return new v4_1.GetByKeyRequestBuilder(TargetGroups_1.TargetGroups, { TargetGroupCode: targetGroupCode });
    };
    /**
    ...
    TargetGroupsRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(TargetGroups_1.TargetGroups);
    };
    /**
    ...
    TargetGroupsRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(TargetGroups_1.TargetGroups, entity);
    };
    /**
    ...
    TargetGroupsRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(TargetGroups_1.TargetGroups, entity);
    };
    TargetGroupsRequestBuilder.prototype.delete = function (targetGroupCodeOrEntity) {
        return new v4_1.DeleteRequestBuilder(TargetGroups_1.TargetGroups, targetGroupCodeOrEntity instanceof TargetGroups_1.TargetGroups ? targetGroupCodeOrEntity : { TargetGroupCode: targetGroupCodeOrEntity });
    };
