 ...
 */
export declare class PosDailySummaryParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, PosDailySummaryParams> {
    /**
...
export declare namespace PosDailySummaryParams {
     ...
     */
    const _propertyMetadata: PropertyMetadata<PosDailySummaryParams>[];
    /**
