 ...
 */
export class AdditionalExpensesParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, AdditionalExpensesParams> {
  /**
  ...
  constructor(fieldName: string, fieldOf: ConstructorOrField<EntityT>) {
    super(fieldName, fieldOf, AdditionalExpensesParams);
  }
}
...
export namespace AdditionalExpensesParams {
   ...
   */
  export const _propertyMetadata: PropertyMetadata<AdditionalExpensesParams>[] = [{
  ...
  export function build(json: { [keys: string]: FieldType }): AdditionalExpensesParams {
    return deserializeComplexTypeV4(json, AdditionalExpensesParams);
  }
}
