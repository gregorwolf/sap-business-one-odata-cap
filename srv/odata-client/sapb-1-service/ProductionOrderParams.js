...
var ProductionOrderParamsField = /** @class */ (function (_super) {
     ...
     */
    function ProductionOrderParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, ProductionOrderParams) || this;
        /**
...
(function (ProductionOrderParams) {
     ...
     */
    ProductionOrderParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, ProductionOrderParams);
    }
