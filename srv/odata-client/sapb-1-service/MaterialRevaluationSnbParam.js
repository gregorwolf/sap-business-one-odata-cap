...
var MaterialRevaluationSnbParamField = /** @class */ (function (_super) {
     ...
     */
    function MaterialRevaluationSnbParamField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, MaterialRevaluationSnbParam) || this;
        /**
...
(function (MaterialRevaluationSnbParam) {
     ...
     */
    MaterialRevaluationSnbParam._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, MaterialRevaluationSnbParam);
    }
