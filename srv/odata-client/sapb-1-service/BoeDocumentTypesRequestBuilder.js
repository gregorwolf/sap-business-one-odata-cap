...
var BoeDocumentTypesRequestBuilder = /** @class */ (function (_super) {
    ...
    BoeDocumentTypesRequestBuilder.prototype.getByKey = function (docEntry) {
        return new v4_1.GetByKeyRequestBuilder(BoeDocumentTypes_1.BoeDocumentTypes, { DocEntry: docEntry });
    };
    /**
    ...
    BoeDocumentTypesRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(BoeDocumentTypes_1.BoeDocumentTypes);
    };
    /**
    ...
    BoeDocumentTypesRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(BoeDocumentTypes_1.BoeDocumentTypes, entity);
    };
    /**
    ...
    BoeDocumentTypesRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(BoeDocumentTypes_1.BoeDocumentTypes, entity);
    };
    BoeDocumentTypesRequestBuilder.prototype.delete = function (docEntryOrEntity) {
        return new v4_1.DeleteRequestBuilder(BoeDocumentTypes_1.BoeDocumentTypes, docEntryOrEntity instanceof BoeDocumentTypes_1.BoeDocumentTypes ? docEntryOrEntity : { DocEntry: docEntryOrEntity });
    };
