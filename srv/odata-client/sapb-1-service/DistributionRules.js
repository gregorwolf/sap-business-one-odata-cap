...
var DistributionRules = /** @class */ (function (_super) {
    ...
    DistributionRules.builder = function () {
        return v4_1.Entity.entityBuilder(DistributionRules);
    };
    /**
    ...
    DistributionRules.customField = function (fieldName) {
        return v4_1.Entity.customFieldSelector(fieldName, DistributionRules);
    };
    /**
     ...
     */
    DistributionRules._serviceName = 'SAPB1';
    /**
     * Default url path for the according service.
     */
    DistributionRules._defaultServicePath = 'VALUE_IS_UNDEFINED';
...
(function (DistributionRules) {
     ...
     */
    DistributionRules.FACTOR_CODE = new v4_1.StringField('FactorCode', DistributionRules, 'Edm.String');
    /**
     * Static representation of the [[factorDescription]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    DistributionRules.FACTOR_DESCRIPTION = new v4_1.StringField('FactorDescription', DistributionRules, 'Edm.String');
    /**
     * Static representation of the [[totalFactor]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    DistributionRules.TOTAL_FACTOR = new v4_1.NumberField('TotalFactor', DistributionRules, 'Edm.Double');
    /**
     * Static representation of the [[direct]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    DistributionRules.DIRECT = new v4_1.StringField('Direct', DistributionRules, 'Edm.String');
    /**
     * Static representation of the [[inWhichDimension]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    DistributionRules.IN_WHICH_DIMENSION = new v4_1.NumberField('InWhichDimension', DistributionRules, 'Edm.Int32');
    /**
     * Static representation of the [[distributionRuleLines]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    DistributionRules.DISTRIBUTION_RULE_LINES = new v4_1.CollectionField('DistributionRuleLines', DistributionRules, new DistributionRuleLine_1.DistributionRuleLineField('', DistributionRules));
    /**
     * Static representation of the one-to-many navigation property [[productionOrders]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    DistributionRules.PRODUCTION_ORDERS = new v4_1.OneToManyLink('ProductionOrders', DistributionRules, ProductionOrders_1.ProductionOrders);
    /**
     * Static representation of the one-to-many navigation property [[productTrees]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    DistributionRules.PRODUCT_TREES = new v4_1.OneToManyLink('ProductTrees', DistributionRules, ProductTrees_1.ProductTrees);
    /**
     * Static representation of the one-to-many navigation property [[chartOfAccounts]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    DistributionRules.CHART_OF_ACCOUNTS = new v4_1.OneToManyLink('ChartOfAccounts', DistributionRules, ChartOfAccounts_1.ChartOfAccounts);
    /**
     * Static representation of the one-to-many navigation property [[budgetScenarios]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    DistributionRules.BUDGET_SCENARIOS = new v4_1.OneToManyLink('BudgetScenarios', DistributionRules, BudgetScenarios_1.BudgetScenarios);
    /**
     * Static representation of the one-to-many navigation property [[additionalExpenses]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    DistributionRules.ADDITIONAL_EXPENSES = new v4_1.OneToManyLink('AdditionalExpenses', DistributionRules, AdditionalExpenses_1.AdditionalExpenses);
    /**
     * Static representation of the one-to-one navigation property [[dimension]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    DistributionRules.DIMENSION = new v4_1.OneToOneLink('Dimension', DistributionRules, Dimensions_1.Dimensions);
    /**
     * Static representation of the one-to-many navigation property [[deposits]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    DistributionRules.DEPOSITS = new v4_1.OneToManyLink('Deposits', DistributionRules, Deposits_1.Deposits);
    /**
     ...
     * All fields selector.
     */
    DistributionRules.ALL_FIELDS = new v4_1.AllFields('*', DistributionRules);
    /**
