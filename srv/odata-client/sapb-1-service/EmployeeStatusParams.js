...
var EmployeeStatusParamsField = /** @class */ (function (_super) {
     ...
     */
    function EmployeeStatusParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, EmployeeStatusParams) || this;
        /**
...
(function (EmployeeStatusParams) {
     ...
     */
    EmployeeStatusParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, EmployeeStatusParams);
    }
