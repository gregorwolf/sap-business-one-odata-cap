...
var SalesOpportunitySourcesSetupRequestBuilder = /** @class */ (function (_super) {
    ...
    SalesOpportunitySourcesSetupRequestBuilder.prototype.getByKey = function (sequenceNo) {
        return new core_1.GetByKeyRequestBuilderV4(SalesOpportunitySourcesSetup_1.SalesOpportunitySourcesSetup, { SequenceNo: sequenceNo });
    };
    /**
    ...
    SalesOpportunitySourcesSetupRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(SalesOpportunitySourcesSetup_1.SalesOpportunitySourcesSetup);
    };
    /**
    ...
    SalesOpportunitySourcesSetupRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(SalesOpportunitySourcesSetup_1.SalesOpportunitySourcesSetup, entity);
    };
    /**
    ...
    SalesOpportunitySourcesSetupRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(SalesOpportunitySourcesSetup_1.SalesOpportunitySourcesSetup, entity);
    };
    SalesOpportunitySourcesSetupRequestBuilder.prototype.delete = function (sequenceNoOrEntity) {
        return new core_1.DeleteRequestBuilderV4(SalesOpportunitySourcesSetup_1.SalesOpportunitySourcesSetup, sequenceNoOrEntity instanceof SalesOpportunitySourcesSetup_1.SalesOpportunitySourcesSetup ? sequenceNoOrEntity : { SequenceNo: sequenceNoOrEntity });
    };
