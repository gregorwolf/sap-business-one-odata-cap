...
var ValueMapping = /** @class */ (function (_super) {
    ...
    ValueMapping.builder = function () {
        return core_1.EntityV4.entityBuilder(ValueMapping);
    };
    /**
    ...
    ValueMapping.customField = function (fieldName) {
        return core_1.EntityV4.customFieldSelector(fieldName, ValueMapping);
    };
    /**
     ...
     */
    ValueMapping._defaultServicePath = '/b1s/v2/';
    return ValueMapping;
}(core_1.EntityV4));
...
(function (ValueMapping) {
     ...
     */
    ValueMapping.ABS_ENTRY = new core_1.NumberField('AbsEntry', ValueMapping, 'Edm.Int32');
    /**
     * Static representation of the [[objectId]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ValueMapping.OBJECT_ID = new core_1.NumberField('ObjectId', ValueMapping, 'Edm.Int32');
    /**
     * Static representation of the [[objectAbsEntry]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ValueMapping.OBJECT_ABS_ENTRY = new core_1.StringField('ObjectAbsEntry', ValueMapping, 'Edm.String');
    /**
     * Static representation of the [[vmThirdPartyValuesCollection]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ValueMapping.VM_THIRD_PARTY_VALUES_COLLECTION = new core_1.CollectionField('VM_ThirdPartyValuesCollection', ValueMapping, VmThirdPartyValuesData_1.VmThirdPartyValuesData);
    /**
     ...
     * All fields selector.
     */
    ValueMapping.ALL_FIELDS = new core_1.AllFields('*', ValueMapping);
    /**
