 ...
 */
export class MaterialRevaluationParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, MaterialRevaluationParams> {
  /**
  ...
  constructor(fieldName: string, fieldOf: ConstructorOrField<EntityT>) {
    super(fieldName, fieldOf, MaterialRevaluationParams);
  }
}
...
export namespace MaterialRevaluationParams {
   ...
   */
  export const _propertyMetadata: PropertyMetadata<MaterialRevaluationParams>[] = [{
  ...
  export function build(json: { [keys: string]: FieldType }): MaterialRevaluationParams {
    return deserializeComplexTypeV4(json, MaterialRevaluationParams);
  }
}
