...
var UserFieldsMdRequestBuilder = /** @class */ (function (_super) {
    ...
    UserFieldsMdRequestBuilder.prototype.getByKey = function (tableName, fieldId) {
        return new v4_1.GetByKeyRequestBuilder(UserFieldsMd_1.UserFieldsMd, {
            TableName: tableName,
            FieldID: fieldId
        });
    };
    ...
    UserFieldsMdRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(UserFieldsMd_1.UserFieldsMd);
    };
    /**
    ...
    UserFieldsMdRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(UserFieldsMd_1.UserFieldsMd, entity);
    };
    /**
    ...
    UserFieldsMdRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(UserFieldsMd_1.UserFieldsMd, entity);
    };
    UserFieldsMdRequestBuilder.prototype.delete = function (tableNameOrEntity, fieldId) {
        return new v4_1.DeleteRequestBuilder(UserFieldsMd_1.UserFieldsMd, tableNameOrEntity instanceof UserFieldsMd_1.UserFieldsMd ? tableNameOrEntity : {
