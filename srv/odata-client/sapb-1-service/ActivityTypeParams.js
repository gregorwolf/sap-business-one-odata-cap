...
var ActivityTypeParamsField = /** @class */ (function (_super) {
     ...
     */
    function ActivityTypeParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, ActivityTypeParams) || this;
        /**
...
(function (ActivityTypeParams) {
     ...
     */
    ActivityTypeParams._propertyMetadata = [{
            originalName: 'Code',
            name: 'code',
            type: 'Edm.Int32',
            isCollection: false
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, ActivityTypeParams);
    }
