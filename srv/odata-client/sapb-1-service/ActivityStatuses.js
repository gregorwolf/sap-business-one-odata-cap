...
var ActivityStatuses = /** @class */ (function (_super) {
    ...
    ActivityStatuses.builder = function () {
        return v4_1.Entity.entityBuilder(ActivityStatuses);
    };
    /**
    ...
    ActivityStatuses.customField = function (fieldName) {
        return v4_1.Entity.customFieldSelector(fieldName, ActivityStatuses);
    };
    /**
     ...
     */
    ActivityStatuses._serviceName = 'SAPB1';
    /**
     * Default url path for the according service.
     */
    ActivityStatuses._defaultServicePath = 'VALUE_IS_UNDEFINED';
...
(function (ActivityStatuses) {
     ...
     */
    ActivityStatuses.STATUS_DESCRIPTION = new v4_1.StringField('StatusDescription', ActivityStatuses, 'Edm.String');
    /**
     * Static representation of the [[statusId]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ActivityStatuses.STATUS_ID = new v4_1.NumberField('StatusId', ActivityStatuses, 'Edm.Int32');
    /**
     * Static representation of the [[statusName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ActivityStatuses.STATUS_NAME = new v4_1.StringField('StatusName', ActivityStatuses, 'Edm.String');
    /**
     * Static representation of the one-to-many navigation property [[contacts]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ActivityStatuses.CONTACTS = new v4_1.OneToManyLink('Contacts', ActivityStatuses, Contacts_1.Contacts);
    /**
     * Static representation of the one-to-many navigation property [[activities]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ActivityStatuses.ACTIVITIES = new v4_1.OneToManyLink('Activities', ActivityStatuses, Activities_1.Activities);
    /**
     ...
     * All fields selector.
     */
    ActivityStatuses.ALL_FIELDS = new v4_1.AllFields('*', ActivityStatuses);
    /**
