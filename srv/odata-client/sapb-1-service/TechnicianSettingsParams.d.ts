 ...
 */
export declare class TechnicianSettingsParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, TechnicianSettingsParams> {
    /**
...
export declare namespace TechnicianSettingsParams {
     ...
     */
    const _propertyMetadata: PropertyMetadata<TechnicianSettingsParams>[];
    /**
