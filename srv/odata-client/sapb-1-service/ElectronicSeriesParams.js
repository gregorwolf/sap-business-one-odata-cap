...
var ElectronicSeriesParamsField = /** @class */ (function (_super) {
     ...
     */
    function ElectronicSeriesParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, ElectronicSeriesParams) || this;
        /**
...
(function (ElectronicSeriesParams) {
     ...
     */
    ElectronicSeriesParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, ElectronicSeriesParams);
    }
