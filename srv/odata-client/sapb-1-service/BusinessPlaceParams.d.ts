 ...
 */
export declare class BusinessPlaceParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, BusinessPlaceParams> {
    /**
...
export declare namespace BusinessPlaceParams {
     ...
     */
    const _propertyMetadata: PropertyMetadata<BusinessPlaceParams>[];
    /**
