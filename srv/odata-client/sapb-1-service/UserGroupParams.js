...
var UserGroupParamsField = /** @class */ (function (_super) {
     ...
     */
    function UserGroupParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, UserGroupParams) || this;
        /**
         * Representation of the [[UserGroupParams.userGroupId]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.userGroupId = new core_1.ComplexTypeNumberPropertyField('UserGroupId', _this, 'Edm.Int32');
        /**
         * Representation of the [[UserGroupParams.userGroupName]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.userGroupName = new core_1.ComplexTypeStringPropertyField('UserGroupName', _this, 'Edm.String');
        return _this;
    }
...
(function (UserGroupParams) {
     ...
     */
    UserGroupParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, UserGroupParams);
    }
