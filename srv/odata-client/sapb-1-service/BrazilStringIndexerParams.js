...
var BrazilStringIndexerParamsField = /** @class */ (function (_super) {
     ...
     */
    function BrazilStringIndexerParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, BrazilStringIndexerParams) || this;
        /**
...
(function (BrazilStringIndexerParams) {
     ...
     */
    BrazilStringIndexerParams._propertyMetadata = [{
            originalName: 'ID',
            name: 'id',
            type: 'Edm.Int32',
            isCollection: false
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, BrazilStringIndexerParams);
    }
