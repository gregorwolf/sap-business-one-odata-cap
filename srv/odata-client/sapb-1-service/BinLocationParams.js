...
var BinLocationParamsField = /** @class */ (function (_super) {
    ...
    function BinLocationParamsField() {
         ...
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.binCode = new v4_1.ComplexTypeStringPropertyField('BinCode', _this, 'Edm.String');
        return _this;
    }
...
(function (BinLocationParams) {
    function build(json) {
        return v4_1.createComplexType(json, {
            ...
            BinCode: function (binCode) { return ({ binCode: v4_1.edmToTs(binCode, 'Edm.String') }); }
        });
    }
