...
var ItemImages = /** @class */ (function (_super) {
    ...
    ItemImages.builder = function () {
        return v4_1.Entity.entityBuilder(ItemImages);
    };
    /**
    ...
    ItemImages.customField = function (fieldName) {
        return v4_1.Entity.customFieldSelector(fieldName, ItemImages);
    };
    /**
     ...
     */
    ItemImages._serviceName = 'SAPB1';
    /**
     * Default url path for the according service.
     */
    ItemImages._defaultServicePath = 'VALUE_IS_UNDEFINED';
    return ItemImages;
}(v4_1.Entity));
...
(function (ItemImages) {
     ...
     */
    ItemImages.ITEM_CODE = new v4_1.StringField('ItemCode', ItemImages, 'Edm.String');
    /**
     * Static representation of the [[picture]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ItemImages.PICTURE = new v4_1.StringField('Picture', ItemImages, 'Edm.String');
    /**
     ...
     * All fields selector.
     */
    ItemImages.ALL_FIELDS = new v4_1.AllFields('*', ItemImages);
    /**
