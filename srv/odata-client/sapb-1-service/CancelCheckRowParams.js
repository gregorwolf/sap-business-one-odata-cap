...
var CancelCheckRowParamsField = /** @class */ (function (_super) {
     ...
     */
    function CancelCheckRowParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, CancelCheckRowParams) || this;
        /**
         * Representation of the [[CancelCheckRowParams.depositId]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.depositId = new core_1.ComplexTypeNumberPropertyField('DepositID', _this, 'Edm.Int32');
        /**
         * Representation of the [[CancelCheckRowParams.checkId]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.checkId = new core_1.ComplexTypeNumberPropertyField('CheckID', _this, 'Edm.Int32');
        return _this;
    }
...
(function (CancelCheckRowParams) {
     ...
     */
    CancelCheckRowParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, CancelCheckRowParams);
    }
