...
var ServiceContractParamsField = /** @class */ (function (_super) {
     ...
     */
    function ServiceContractParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, ServiceContractParams) || this;
        /**
         * Representation of the [[ServiceContractParams.contractId]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.contractId = new core_1.ComplexTypeNumberPropertyField('ContractID', _this, 'Edm.Int32');
        return _this;
    }
...
(function (ServiceContractParams) {
     ...
     */
    ServiceContractParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, ServiceContractParams);
    }
