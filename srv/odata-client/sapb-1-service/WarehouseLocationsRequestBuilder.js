...
var WarehouseLocationsRequestBuilder = /** @class */ (function (_super) {
    ...
    WarehouseLocationsRequestBuilder.prototype.getByKey = function (code) {
        return new core_1.GetByKeyRequestBuilderV4(WarehouseLocations_1.WarehouseLocations, { Code: code });
    };
    /**
    ...
    WarehouseLocationsRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(WarehouseLocations_1.WarehouseLocations);
    };
    /**
    ...
    WarehouseLocationsRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(WarehouseLocations_1.WarehouseLocations, entity);
    };
    /**
    ...
    WarehouseLocationsRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(WarehouseLocations_1.WarehouseLocations, entity);
    };
    WarehouseLocationsRequestBuilder.prototype.delete = function (codeOrEntity) {
        return new core_1.DeleteRequestBuilderV4(WarehouseLocations_1.WarehouseLocations, codeOrEntity instanceof WarehouseLocations_1.WarehouseLocations ? codeOrEntity : { Code: codeOrEntity });
    };
