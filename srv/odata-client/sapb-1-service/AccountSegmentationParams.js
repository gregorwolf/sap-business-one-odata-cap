...
var AccountSegmentationParamsField = /** @class */ (function (_super) {
     ...
     */
    function AccountSegmentationParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, AccountSegmentationParams) || this;
        /**
...
(function (AccountSegmentationParams) {
     ...
     */
    AccountSegmentationParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, AccountSegmentationParams);
    }
