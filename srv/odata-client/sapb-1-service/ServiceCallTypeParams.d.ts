 ...
 */
export declare class ServiceCallTypeParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, ServiceCallTypeParams> {
    /**
...
export declare namespace ServiceCallTypeParams {
     ...
     */
    const _propertyMetadata: PropertyMetadata<ServiceCallTypeParams>[];
    /**
