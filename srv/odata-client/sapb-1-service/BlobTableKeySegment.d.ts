 ...
 */
export declare class BlobTableKeySegmentField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, BlobTableKeySegment> {
    /**
...
export declare namespace BlobTableKeySegment {
     ...
     */
    const _propertyMetadata: PropertyMetadata<BlobTableKeySegment>[];
    /**
