...
var DepositParamsField = /** @class */ (function (_super) {
     ...
     */
    function DepositParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, DepositParams) || this;
        /**
         * Representation of the [[DepositParams.depositNumber]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.depositNumber = new core_1.ComplexTypeNumberPropertyField('DepositNumber', _this, 'Edm.Int32');
        /**
...
(function (DepositParams) {
     ...
     */
    DepositParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, DepositParams);
    }
