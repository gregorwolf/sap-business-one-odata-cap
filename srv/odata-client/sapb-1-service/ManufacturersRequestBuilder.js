...
var ManufacturersRequestBuilder = /** @class */ (function (_super) {
    ...
    ManufacturersRequestBuilder.prototype.getByKey = function (code) {
        return new v4_1.GetByKeyRequestBuilder(Manufacturers_1.Manufacturers, { Code: code });
    };
    /**
    ...
    ManufacturersRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(Manufacturers_1.Manufacturers);
    };
    /**
    ...
    ManufacturersRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(Manufacturers_1.Manufacturers, entity);
    };
    /**
    ...
    ManufacturersRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(Manufacturers_1.Manufacturers, entity);
    };
    ManufacturersRequestBuilder.prototype.delete = function (codeOrEntity) {
        return new v4_1.DeleteRequestBuilder(Manufacturers_1.Manufacturers, codeOrEntity instanceof Manufacturers_1.Manufacturers ? codeOrEntity : { Code: codeOrEntity });
    };
