...
var ProductTreeStageField = /** @class */ (function (_super) {
     ...
     */
    function ProductTreeStageField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, ProductTreeStage) || this;
        /**
         * Representation of the [[ProductTreeStage.father]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.father = new core_1.ComplexTypeStringPropertyField('Father', _this, 'Edm.String');
        /**
...
(function (ProductTreeStage) {
     ...
     */
    ProductTreeStage._propertyMetadata = [{
            originalName: 'Father',
            name: 'father',
            type: 'Edm.String',
            isCollection: false
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, ProductTreeStage);
    }
