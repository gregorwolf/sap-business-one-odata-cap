...
var ExpenseTypesRequestBuilder = /** @class */ (function (_super) {
    ...
    ExpenseTypesRequestBuilder.prototype.getByKey = function (expenseType) {
        return new core_1.GetByKeyRequestBuilderV4(ExpenseTypes_1.ExpenseTypes, { ExpenseType: expenseType });
    };
    /**
    ...
    ExpenseTypesRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(ExpenseTypes_1.ExpenseTypes);
    };
    /**
    ...
    ExpenseTypesRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(ExpenseTypes_1.ExpenseTypes, entity);
    };
    /**
    ...
    ExpenseTypesRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(ExpenseTypes_1.ExpenseTypes, entity);
    };
    ExpenseTypesRequestBuilder.prototype.delete = function (expenseTypeOrEntity) {
        return new core_1.DeleteRequestBuilderV4(ExpenseTypes_1.ExpenseTypes, expenseTypeOrEntity instanceof ExpenseTypes_1.ExpenseTypes ? expenseTypeOrEntity : { ExpenseType: expenseTypeOrEntity });
    };
