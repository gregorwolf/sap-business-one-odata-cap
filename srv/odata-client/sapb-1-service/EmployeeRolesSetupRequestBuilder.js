...
var EmployeeRolesSetupRequestBuilder = /** @class */ (function (_super) {
    ...
    EmployeeRolesSetupRequestBuilder.prototype.getByKey = function (typeId) {
        return new core_1.GetByKeyRequestBuilderV4(EmployeeRolesSetup_1.EmployeeRolesSetup, { TypeID: typeId });
    };
    /**
    ...
    EmployeeRolesSetupRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(EmployeeRolesSetup_1.EmployeeRolesSetup);
    };
    /**
    ...
    EmployeeRolesSetupRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(EmployeeRolesSetup_1.EmployeeRolesSetup, entity);
    };
    /**
    ...
    EmployeeRolesSetupRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(EmployeeRolesSetup_1.EmployeeRolesSetup, entity);
    };
    EmployeeRolesSetupRequestBuilder.prototype.delete = function (typeIdOrEntity) {
        return new core_1.DeleteRequestBuilderV4(EmployeeRolesSetup_1.EmployeeRolesSetup, typeIdOrEntity instanceof EmployeeRolesSetup_1.EmployeeRolesSetup ? typeIdOrEntity : { TypeID: typeIdOrEntity });
    };
