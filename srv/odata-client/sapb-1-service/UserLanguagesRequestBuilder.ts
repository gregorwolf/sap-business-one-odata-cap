...
export class UserLanguagesRequestBuilder extends RequestBuilder<UserLanguages> {
  ...
  getByKey(code: number): GetByKeyRequestBuilder<UserLanguages> {
    return new GetByKeyRequestBuilder(UserLanguages, { Code: code });
  }
  ...
  getAll(): GetAllRequestBuilder<UserLanguages> {
    return new GetAllRequestBuilder(UserLanguages);
  }
  ...
  create(entity: UserLanguages): CreateRequestBuilder<UserLanguages> {
    return new CreateRequestBuilder(UserLanguages, entity);
  }
  ...
  update(entity: UserLanguages): UpdateRequestBuilder<UserLanguages> {
    return new UpdateRequestBuilder(UserLanguages, entity);
  }
  ...
  delete(codeOrEntity: any): DeleteRequestBuilder<UserLanguages> {
    return new DeleteRequestBuilder(UserLanguages, codeOrEntity instanceof UserLanguages ? codeOrEntity : { Code: codeOrEntity! });
  }
}
