...
var InternalReconciliationBpField = /** @class */ (function (_super) {
     ...
     */
    function InternalReconciliationBpField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, InternalReconciliationBp) || this;
        /**
...
(function (InternalReconciliationBp) {
     ...
     */
    InternalReconciliationBp._propertyMetadata = [{
            originalName: 'BPCode',
            name: 'bpCode',
            type: 'Edm.String',
            isCollection: false
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, InternalReconciliationBp);
    }
