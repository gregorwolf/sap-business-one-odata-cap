...
var UserBranchAssignmentItemField = /** @class */ (function (_super) {
     ...
     */
    function UserBranchAssignmentItemField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, UserBranchAssignmentItem) || this;
        /**
...
(function (UserBranchAssignmentItem) {
     ...
     */
    UserBranchAssignmentItem._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, UserBranchAssignmentItem);
    }
