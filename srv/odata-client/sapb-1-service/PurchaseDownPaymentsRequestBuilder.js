...
var PurchaseDownPaymentsRequestBuilder = /** @class */ (function (_super) {
    ...
    PurchaseDownPaymentsRequestBuilder.prototype.getByKey = function (docEntry) {
        return new core_1.GetByKeyRequestBuilderV4(PurchaseDownPayments_1.PurchaseDownPayments, { DocEntry: docEntry });
    };
    /**
    ...
    PurchaseDownPaymentsRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(PurchaseDownPayments_1.PurchaseDownPayments);
    };
    /**
    ...
    PurchaseDownPaymentsRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(PurchaseDownPayments_1.PurchaseDownPayments, entity);
    };
    /**
    ...
    PurchaseDownPaymentsRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(PurchaseDownPayments_1.PurchaseDownPayments, entity);
    };
    PurchaseDownPaymentsRequestBuilder.prototype.delete = function (docEntryOrEntity) {
        return new core_1.DeleteRequestBuilderV4(PurchaseDownPayments_1.PurchaseDownPayments, docEntryOrEntity instanceof PurchaseDownPayments_1.PurchaseDownPayments ? docEntryOrEntity : { DocEntry: docEntryOrEntity });
    };
