...
var AdditionalExpensesRequestBuilder = /** @class */ (function (_super) {
    ...
    AdditionalExpensesRequestBuilder.prototype.getByKey = function (expensCode) {
        return new core_1.GetByKeyRequestBuilderV4(AdditionalExpenses_1.AdditionalExpenses, { ExpensCode: expensCode });
    };
    /**
    ...
    AdditionalExpensesRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(AdditionalExpenses_1.AdditionalExpenses);
    };
    /**
    ...
    AdditionalExpensesRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(AdditionalExpenses_1.AdditionalExpenses, entity);
    };
    /**
    ...
    AdditionalExpensesRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(AdditionalExpenses_1.AdditionalExpenses, entity);
    };
    AdditionalExpensesRequestBuilder.prototype.delete = function (expensCodeOrEntity) {
        return new core_1.DeleteRequestBuilderV4(AdditionalExpenses_1.AdditionalExpenses, expensCodeOrEntity instanceof AdditionalExpenses_1.AdditionalExpenses ? expensCodeOrEntity : { ExpensCode: expensCodeOrEntity });
    };
