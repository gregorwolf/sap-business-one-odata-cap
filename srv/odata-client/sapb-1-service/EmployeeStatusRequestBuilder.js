...
var EmployeeStatusRequestBuilder = /** @class */ (function (_super) {
    ...
    EmployeeStatusRequestBuilder.prototype.getByKey = function (statusId) {
        return new v4_1.GetByKeyRequestBuilder(EmployeeStatus_1.EmployeeStatus, { StatusId: statusId });
    };
    /**
    ...
    EmployeeStatusRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(EmployeeStatus_1.EmployeeStatus);
    };
    /**
    ...
    EmployeeStatusRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(EmployeeStatus_1.EmployeeStatus, entity);
    };
    /**
    ...
    EmployeeStatusRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(EmployeeStatus_1.EmployeeStatus, entity);
    };
    EmployeeStatusRequestBuilder.prototype.delete = function (statusIdOrEntity) {
        return new v4_1.DeleteRequestBuilder(EmployeeStatus_1.EmployeeStatus, statusIdOrEntity instanceof EmployeeStatus_1.EmployeeStatus ? statusIdOrEntity : { StatusId: statusIdOrEntity });
    };
