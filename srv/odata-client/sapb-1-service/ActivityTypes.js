...
var ActivityTypes = /** @class */ (function (_super) {
    ...
    ActivityTypes.builder = function () {
        return v4_1.Entity.entityBuilder(ActivityTypes);
    };
    /**
    ...
    ActivityTypes.customField = function (fieldName) {
        return v4_1.Entity.customFieldSelector(fieldName, ActivityTypes);
    };
    /**
     ...
     */
    ActivityTypes._serviceName = 'SAPB1';
    /**
     * Default url path for the according service.
     */
    ActivityTypes._defaultServicePath = 'VALUE_IS_UNDEFINED';
...
(function (ActivityTypes) {
     ...
     */
    ActivityTypes.CODE = new v4_1.NumberField('Code', ActivityTypes, 'Edm.Int32');
    /**
     * Static representation of the [[name]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ActivityTypes.NAME = new v4_1.StringField('Name', ActivityTypes, 'Edm.String');
    /**
     * Static representation of the one-to-many navigation property [[contacts]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ActivityTypes.CONTACTS = new v4_1.OneToManyLink('Contacts', ActivityTypes, Contacts_1.Contacts);
    /**
     * Static representation of the one-to-many navigation property [[activities]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ActivityTypes.ACTIVITIES = new v4_1.OneToManyLink('Activities', ActivityTypes, Activities_1.Activities);
    /**
     ...
     * All fields selector.
     */
    ActivityTypes.ALL_FIELDS = new v4_1.AllFields('*', ActivityTypes);
    /**
