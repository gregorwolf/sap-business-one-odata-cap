 ...
 */
export declare class PmSubprojectDocumentParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, PmSubprojectDocumentParams> {
    /**
...
export declare namespace PmSubprojectDocumentParams {
     ...
     */
    const _propertyMetadata: PropertyMetadata<PmSubprojectDocumentParams>[];
    /**
