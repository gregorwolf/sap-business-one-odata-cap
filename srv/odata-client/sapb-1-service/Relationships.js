...
var Relationships = /** @class */ (function (_super) {
    ...
    Relationships.builder = function () {
        return core_1.EntityV4.entityBuilder(Relationships);
    };
    /**
    ...
    Relationships.customField = function (fieldName) {
        return core_1.EntityV4.customFieldSelector(fieldName, Relationships);
    };
    /**
     ...
     */
    Relationships._defaultServicePath = '/b1s/v2/';
...
(function (Relationships) {
     ...
     */
    Relationships.RELATIONSHIP_DESCRIPTION = new core_1.StringField('RelationshipDescription', Relationships, 'Edm.String');
    /**
     * Static representation of the [[relationshipCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Relationships.RELATIONSHIP_CODE = new core_1.NumberField('RelationshipCode', Relationships, 'Edm.Int32');
    /**
     * Static representation of the one-to-many navigation property [[partnersSetups]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Relationships.PARTNERS_SETUPS = new core_1.OneToManyLink('PartnersSetups', Relationships, PartnersSetups_1.PartnersSetups);
    /**
     ...
     * All fields selector.
     */
    Relationships.ALL_FIELDS = new core_1.AllFields('*', Relationships);
    /**
