...
var PaymentRunExportParamsField = /** @class */ (function (_super) {
     ...
     */
    function PaymentRunExportParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, PaymentRunExportParams) || this;
        /**
...
(function (PaymentRunExportParams) {
     ...
     */
    PaymentRunExportParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, PaymentRunExportParams);
    }
