...
var MessagesRequestBuilder = /** @class */ (function (_super) {
    ...
    MessagesRequestBuilder.prototype.getByKey = function (code) {
        return new v4_1.GetByKeyRequestBuilder(Messages_1.Messages, { Code: code });
    };
    /**
    ...
    MessagesRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(Messages_1.Messages);
    };
    /**
    ...
    MessagesRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(Messages_1.Messages, entity);
    };
    /**
    ...
    MessagesRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(Messages_1.Messages, entity);
    };
    MessagesRequestBuilder.prototype.delete = function (codeOrEntity) {
        return new v4_1.DeleteRequestBuilder(Messages_1.Messages, codeOrEntity instanceof Messages_1.Messages ? codeOrEntity : { Code: codeOrEntity });
    };
