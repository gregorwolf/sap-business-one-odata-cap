 ...
 */
export class NatureOfAssesseeParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, NatureOfAssesseeParams> {
  /**
  ...
  constructor(fieldName: string, fieldOf: ConstructorOrField<EntityT>) {
    super(fieldName, fieldOf, NatureOfAssesseeParams);
  }
}
...
export namespace NatureOfAssesseeParams {
  ...
  export function build(json: { [keys: string]: FieldType }): NatureOfAssesseeParams {
    return deserializeComplexTypeV4(json, NatureOfAssesseeParams);
  }
}
