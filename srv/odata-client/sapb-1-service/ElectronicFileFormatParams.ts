 ...
 */
export class ElectronicFileFormatParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, ElectronicFileFormatParams> {
  /**
  ...
  constructor(fieldName: string, fieldOf: ConstructorOrField<EntityT>) {
    super(fieldName, fieldOf, ElectronicFileFormatParams);
  }
}
...
export namespace ElectronicFileFormatParams {
  ...
  export function build(json: { [keys: string]: FieldType }): ElectronicFileFormatParams {
    return deserializeComplexTypeV4(json, ElectronicFileFormatParams);
  }
}
