...
var ResourceProperties = /** @class */ (function (_super) {
    ...
    ResourceProperties.builder = function () {
        return core_1.EntityV4.entityBuilder(ResourceProperties);
    };
    /**
    ...
    ResourceProperties.customField = function (fieldName) {
        return core_1.EntityV4.customFieldSelector(fieldName, ResourceProperties);
    };
    /**
     ...
     */
    ResourceProperties._defaultServicePath = '/b1s/v2/';
...
(function (ResourceProperties) {
     ...
     */
    ResourceProperties.CODE = new core_1.NumberField('Code', ResourceProperties, 'Edm.Int32');
    /**
     * Static representation of the [[name]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ResourceProperties.NAME = new core_1.StringField('Name', ResourceProperties, 'Edm.String');
    /**
     ...
     * All fields selector.
     */
    ResourceProperties.ALL_FIELDS = new core_1.AllFields('*', ResourceProperties);
    /**
