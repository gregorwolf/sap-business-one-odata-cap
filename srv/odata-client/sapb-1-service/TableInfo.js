...
var TableInfoField = /** @class */ (function (_super) {
     ...
     */
    function TableInfoField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, TableInfo) || this;
        /**
...
(function (TableInfo) {
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, TableInfo);
    }
