 ...
 */
export declare class EmployeeRoleSetupParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, EmployeeRoleSetupParams> {
    /**
...
export declare namespace EmployeeRoleSetupParams {
     ...
     */
    const _propertyMetadata: PropertyMetadata<EmployeeRoleSetupParams>[];
    /**
