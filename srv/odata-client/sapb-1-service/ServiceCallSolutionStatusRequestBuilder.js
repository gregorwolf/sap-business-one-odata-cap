...
var ServiceCallSolutionStatusRequestBuilder = /** @class */ (function (_super) {
    ...
    ServiceCallSolutionStatusRequestBuilder.prototype.getByKey = function (statusId) {
        return new v4_1.GetByKeyRequestBuilder(ServiceCallSolutionStatus_1.ServiceCallSolutionStatus, { StatusId: statusId });
    };
    /**
    ...
    ServiceCallSolutionStatusRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(ServiceCallSolutionStatus_1.ServiceCallSolutionStatus);
    };
    /**
    ...
    ServiceCallSolutionStatusRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(ServiceCallSolutionStatus_1.ServiceCallSolutionStatus, entity);
    };
    /**
    ...
    ServiceCallSolutionStatusRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(ServiceCallSolutionStatus_1.ServiceCallSolutionStatus, entity);
    };
    ServiceCallSolutionStatusRequestBuilder.prototype.delete = function (statusIdOrEntity) {
        return new v4_1.DeleteRequestBuilder(ServiceCallSolutionStatus_1.ServiceCallSolutionStatus, statusIdOrEntity instanceof ServiceCallSolutionStatus_1.ServiceCallSolutionStatus ? statusIdOrEntity : { StatusId: statusIdOrEntity });
    };
