...
var SalesOpportunitiesInterestField = /** @class */ (function (_super) {
    ...
    function SalesOpportunitiesInterestField() {
         ...
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.interestId = new v4_1.ComplexTypeNumberPropertyField('InterestId', _this, 'Edm.Int32');
        return _this;
    }
...
(function (SalesOpportunitiesInterest) {
    function build(json) {
        return v4_1.createComplexType(json, {
            ...
            InterestId: function (interestId) { return ({ interestId: v4_1.edmToTs(interestId, 'Edm.Int32') }); }
        });
    }
