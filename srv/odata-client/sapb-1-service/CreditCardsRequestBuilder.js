...
var CreditCardsRequestBuilder = /** @class */ (function (_super) {
    ...
    CreditCardsRequestBuilder.prototype.getByKey = function (creditCardCode) {
        return new core_1.GetByKeyRequestBuilderV4(CreditCards_1.CreditCards, { CreditCardCode: creditCardCode });
    };
    /**
    ...
    CreditCardsRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(CreditCards_1.CreditCards);
    };
    /**
    ...
    CreditCardsRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(CreditCards_1.CreditCards, entity);
    };
    /**
    ...
    CreditCardsRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(CreditCards_1.CreditCards, entity);
    };
    CreditCardsRequestBuilder.prototype.delete = function (creditCardCodeOrEntity) {
        return new core_1.DeleteRequestBuilderV4(CreditCards_1.CreditCards, creditCardCodeOrEntity instanceof CreditCards_1.CreditCards ? creditCardCodeOrEntity : { CreditCardCode: creditCardCodeOrEntity });
    };
