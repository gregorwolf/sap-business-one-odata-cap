...
var FiscalPrinter = /** @class */ (function (_super) {
    ...
    FiscalPrinter.builder = function () {
        return v4_1.Entity.entityBuilder(FiscalPrinter);
    };
    /**
    ...
    FiscalPrinter.customField = function (fieldName) {
        return v4_1.Entity.customFieldSelector(fieldName, FiscalPrinter);
    };
    /**
     ...
     */
    FiscalPrinter._serviceName = 'SAPB1';
    /**
     * Default url path for the according service.
     */
    FiscalPrinter._defaultServicePath = 'VALUE_IS_UNDEFINED';
...
(function (FiscalPrinter) {
     ...
     */
    FiscalPrinter.EQUIPMENT_NO = new v4_1.StringField('EquipmentNo', FiscalPrinter, 'Edm.String');
    /**
     * Static representation of the [[model]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    FiscalPrinter.MODEL = new v4_1.StringField('Model', FiscalPrinter, 'Edm.String');
    /**
     * Static representation of the [[manufacturerSerialN]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    FiscalPrinter.MANUFACTURER_SERIAL_N = new v4_1.StringField('ManufacturerSerialN', FiscalPrinter, 'Edm.String');
    /**
     * Static representation of the [[registerNo]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    FiscalPrinter.REGISTER_NO = new v4_1.NumberField('RegisterNo', FiscalPrinter, 'Edm.Int32');
    /**
     * Static representation of the [[fiscalDocumentModel]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    FiscalPrinter.FISCAL_DOCUMENT_MODEL = new v4_1.StringField('FiscalDocumentModel', FiscalPrinter, 'Edm.String');
    /**
     * Static representation of the [[fiscalPrintersParams]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    FiscalPrinter.FISCAL_PRINTERS_PARAMS = new v4_1.CollectionField('FiscalPrintersParams', FiscalPrinter, new FiscalPrinterParams_1.FiscalPrinterParamsField('', FiscalPrinter));
    /**
     * Static representation of the one-to-one navigation property [[nfModel]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    FiscalPrinter.NF_MODEL = new v4_1.OneToOneLink('NFModel', FiscalPrinter, NfModels_1.NfModels);
    /**
     * Static representation of the one-to-many navigation property [[posDailySummary]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    FiscalPrinter.POS_DAILY_SUMMARY = new v4_1.OneToManyLink('POSDailySummary', FiscalPrinter, PosDailySummary_1.PosDailySummary);
    /**
     ...
     * All fields selector.
     */
    FiscalPrinter.ALL_FIELDS = new v4_1.AllFields('*', FiscalPrinter);
    /**
