 ...
 */
export declare class RecordsetParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, RecordsetParams> {
    /**
...
export declare namespace RecordsetParams {
     ...
     */
    const _propertyMetadata: PropertyMetadata<RecordsetParams>[];
    /**
