...
var ProductionOrdersSalesOrderLineField = /** @class */ (function (_super) {
    ...
    function ProductionOrdersSalesOrderLineField() {
         ...
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.baseNumber = new v4_1.ComplexTypeNumberPropertyField('BaseNumber', _this, 'Edm.Int32');
        /**
         * Representation of the [[ProductionOrdersSalesOrderLine.baseAbsEntry]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.baseAbsEntry = new v4_1.ComplexTypeNumberPropertyField('BaseAbsEntry', _this, 'Edm.Int32');
        /**
...
(function (ProductionOrdersSalesOrderLine) {
    function build(json) {
        return v4_1.createComplexType(json, {
            ...
            BaseNumber: function (baseNumber) { return ({ baseNumber: v4_1.edmToTs(baseNumber, 'Edm.Int32') }); },
            BaseAbsEntry: function (baseAbsEntry) { return ({ baseAbsEntry: v4_1.edmToTs(baseAbsEntry, 'Edm.Int32') }); },
