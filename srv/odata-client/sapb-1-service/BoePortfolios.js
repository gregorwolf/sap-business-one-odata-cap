...
var BoePortfolios = /** @class */ (function (_super) {
    ...
    BoePortfolios.builder = function () {
        return core_1.EntityV4.entityBuilder(BoePortfolios);
    };
    /**
    ...
    BoePortfolios.customField = function (fieldName) {
        return core_1.EntityV4.customFieldSelector(fieldName, BoePortfolios);
    };
    /**
     ...
     */
    BoePortfolios._defaultServicePath = '/b1s/v2/';
...
(function (BoePortfolios) {
     ...
     */
    BoePortfolios.PORTFOLIO_ENTRY = new core_1.NumberField('PortfolioEntry', BoePortfolios, 'Edm.Int32');
    /**
     * Static representation of the [[portfolioId]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BoePortfolios.PORTFOLIO_ID = new core_1.StringField('PortfolioID', BoePortfolios, 'Edm.String');
    /**
     * Static representation of the [[portfolioCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BoePortfolios.PORTFOLIO_CODE = new core_1.StringField('PortfolioCode', BoePortfolios, 'Edm.String');
    /**
     * Static representation of the [[portfolioNum]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BoePortfolios.PORTFOLIO_NUM = new core_1.StringField('PortfolioNum', BoePortfolios, 'Edm.String');
    /**
     * Static representation of the [[portfolioDescription]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BoePortfolios.PORTFOLIO_DESCRIPTION = new core_1.StringField('PortfolioDescription', BoePortfolios, 'Edm.String');
    /**
     ...
     * All fields selector.
     */
    BoePortfolios.ALL_FIELDS = new core_1.AllFields('*', BoePortfolios);
    /**
