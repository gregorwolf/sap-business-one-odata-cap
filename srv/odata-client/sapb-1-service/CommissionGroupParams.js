...
var CommissionGroupParamsField = /** @class */ (function (_super) {
     ...
     */
    function CommissionGroupParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, CommissionGroupParams) || this;
        /**
         * Representation of the [[CommissionGroupParams.commissionGroupCode]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.commissionGroupCode = new core_1.ComplexTypeNumberPropertyField('CommissionGroupCode', _this, 'Edm.Int32');
        return _this;
    }
...
(function (CommissionGroupParams) {
     ...
     */
    CommissionGroupParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, CommissionGroupParams);
    }
