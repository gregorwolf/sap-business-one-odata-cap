...
var BrazilStringIndexers = /** @class */ (function (_super) {
    ...
    BrazilStringIndexers.builder = function () {
        return v4_1.Entity.entityBuilder(BrazilStringIndexers);
    };
    /**
    ...
    BrazilStringIndexers.customField = function (fieldName) {
        return v4_1.Entity.customFieldSelector(fieldName, BrazilStringIndexers);
    };
    /**
     ...
     */
    BrazilStringIndexers._serviceName = 'SAPB1';
    /**
     * Default url path for the according service.
     */
    BrazilStringIndexers._defaultServicePath = 'VALUE_IS_UNDEFINED';
...
(function (BrazilStringIndexers) {
     ...
     */
    BrazilStringIndexers.CODE = new v4_1.StringField('Code', BrazilStringIndexers, 'Edm.String');
    /**
     * Static representation of the [[description]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BrazilStringIndexers.DESCRIPTION = new v4_1.StringField('Description', BrazilStringIndexers, 'Edm.String');
    /**
     * Static representation of the [[id]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BrazilStringIndexers.ID = new v4_1.NumberField('ID', BrazilStringIndexers, 'Edm.Int32');
    /**
     * Static representation of the one-to-many navigation property [[brazilBeverageIndexers]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BrazilStringIndexers.BRAZIL_BEVERAGE_INDEXERS = new v4_1.OneToManyLink('BrazilBeverageIndexers', BrazilStringIndexers, BrazilBeverageIndexers_1.BrazilBeverageIndexers);
    /**
     * Static representation of the one-to-many navigation property [[items]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BrazilStringIndexers.ITEMS = new v4_1.OneToManyLink('Items', BrazilStringIndexers, Items_1.Items);
    /**
     * Static representation of the one-to-many navigation property [[businessPlaces]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BrazilStringIndexers.BUSINESS_PLACES = new v4_1.OneToManyLink('BusinessPlaces', BrazilStringIndexers, BusinessPlaces_1.BusinessPlaces);
    /**
     * Static representation of the one-to-many navigation property [[withholdingTaxCodes]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BrazilStringIndexers.WITHHOLDING_TAX_CODES = new v4_1.OneToManyLink('WithholdingTaxCodes', BrazilStringIndexers, WithholdingTaxCodes_1.WithholdingTaxCodes);
    /**
     ...
     * All fields selector.
     */
    BrazilStringIndexers.ALL_FIELDS = new v4_1.AllFields('*', BrazilStringIndexers);
    /**
