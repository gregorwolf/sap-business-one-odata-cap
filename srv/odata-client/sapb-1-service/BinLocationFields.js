...
var BinLocationFields = /** @class */ (function (_super) {
    ...
    BinLocationFields.builder = function () {
        return core_1.EntityV4.entityBuilder(BinLocationFields);
    };
    /**
    ...
    BinLocationFields.customField = function (fieldName) {
        return core_1.EntityV4.customFieldSelector(fieldName, BinLocationFields);
    };
    /**
     ...
     */
    BinLocationFields._defaultServicePath = '/b1s/v2/';
...
(function (BinLocationFields) {
     ...
     */
    BinLocationFields.ABS_ENTRY = new core_1.NumberField('AbsEntry', BinLocationFields, 'Edm.Int32');
    /**
     * Static representation of the [[fieldType]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BinLocationFields.FIELD_TYPE = new core_1.EnumField('FieldType', BinLocationFields);
    /**
     * Static representation of the [[fieldNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BinLocationFields.FIELD_NUMBER = new core_1.NumberField('FieldNumber', BinLocationFields, 'Edm.Int32');
    /**
     * Static representation of the [[name]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BinLocationFields.NAME = new core_1.StringField('Name', BinLocationFields, 'Edm.String');
    /**
     * Static representation of the [[activated]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BinLocationFields.ACTIVATED = new core_1.EnumField('Activated', BinLocationFields);
    /**
     * Static representation of the [[defaultFieldName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BinLocationFields.DEFAULT_FIELD_NAME = new core_1.StringField('DefaultFieldName', BinLocationFields, 'Edm.String');
    /**
     * Static representation of the one-to-many navigation property [[binLocationAttributes]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BinLocationFields.BIN_LOCATION_ATTRIBUTES = new core_1.OneToManyLink('BinLocationAttributes', BinLocationFields, BinLocationAttributes_1.BinLocationAttributes);
    /**
     * Static representation of the one-to-many navigation property [[warehouseSublevelCodes]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BinLocationFields.WAREHOUSE_SUBLEVEL_CODES = new core_1.OneToManyLink('WarehouseSublevelCodes', BinLocationFields, WarehouseSublevelCodes_1.WarehouseSublevelCodes);
    /**
     ...
     * All fields selector.
     */
    BinLocationFields.ALL_FIELDS = new core_1.AllFields('*', BinLocationFields);
    /**
