...
var InventoryGenEntriesRequestBuilder = /** @class */ (function (_super) {
    ...
    InventoryGenEntriesRequestBuilder.prototype.getByKey = function (docEntry) {
        return new v4_1.GetByKeyRequestBuilder(InventoryGenEntries_1.InventoryGenEntries, { DocEntry: docEntry });
    };
    /**
    ...
    InventoryGenEntriesRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(InventoryGenEntries_1.InventoryGenEntries);
    };
    /**
    ...
    InventoryGenEntriesRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(InventoryGenEntries_1.InventoryGenEntries, entity);
    };
    /**
    ...
    InventoryGenEntriesRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(InventoryGenEntries_1.InventoryGenEntries, entity);
    };
    InventoryGenEntriesRequestBuilder.prototype.delete = function (docEntryOrEntity) {
        return new v4_1.DeleteRequestBuilder(InventoryGenEntries_1.InventoryGenEntries, docEntryOrEntity instanceof InventoryGenEntries_1.InventoryGenEntries ? docEntryOrEntity : { DocEntry: docEntryOrEntity });
    };
