...
var InternalReconciliationsRequestBuilder = /** @class */ (function (_super) {
    ...
    InternalReconciliationsRequestBuilder.prototype.getByKey = function (reconNum) {
        return new core_1.GetByKeyRequestBuilderV4(InternalReconciliations_1.InternalReconciliations, { ReconNum: reconNum });
    };
    /**
    ...
    InternalReconciliationsRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(InternalReconciliations_1.InternalReconciliations);
    };
    /**
    ...
    InternalReconciliationsRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(InternalReconciliations_1.InternalReconciliations, entity);
    };
    /**
    ...
    InternalReconciliationsRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(InternalReconciliations_1.InternalReconciliations, entity);
    };
    InternalReconciliationsRequestBuilder.prototype.delete = function (reconNumOrEntity) {
        return new core_1.DeleteRequestBuilderV4(InternalReconciliations_1.InternalReconciliations, reconNumOrEntity instanceof InternalReconciliations_1.InternalReconciliations ? reconNumOrEntity : { ReconNum: reconNumOrEntity });
    };
