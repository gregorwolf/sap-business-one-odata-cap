...
var SalesPersonParamsField = /** @class */ (function (_super) {
    ...
    function SalesPersonParamsField() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        /**
         * Representation of the [[SalesPersonParams.salesEmployeeCode]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.salesEmployeeCode = new v4_1.ComplexTypeNumberPropertyField('SalesEmployeeCode', _this, 'Edm.Int32');
        return _this;
    }
...
(function (SalesPersonParams) {
    function build(json) {
        return v4_1.createComplexType(json, {
            SalesEmployeeCode: function (salesEmployeeCode) { return ({ salesEmployeeCode: v4_1.edmToTs(salesEmployeeCode, 'Edm.Int32') }); }
        });
    }
