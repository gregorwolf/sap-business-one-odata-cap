...
import { CategoryGroup, CategoryGroupField } from './CategoryGroup';
 ...
 */
export class QueryAuthGroups extends Entity implements QueryAuthGroupsType {
  /**
  ...
  static builder(): EntityBuilderType<QueryAuthGroups, QueryAuthGroupsTypeForceMandatory> {
    return Entity.entityBuilder(QueryAuthGroups);
  }
  ...
  static customField(fieldName: string): CustomField<QueryAuthGroups> {
    return Entity.customFieldSelector(fieldName, QueryAuthGroups);
  }
...
export namespace QueryAuthGroups {
   ...
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const CATEGORY_GROUP_COLLECTION: CollectionField<QueryAuthGroups> = new CollectionField('CategoryGroupCollection', QueryAuthGroups, new CategoryGroupField('', QueryAuthGroups));
  /**
   * All fields of the QueryAuthGroups entity.
   */
  export const _allFields: Array<StringField<QueryAuthGroups> | NumberField<QueryAuthGroups> | CollectionField<QueryAuthGroups>> = [
