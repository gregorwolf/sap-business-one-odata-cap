...
var DepreciationTypePoolParamsField = /** @class */ (function (_super) {
     ...
     */
    function DepreciationTypePoolParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, DepreciationTypePoolParams) || this;
        /**
...
(function (DepreciationTypePoolParams) {
     ...
     */
    DepreciationTypePoolParams._propertyMetadata = [{
            originalName: 'Code',
            name: 'code',
            type: 'Edm.String',
            isCollection: false
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, DepreciationTypePoolParams);
    }
