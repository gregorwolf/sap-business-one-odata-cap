...
var ItemParamsField = /** @class */ (function (_super) {
     ...
     */
    function ItemParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, ItemParams) || this;
        /**
...
(function (ItemParams) {
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, ItemParams);
    }
