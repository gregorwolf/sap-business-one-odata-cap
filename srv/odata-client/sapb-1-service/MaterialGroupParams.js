...
var MaterialGroupParamsField = /** @class */ (function (_super) {
     ...
     */
    function MaterialGroupParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, MaterialGroupParams) || this;
        /**
         ...
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.materialGroupCode = new core_1.ComplexTypeStringPropertyField('MaterialGroupCode', _this, 'Edm.String');
        return _this;
    }
...
(function (MaterialGroupParams) {
     ...
     */
    MaterialGroupParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, MaterialGroupParams);
    }
