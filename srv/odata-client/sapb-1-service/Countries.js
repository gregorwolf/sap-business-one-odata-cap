...
var Countries = /** @class */ (function (_super) {
     ...
     */
    Countries._defaultServicePath = '/b1s/v2/';
    return Countries;
}(core_1.EntityV4));
...
(function (Countries) {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.CODE_FOR_REPORTS = new core_1.StringField('CodeForReports', Countries, 'Edm.String');
    /**
     * Static representation of the [[addressFormat]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.ADDRESS_FORMAT = new core_1.NumberField('AddressFormat', Countries, 'Edm.Int32');
    /**
     * Static representation of the [[eu]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.EU = new core_1.EnumField('EU', Countries);
    /**
     * Static representation of the [[numberOfDigitsForTaxId]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.NUMBER_OF_DIGITS_FOR_TAX_ID = new core_1.NumberField('NumberOfDigitsForTaxID', Countries, 'Edm.Int32');
    /**
     * Static representation of the [[bankCodeDigits]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.BANK_CODE_DIGITS = new core_1.NumberField('BankCodeDigits', Countries, 'Edm.Int32');
    /**
     * Static representation of the [[bankBranchDigits]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.BANK_BRANCH_DIGITS = new core_1.NumberField('BankBranchDigits', Countries, 'Edm.Int32');
    /**
     * Static representation of the [[bankAccountDigits]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.BANK_ACCOUNT_DIGITS = new core_1.NumberField('BankAccountDigits', Countries, 'Edm.Int32');
    /**
     * Static representation of the [[bankControlKeyDigits]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.BANK_CONTROL_KEY_DIGITS = new core_1.NumberField('BankControlKeyDigits', Countries, 'Edm.Int32');
    /**
     * Static representation of the [[domesticAccountValidation]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.DOMESTIC_ACCOUNT_VALIDATION = new core_1.EnumField('DomesticAccountValidation', Countries);
    /**
     * Static representation of the [[ibanValidation]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.IBAN_VALIDATION = new core_1.EnumField('IbanValidation', Countries);
    /**
     * Static representation of the [[blacklisted]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.BLACKLISTED = new core_1.EnumField('Blacklisted', Countries);
    /**
     * Static representation of the [[uicCountryCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.UIC_COUNTRY_CODE = new core_1.StringField('UICCountryCode', Countries, 'Edm.String');
    /**
     * Static representation of the [[eaeu]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.EAEU = new core_1.EnumField('EAEU', Countries);
    /**
     * Static representation of the one-to-many navigation property [[userDefaultGroups]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.USER_DEFAULT_GROUPS = new core_1.OneToManyLink('UserDefaultGroups', Countries, UserDefaultGroups_1.UserDefaultGroups);
    /**
     * Static representation of the one-to-many navigation property [[warehouses]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.WAREHOUSES = new core_1.OneToManyLink('Warehouses', Countries, Warehouses_1.Warehouses);
    /**
     * Static representation of the one-to-many navigation property [[inventoryGenEntries]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.INVENTORY_GEN_ENTRIES = new core_1.OneToManyLink('InventoryGenEntries', Countries, InventoryGenEntries_1.InventoryGenEntries);
    /**
     * Static representation of the one-to-many navigation property [[checksforPayment]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.CHECKSFOR_PAYMENT = new core_1.OneToManyLink('ChecksforPayment', Countries, ChecksforPayment_1.ChecksforPayment);
    /**
     * Static representation of the one-to-many navigation property [[purchaseQuotations]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.PURCHASE_QUOTATIONS = new core_1.OneToManyLink('PurchaseQuotations', Countries, PurchaseQuotations_1.PurchaseQuotations);
    /**
     * Static representation of the one-to-many navigation property [[vendorPayments]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.VENDOR_PAYMENTS = new core_1.OneToManyLink('VendorPayments', Countries, VendorPayments_1.VendorPayments);
    /**
     * Static representation of the one-to-many navigation property [[creditCards]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.CREDIT_CARDS = new core_1.OneToManyLink('CreditCards', Countries, CreditCards_1.CreditCards);
    /**
     * Static representation of the one-to-many navigation property [[contacts]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.CONTACTS = new core_1.OneToManyLink('Contacts', Countries, Contacts_1.Contacts);
    /**
     * Static representation of the one-to-many navigation property [[deliveryNotes]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.DELIVERY_NOTES = new core_1.OneToManyLink('DeliveryNotes', Countries, DeliveryNotes_1.DeliveryNotes);
    /**
     * Static representation of the one-to-many navigation property [[businessPartners]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.BUSINESS_PARTNERS = new core_1.OneToManyLink('BusinessPartners', Countries, BusinessPartners_1.BusinessPartners);
    /**
     * Static representation of the one-to-many navigation property [[quotations]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.QUOTATIONS = new core_1.OneToManyLink('Quotations', Countries, Quotations_1.Quotations);
    /**
     * Static representation of the one-to-many navigation property [[warehouseLocations]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.WAREHOUSE_LOCATIONS = new core_1.OneToManyLink('WarehouseLocations', Countries, WarehouseLocations_1.WarehouseLocations);
    /**
     * Static representation of the one-to-many navigation property [[inventoryGenExits]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.INVENTORY_GEN_EXITS = new core_1.OneToManyLink('InventoryGenExits', Countries, InventoryGenExits_1.InventoryGenExits);
    /**
     * Static representation of the one-to-many navigation property [[purchaseRequests]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.PURCHASE_REQUESTS = new core_1.OneToManyLink('PurchaseRequests', Countries, PurchaseRequests_1.PurchaseRequests);
    /**
     * Static representation of the one-to-many navigation property [[returnRequest]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.RETURN_REQUEST = new core_1.OneToManyLink('ReturnRequest', Countries, ReturnRequest_1.ReturnRequest);
    /**
     * Static representation of the one-to-many navigation property [[glAccountAdvancedRules]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.GL_ACCOUNT_ADVANCED_RULES = new core_1.OneToManyLink('GLAccountAdvancedRules', Countries, GlAccountAdvancedRules_1.GlAccountAdvancedRules);
    /**
     * Static representation of the one-to-many navigation property [[states]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.STATES = new core_1.OneToManyLink('States', Countries, States_1.States);
    /**
     * Static representation of the one-to-many navigation property [[purchaseReturns]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.PURCHASE_RETURNS = new core_1.OneToManyLink('PurchaseReturns', Countries, PurchaseReturns_1.PurchaseReturns);
    /**
     * Static representation of the one-to-many navigation property [[invoices]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.INVOICES = new core_1.OneToManyLink('Invoices', Countries, Invoices_1.Invoices);
    /**
     * Static representation of the one-to-many navigation property [[creditNotes]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.CREDIT_NOTES = new core_1.OneToManyLink('CreditNotes', Countries, CreditNotes_1.CreditNotes);
    /**
     * Static representation of the one-to-many navigation property [[businessPlaces]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.BUSINESS_PLACES = new core_1.OneToManyLink('BusinessPlaces', Countries, BusinessPlaces_1.BusinessPlaces);
    /**
     * Static representation of the one-to-many navigation property [[orders]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.ORDERS = new core_1.OneToManyLink('Orders', Countries, Orders_1.Orders);
    /**
     * Static representation of the one-to-many navigation property [[activities]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.ACTIVITIES = new core_1.OneToManyLink('Activities', Countries, Activities_1.Activities);
    /**
     * Static representation of the one-to-many navigation property [[downPayments]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.DOWN_PAYMENTS = new core_1.OneToManyLink('DownPayments', Countries, DownPayments_1.DownPayments);
    /**
     * Static representation of the one-to-many navigation property [[drafts]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.DRAFTS = new core_1.OneToManyLink('Drafts', Countries, Drafts_1.Drafts);
    /**
     * Static representation of the one-to-many navigation property [[wizardPaymentMethods]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.WIZARD_PAYMENT_METHODS = new core_1.OneToManyLink('WizardPaymentMethods', Countries, WizardPaymentMethods_1.WizardPaymentMethods);
    /**
     * Static representation of the one-to-many navigation property [[paymentDrafts]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.PAYMENT_DRAFTS = new core_1.OneToManyLink('PaymentDrafts', Countries, PaymentDrafts_1.PaymentDrafts);
    /**
     * Static representation of the one-to-many navigation property [[returns]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.RETURNS = new core_1.OneToManyLink('Returns', Countries, Returns_1.Returns);
    /**
     * Static representation of the one-to-many navigation property [[correctionInvoiceReversal]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.CORRECTION_INVOICE_REVERSAL = new core_1.OneToManyLink('CorrectionInvoiceReversal', Countries, CorrectionInvoiceReversal_1.CorrectionInvoiceReversal);
    /**
     * Static representation of the one-to-many navigation property [[correctionPurchaseInvoice]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.CORRECTION_PURCHASE_INVOICE = new core_1.OneToManyLink('CorrectionPurchaseInvoice', Countries, CorrectionPurchaseInvoice_1.CorrectionPurchaseInvoice);
    /**
     * Static representation of the one-to-many navigation property [[correctionPurchaseInvoiceReversal]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.CORRECTION_PURCHASE_INVOICE_REVERSAL = new core_1.OneToManyLink('CorrectionPurchaseInvoiceReversal', Countries, CorrectionPurchaseInvoiceReversal_1.CorrectionPurchaseInvoiceReversal);
    /**
     * Static representation of the one-to-many navigation property [[customerEquipmentCards]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.CUSTOMER_EQUIPMENT_CARDS = new core_1.OneToManyLink('CustomerEquipmentCards', Countries, CustomerEquipmentCards_1.CustomerEquipmentCards);
    /**
     * Static representation of the one-to-many navigation property [[purchaseInvoices]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.PURCHASE_INVOICES = new core_1.OneToManyLink('PurchaseInvoices', Countries, PurchaseInvoices_1.PurchaseInvoices);
    /**
     * Static representation of the one-to-many navigation property [[purchaseDeliveryNotes]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.PURCHASE_DELIVERY_NOTES = new core_1.OneToManyLink('PurchaseDeliveryNotes', Countries, PurchaseDeliveryNotes_1.PurchaseDeliveryNotes);
    /**
     * Static representation of the one-to-many navigation property [[correctionInvoice]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.CORRECTION_INVOICE = new core_1.OneToManyLink('CorrectionInvoice', Countries, CorrectionInvoice_1.CorrectionInvoice);
    /**
     * Static representation of the one-to-many navigation property [[purchaseCreditNotes]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.PURCHASE_CREDIT_NOTES = new core_1.OneToManyLink('PurchaseCreditNotes', Countries, PurchaseCreditNotes_1.PurchaseCreditNotes);
    /**
     * Static representation of the one-to-many navigation property [[serviceCalls]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.SERVICE_CALLS = new core_1.OneToManyLink('ServiceCalls', Countries, ServiceCalls_1.ServiceCalls);
    /**
     * Static representation of the one-to-many navigation property [[purchaseDownPayments]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.PURCHASE_DOWN_PAYMENTS = new core_1.OneToManyLink('PurchaseDownPayments', Countries, PurchaseDownPayments_1.PurchaseDownPayments);
    /**
     * Static representation of the one-to-many navigation property [[employeesInfo]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.EMPLOYEES_INFO = new core_1.OneToManyLink('EmployeesInfo', Countries, EmployeesInfo_1.EmployeesInfo);
    /**
     * Static representation of the one-to-many navigation property [[banks]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.BANKS = new core_1.OneToManyLink('Banks', Countries, Banks_1.Banks);
    /**
     * Static representation of the one-to-many navigation property [[purchaseOrders]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.PURCHASE_ORDERS = new core_1.OneToManyLink('PurchaseOrders', Countries, PurchaseOrders_1.PurchaseOrders);
    /**
     * Static representation of the one-to-many navigation property [[houseBankAccounts]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.HOUSE_BANK_ACCOUNTS = new core_1.OneToManyLink('HouseBankAccounts', Countries, HouseBankAccounts_1.HouseBankAccounts);
    /**
     * Static representation of the one-to-many navigation property [[goodsReturnRequest]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.GOODS_RETURN_REQUEST = new core_1.OneToManyLink('GoodsReturnRequest', Countries, GoodsReturnRequest_1.GoodsReturnRequest);
    /**
     * Static representation of the one-to-many navigation property [[incomingPayments]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Countries.INCOMING_PAYMENTS = new core_1.OneToManyLink('IncomingPayments', Countries, IncomingPayments_1.IncomingPayments);
    /**
