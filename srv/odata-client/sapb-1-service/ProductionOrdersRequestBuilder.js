...
var ProductionOrdersRequestBuilder = /** @class */ (function (_super) {
    ...
    ProductionOrdersRequestBuilder.prototype.getByKey = function (absoluteEntry) {
        return new v4_1.GetByKeyRequestBuilder(ProductionOrders_1.ProductionOrders, { AbsoluteEntry: absoluteEntry });
    };
    /**
    ...
    ProductionOrdersRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(ProductionOrders_1.ProductionOrders);
    };
    /**
    ...
    ProductionOrdersRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(ProductionOrders_1.ProductionOrders, entity);
    };
    /**
    ...
    ProductionOrdersRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(ProductionOrders_1.ProductionOrders, entity);
    };
    ProductionOrdersRequestBuilder.prototype.delete = function (absoluteEntryOrEntity) {
        return new v4_1.DeleteRequestBuilder(ProductionOrders_1.ProductionOrders, absoluteEntryOrEntity instanceof ProductionOrders_1.ProductionOrders ? absoluteEntryOrEntity : { AbsoluteEntry: absoluteEntryOrEntity });
    };
