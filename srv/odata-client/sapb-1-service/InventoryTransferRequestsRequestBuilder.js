...
var InventoryTransferRequestsRequestBuilder = /** @class */ (function (_super) {
    ...
    InventoryTransferRequestsRequestBuilder.prototype.getByKey = function (docEntry) {
        return new v4_1.GetByKeyRequestBuilder(InventoryTransferRequests_1.InventoryTransferRequests, { DocEntry: docEntry });
    };
    /**
    ...
    InventoryTransferRequestsRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(InventoryTransferRequests_1.InventoryTransferRequests);
    };
    /**
    ...
    InventoryTransferRequestsRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(InventoryTransferRequests_1.InventoryTransferRequests, entity);
    };
    /**
    ...
    InventoryTransferRequestsRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(InventoryTransferRequests_1.InventoryTransferRequests, entity);
    };
    InventoryTransferRequestsRequestBuilder.prototype.delete = function (docEntryOrEntity) {
        return new v4_1.DeleteRequestBuilder(InventoryTransferRequests_1.InventoryTransferRequests, docEntryOrEntity instanceof InventoryTransferRequests_1.InventoryTransferRequests ? docEntryOrEntity : { DocEntry: docEntryOrEntity });
    };
