...
var LandedCosts = /** @class */ (function (_super) {
    ...
    LandedCosts.builder = function () {
        return core_1.EntityV4.entityBuilder(LandedCosts);
    };
    /**
    ...
    LandedCosts.customField = function (fieldName) {
        return core_1.EntityV4.customFieldSelector(fieldName, LandedCosts);
    };
    /**
     ...
     */
    LandedCosts._defaultServicePath = '/b1s/v2/';
    return LandedCosts;
}(core_1.EntityV4));
...
(function (LandedCosts) {
     ...
     */
    LandedCosts.DOC_ENTRY = new core_1.NumberField('DocEntry', LandedCosts, 'Edm.Int32');
    /**
     * Static representation of the [[landedCostNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.LANDED_COST_NUMBER = new core_1.NumberField('LandedCostNumber', LandedCosts, 'Edm.Int32');
    /**
     * Static representation of the [[postingDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.POSTING_DATE = new core_1.DateField('PostingDate', LandedCosts, 'Edm.DateTimeOffset');
    /**
     * Static representation of the [[dueDate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.DUE_DATE = new core_1.DateField('DueDate', LandedCosts, 'Edm.DateTimeOffset');
    /**
     * Static representation of the [[vendorCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.VENDOR_CODE = new core_1.StringField('VendorCode', LandedCosts, 'Edm.String');
    /**
     * Static representation of the [[vendorName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.VENDOR_NAME = new core_1.StringField('VendorName', LandedCosts, 'Edm.String');
    /**
     * Static representation of the [[broker]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.BROKER = new core_1.StringField('Broker', LandedCosts, 'Edm.String');
    /**
     * Static representation of the [[brokerName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.BROKER_NAME = new core_1.StringField('BrokerName', LandedCosts, 'Edm.String');
    /**
     * Static representation of the [[closedDocument]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.CLOSED_DOCUMENT = new core_1.EnumField('ClosedDocument', LandedCosts);
    /**
     * Static representation of the [[fileNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.FILE_NUMBER = new core_1.StringField('FileNumber', LandedCosts, 'Edm.String');
    /**
     * Static representation of the [[remarks]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.REMARKS = new core_1.StringField('Remarks', LandedCosts, 'Edm.String');
    /**
     * Static representation of the [[reference]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.REFERENCE = new core_1.StringField('Reference', LandedCosts, 'Edm.String');
    /**
     * Static representation of the [[documentCurrency]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.DOCUMENT_CURRENCY = new core_1.StringField('DocumentCurrency', LandedCosts, 'Edm.String');
    /**
     * Static representation of the [[documentRate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.DOCUMENT_RATE = new core_1.NumberField('DocumentRate', LandedCosts, 'Edm.Double');
    /**
     * Static representation of the [[projectedCustoms]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.PROJECTED_CUSTOMS = new core_1.NumberField('ProjectedCustoms', LandedCosts, 'Edm.Double');
    /**
     * Static representation of the [[actualCustoms]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.ACTUAL_CUSTOMS = new core_1.NumberField('ActualCustoms', LandedCosts, 'Edm.Double');
    /**
     * Static representation of the [[actualCustomsFc]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.ACTUAL_CUSTOMS_FC = new core_1.NumberField('ActualCustomsFC', LandedCosts, 'Edm.Double');
    /**
     * Static representation of the [[tax1]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.TAX_1 = new core_1.NumberField('Tax1', LandedCosts, 'Edm.Double');
    /**
     * Static representation of the [[tax2]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.TAX_2 = new core_1.NumberField('Tax2', LandedCosts, 'Edm.Double');
    /**
     * Static representation of the [[beforeTax]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.BEFORE_TAX = new core_1.NumberField('BeforeTax', LandedCosts, 'Edm.Double');
    /**
     * Static representation of the [[total]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.TOTAL = new core_1.NumberField('Total', LandedCosts, 'Edm.Double');
    /**
     * Static representation of the [[totalFreightCharges]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.TOTAL_FREIGHT_CHARGES = new core_1.NumberField('TotalFreightCharges', LandedCosts, 'Edm.Double');
    /**
     * Static representation of the [[projectedCustomsFc]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.PROJECTED_CUSTOMS_FC = new core_1.NumberField('ProjectedCustomsFC', LandedCosts, 'Edm.Double');
    /**
     * Static representation of the [[tax1Fc]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.TAX_1_FC = new core_1.NumberField('Tax1FC', LandedCosts, 'Edm.Double');
    /**
     * Static representation of the [[tax2Fc]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.TAX_2_FC = new core_1.NumberField('Tax2FC', LandedCosts, 'Edm.Double');
    /**
     * Static representation of the [[beforeTaxFc]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.BEFORE_TAX_FC = new core_1.NumberField('BeforeTaxFC', LandedCosts, 'Edm.Double');
    /**
     * Static representation of the [[totalFc]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.TOTAL_FC = new core_1.NumberField('TotalFC', LandedCosts, 'Edm.Double');
    /**
     * Static representation of the [[totalFreightChargesFc]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.TOTAL_FREIGHT_CHARGES_FC = new core_1.NumberField('TotalFreightChargesFC', LandedCosts, 'Edm.Double');
    /**
     * Static representation of the [[series]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.SERIES = new core_1.NumberField('Series', LandedCosts, 'Edm.Int32');
    /**
     * Static representation of the [[customsAffectsInventory]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.CUSTOMS_AFFECTS_INVENTORY = new core_1.EnumField('CustomsAffectsInventory', LandedCosts);
    /**
     * Static representation of the [[amountToBalance]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.AMOUNT_TO_BALANCE = new core_1.NumberField('AmountToBalance', LandedCosts, 'Edm.Double');
    /**
     * Static representation of the [[amountToBalanceFc]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.AMOUNT_TO_BALANCE_FC = new core_1.NumberField('AmountToBalanceFC', LandedCosts, 'Edm.Double');
    /**
     * Static representation of the [[billofLadingNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.BILLOF_LADING_NUMBER = new core_1.StringField('BillofLadingNumber', LandedCosts, 'Edm.String');
    /**
     * Static representation of the [[transportType]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.TRANSPORT_TYPE = new core_1.NumberField('TransportType', LandedCosts, 'Edm.Int32');
    /**
     * Static representation of the [[transactionNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.TRANSACTION_NUMBER = new core_1.NumberField('TransactionNumber', LandedCosts, 'Edm.Int32');
    /**
     * Static representation of the [[journalRemarks]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.JOURNAL_REMARKS = new core_1.StringField('JournalRemarks', LandedCosts, 'Edm.String');
    /**
     * Static representation of the [[attachmentEntry]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.ATTACHMENT_ENTRY = new core_1.NumberField('AttachmentEntry', LandedCosts, 'Edm.Int32');
    /**
     * Static representation of the [[landedCostItemLines]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.LANDED_COST_ITEM_LINES = new core_1.CollectionField('LandedCost_ItemLines', LandedCosts, LandedCostItemLine_1.LandedCostItemLine);
    /**
     * Static representation of the [[landedCostCostLines]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.LANDED_COST_COST_LINES = new core_1.CollectionField('LandedCost_CostLines', LandedCosts, LandedCostCostLine_1.LandedCostCostLine);
    /**
     * Static representation of the one-to-one navigation property [[businessPartner]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.BUSINESS_PARTNER = new core_1.OneToOneLink('BusinessPartner', LandedCosts, BusinessPartners_1.BusinessPartners);
    /**
     * Static representation of the one-to-one navigation property [[shippingType]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.SHIPPING_TYPE = new core_1.OneToOneLink('ShippingType', LandedCosts, ShippingTypes_1.ShippingTypes);
    /**
     * Static representation of the one-to-one navigation property [[journalEntry]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.JOURNAL_ENTRY = new core_1.OneToOneLink('JournalEntry', LandedCosts, JournalEntries_1.JournalEntries);
    /**
     * Static representation of the one-to-many navigation property [[purchaseDeliveryNotes]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCosts.PURCHASE_DELIVERY_NOTES = new core_1.OneToManyLink('PurchaseDeliveryNotes', LandedCosts, PurchaseDeliveryNotes_1.PurchaseDeliveryNotes);
    /**
     ...
     * All fields selector.
     */
    LandedCosts.ALL_FIELDS = new core_1.AllFields('*', LandedCosts);
    /**
