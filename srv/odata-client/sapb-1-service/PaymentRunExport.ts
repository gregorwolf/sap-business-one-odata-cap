...
import { PaymentRunExportLine, PaymentRunExportLineField } from './PaymentRunExportLine';
 ...
 */
export class PaymentRunExport extends Entity implements PaymentRunExportType {
  /**
  ...
  static builder(): EntityBuilderType<PaymentRunExport, PaymentRunExportTypeForceMandatory> {
    return Entity.entityBuilder(PaymentRunExport);
  }
  ...
  static customField(fieldName: string): CustomField<PaymentRunExport> {
    return Entity.customFieldSelector(fieldName, PaymentRunExport);
  }
...
export namespace PaymentRunExport {
   ...
   * Use to reference this property in query operations such as 'select' in the fluent request API.
   */
  export const PAYMENT_RUN_EXPORT_LINES: CollectionField<PaymentRunExport> = new CollectionField('PaymentRunExport_Lines', PaymentRunExport, new PaymentRunExportLineField('', PaymentRunExport));
  /**
   ...
   */
  export const _allFields: Array<NumberField<PaymentRunExport> | DateField<PaymentRunExport> | StringField<PaymentRunExport> | CollectionField<PaymentRunExport> | OneToOneLink<PaymentRunExport, BankChargesAllocationCodes>> = [
