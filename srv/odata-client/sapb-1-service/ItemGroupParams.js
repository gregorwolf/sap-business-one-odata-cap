...
var ItemGroupParamsField = /** @class */ (function (_super) {
     ...
     */
    function ItemGroupParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, ItemGroupParams) || this;
        /**
...
(function (ItemGroupParams) {
     ...
     */
    ItemGroupParams._propertyMetadata = [{
            originalName: 'Number',
            name: 'number',
            type: 'Edm.Int32',
            isCollection: false
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, ItemGroupParams);
    }
