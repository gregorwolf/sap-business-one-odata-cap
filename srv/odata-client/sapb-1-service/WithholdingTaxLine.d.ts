 ...
 */
export declare class WithholdingTaxLineField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, WithholdingTaxLine> {
    /**
...
export declare namespace WithholdingTaxLine {
     ...
     */
    const _propertyMetadata: PropertyMetadata<WithholdingTaxLine>[];
    /**
