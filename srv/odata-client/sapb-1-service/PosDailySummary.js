...
var PosDailySummary = /** @class */ (function (_super) {
    ...
    PosDailySummary.builder = function () {
        return v4_1.Entity.entityBuilder(PosDailySummary);
    };
    /**
    ...
    PosDailySummary.customField = function (fieldName) {
        return v4_1.Entity.customFieldSelector(fieldName, PosDailySummary);
    };
    /**
     ...
     */
    PosDailySummary._serviceName = 'SAPB1';
    /**
     * Default url path for the according service.
     */
    PosDailySummary._defaultServicePath = 'VALUE_IS_UNDEFINED';
...
(function (PosDailySummary) {
     ...
     */
    PosDailySummary.ABS_ENTRY = new v4_1.NumberField('AbsEntry', PosDailySummary, 'Edm.Int32');
    /**
     * Static representation of the [[date]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.DATE = new v4_1.DateField('Date', PosDailySummary, 'Edm.DateTimeOffset');
    /**
     * Static representation of the [[equipmentNo]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.EQUIPMENT_NO = new v4_1.StringField('EquipmentNo', PosDailySummary, 'Edm.String');
    /**
     * Static representation of the [[counterPosition]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.COUNTER_POSITION = new v4_1.NumberField('CounterPosition', PosDailySummary, 'Edm.Int32');
    /**
     * Static representation of the [[resetCounterPosition]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.RESET_COUNTER_POSITION = new v4_1.NumberField('ResetCounterPosition', PosDailySummary, 'Edm.Int32');
    /**
     * Static representation of the [[operationCounter]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.OPERATION_COUNTER = new v4_1.NumberField('OperationCounter', PosDailySummary, 'Edm.Int32');
    /**
     * Static representation of the [[total]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.TOTAL = new v4_1.NumberField('Total', PosDailySummary, 'Edm.Double');
    /**
     * Static representation of the [[grossSales]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.GROSS_SALES = new v4_1.NumberField('GrossSales', PosDailySummary, 'Edm.Double');
    /**
     * Static representation of the [[pisTotal]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.PIS_TOTAL = new v4_1.NumberField('PISTotal', PosDailySummary, 'Edm.Double');
    /**
     * Static representation of the [[cofinsTotal]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.COFINS_TOTAL = new v4_1.NumberField('COFINSTotal', PosDailySummary, 'Edm.Double');
    /**
     * Static representation of the [[posTotalizerCollection]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.POS_TOTALIZER_COLLECTION = new v4_1.CollectionField('POSTotalizerCollection', PosDailySummary, new PosTotalizer_1.PosTotalizerField('', PosDailySummary));
    /**
     * Static representation of the one-to-many navigation property [[inventoryGenEntries]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.INVENTORY_GEN_ENTRIES = new v4_1.OneToManyLink('InventoryGenEntries', PosDailySummary, InventoryGenEntries_1.InventoryGenEntries);
    /**
     * Static representation of the one-to-many navigation property [[purchaseQuotations]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.PURCHASE_QUOTATIONS = new v4_1.OneToManyLink('PurchaseQuotations', PosDailySummary, PurchaseQuotations_1.PurchaseQuotations);
    /**
     * Static representation of the one-to-many navigation property [[deliveryNotes]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.DELIVERY_NOTES = new v4_1.OneToManyLink('DeliveryNotes', PosDailySummary, DeliveryNotes_1.DeliveryNotes);
    /**
     * Static representation of the one-to-many navigation property [[quotations]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.QUOTATIONS = new v4_1.OneToManyLink('Quotations', PosDailySummary, Quotations_1.Quotations);
    /**
     * Static representation of the one-to-many navigation property [[inventoryGenExits]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.INVENTORY_GEN_EXITS = new v4_1.OneToManyLink('InventoryGenExits', PosDailySummary, InventoryGenExits_1.InventoryGenExits);
    /**
     * Static representation of the one-to-many navigation property [[purchaseRequests]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.PURCHASE_REQUESTS = new v4_1.OneToManyLink('PurchaseRequests', PosDailySummary, PurchaseRequests_1.PurchaseRequests);
    /**
     * Static representation of the one-to-many navigation property [[returnRequest]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.RETURN_REQUEST = new v4_1.OneToManyLink('ReturnRequest', PosDailySummary, ReturnRequest_1.ReturnRequest);
    /**
     * Static representation of the one-to-many navigation property [[purchaseReturns]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.PURCHASE_RETURNS = new v4_1.OneToManyLink('PurchaseReturns', PosDailySummary, PurchaseReturns_1.PurchaseReturns);
    /**
     * Static representation of the one-to-many navigation property [[invoices]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.INVOICES = new v4_1.OneToManyLink('Invoices', PosDailySummary, Invoices_1.Invoices);
    /**
     * Static representation of the one-to-many navigation property [[creditNotes]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.CREDIT_NOTES = new v4_1.OneToManyLink('CreditNotes', PosDailySummary, CreditNotes_1.CreditNotes);
    /**
     * Static representation of the one-to-many navigation property [[orders]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.ORDERS = new v4_1.OneToManyLink('Orders', PosDailySummary, Orders_1.Orders);
    /**
     * Static representation of the one-to-many navigation property [[downPayments]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.DOWN_PAYMENTS = new v4_1.OneToManyLink('DownPayments', PosDailySummary, DownPayments_1.DownPayments);
    /**
     * Static representation of the one-to-many navigation property [[drafts]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.DRAFTS = new v4_1.OneToManyLink('Drafts', PosDailySummary, Drafts_1.Drafts);
    /**
     * Static representation of the one-to-many navigation property [[returns]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.RETURNS = new v4_1.OneToManyLink('Returns', PosDailySummary, Returns_1.Returns);
    /**
     * Static representation of the one-to-many navigation property [[correctionInvoiceReversal]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.CORRECTION_INVOICE_REVERSAL = new v4_1.OneToManyLink('CorrectionInvoiceReversal', PosDailySummary, CorrectionInvoiceReversal_1.CorrectionInvoiceReversal);
    /**
     * Static representation of the one-to-many navigation property [[correctionPurchaseInvoice]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.CORRECTION_PURCHASE_INVOICE = new v4_1.OneToManyLink('CorrectionPurchaseInvoice', PosDailySummary, CorrectionPurchaseInvoice_1.CorrectionPurchaseInvoice);
    /**
     * Static representation of the one-to-many navigation property [[correctionPurchaseInvoiceReversal]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.CORRECTION_PURCHASE_INVOICE_REVERSAL = new v4_1.OneToManyLink('CorrectionPurchaseInvoiceReversal', PosDailySummary, CorrectionPurchaseInvoiceReversal_1.CorrectionPurchaseInvoiceReversal);
    /**
     * Static representation of the one-to-one navigation property [[fiscalPrinter]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.FISCAL_PRINTER = new v4_1.OneToOneLink('FiscalPrinter', PosDailySummary, FiscalPrinter_1.FiscalPrinter);
    /**
     * Static representation of the one-to-many navigation property [[purchaseInvoices]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.PURCHASE_INVOICES = new v4_1.OneToManyLink('PurchaseInvoices', PosDailySummary, PurchaseInvoices_1.PurchaseInvoices);
    /**
     * Static representation of the one-to-many navigation property [[purchaseDeliveryNotes]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.PURCHASE_DELIVERY_NOTES = new v4_1.OneToManyLink('PurchaseDeliveryNotes', PosDailySummary, PurchaseDeliveryNotes_1.PurchaseDeliveryNotes);
    /**
     * Static representation of the one-to-many navigation property [[correctionInvoice]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.CORRECTION_INVOICE = new v4_1.OneToManyLink('CorrectionInvoice', PosDailySummary, CorrectionInvoice_1.CorrectionInvoice);
    /**
     * Static representation of the one-to-many navigation property [[purchaseCreditNotes]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.PURCHASE_CREDIT_NOTES = new v4_1.OneToManyLink('PurchaseCreditNotes', PosDailySummary, PurchaseCreditNotes_1.PurchaseCreditNotes);
    /**
     * Static representation of the one-to-many navigation property [[purchaseDownPayments]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.PURCHASE_DOWN_PAYMENTS = new v4_1.OneToManyLink('PurchaseDownPayments', PosDailySummary, PurchaseDownPayments_1.PurchaseDownPayments);
    /**
     * Static representation of the one-to-many navigation property [[purchaseOrders]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.PURCHASE_ORDERS = new v4_1.OneToManyLink('PurchaseOrders', PosDailySummary, PurchaseOrders_1.PurchaseOrders);
    /**
     * Static representation of the one-to-many navigation property [[goodsReturnRequest]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    PosDailySummary.GOODS_RETURN_REQUEST = new v4_1.OneToManyLink('GoodsReturnRequest', PosDailySummary, GoodsReturnRequest_1.GoodsReturnRequest);
    /**
     ...
     * All fields selector.
     */
    PosDailySummary.ALL_FIELDS = new v4_1.AllFields('*', PosDailySummary);
    /**
