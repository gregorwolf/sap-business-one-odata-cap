...
var PaymentsApprovalRequestField = /** @class */ (function (_super) {
     ...
     */
    function PaymentsApprovalRequestField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, PaymentsApprovalRequest) || this;
        /**
...
(function (PaymentsApprovalRequest) {
     ...
     */
    PaymentsApprovalRequest._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, PaymentsApprovalRequest);
    }
