 ...
 */
export declare class SectionParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, SectionParams> {
    /**
...
export declare namespace SectionParams {
     ...
     */
    const _propertyMetadata: PropertyMetadata<SectionParams>[];
    /**
