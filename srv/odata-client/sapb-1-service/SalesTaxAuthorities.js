...
var SalesTaxAuthorities = /** @class */ (function (_super) {
    ...
    SalesTaxAuthorities.builder = function () {
        return core_1.EntityV4.entityBuilder(SalesTaxAuthorities);
    };
    /**
    ...
    SalesTaxAuthorities.customField = function (fieldName) {
        return core_1.EntityV4.customFieldSelector(fieldName, SalesTaxAuthorities);
    };
    /**
     ...
     */
    SalesTaxAuthorities._defaultServicePath = '/b1s/v2/';
...
(function (SalesTaxAuthorities) {
     ...
     */
    SalesTaxAuthorities.USE_TAX_ACCOUNT = new core_1.StringField('UseTaxAccount', SalesTaxAuthorities, 'Edm.String');
    /**
     * Static representation of the [[userSignature]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SalesTaxAuthorities.USER_SIGNATURE = new core_1.NumberField('UserSignature', SalesTaxAuthorities, 'Edm.Int32');
    /**
     * Static representation of the [[type]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SalesTaxAuthorities.TYPE = new core_1.NumberField('Type', SalesTaxAuthorities, 'Edm.Int32');
    /**
     * Static representation of the [[aOrRTaxAccount]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SalesTaxAuthorities.A_OR_R_TAX_ACCOUNT = new core_1.StringField('AOrRTaxAccount', SalesTaxAuthorities, 'Edm.String');
    /**
     * Static representation of the [[rate]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SalesTaxAuthorities.RATE = new core_1.NumberField('Rate', SalesTaxAuthorities, 'Edm.Double');
    /**
     * Static representation of the [[aOrPTaxAccount]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SalesTaxAuthorities.A_OR_P_TAX_ACCOUNT = new core_1.StringField('AOrPTaxAccount', SalesTaxAuthorities, 'Edm.String');
    /**
     * Static representation of the [[nonDeductiblePrecent]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SalesTaxAuthorities.NON_DEDUCTIBLE_PRECENT = new core_1.NumberField('NonDeductiblePrecent', SalesTaxAuthorities, 'Edm.Double');
    /**
     * Static representation of the [[nonDeductibleAccount]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SalesTaxAuthorities.NON_DEDUCTIBLE_ACCOUNT = new core_1.StringField('NonDeductibleAccount', SalesTaxAuthorities, 'Edm.String');
    /**
     * Static representation of the [[name]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SalesTaxAuthorities.NAME = new core_1.StringField('Name', SalesTaxAuthorities, 'Edm.String');
    /**
     * Static representation of the [[deferredTaxAccount]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SalesTaxAuthorities.DEFERRED_TAX_ACCOUNT = new core_1.StringField('DeferredTaxAccount', SalesTaxAuthorities, 'Edm.String');
    /**
     * Static representation of the [[code]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SalesTaxAuthorities.CODE = new core_1.StringField('Code', SalesTaxAuthorities, 'Edm.String');
    /**
     * Static representation of the [[minTaxableAmount]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SalesTaxAuthorities.MIN_TAXABLE_AMOUNT = new core_1.NumberField('MinTaxableAmount', SalesTaxAuthorities, 'Edm.Double');
    /**
     * Static representation of the [[maxTaxableAmount]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SalesTaxAuthorities.MAX_TAXABLE_AMOUNT = new core_1.NumberField('MaxTaxableAmount', SalesTaxAuthorities, 'Edm.Double');
    /**
     * Static representation of the [[flatTaxAmount]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SalesTaxAuthorities.FLAT_TAX_AMOUNT = new core_1.NumberField('FlatTaxAmount', SalesTaxAuthorities, 'Edm.Double');
    /**
     * Static representation of the [[inclInPrice]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SalesTaxAuthorities.INCL_IN_PRICE = new core_1.EnumField('InclInPrice', SalesTaxAuthorities);
    /**
     * Static representation of the [[exempt]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SalesTaxAuthorities.EXEMPT = new core_1.EnumField('Exempt', SalesTaxAuthorities);
    /**
     * Static representation of the [[apExpAccount]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SalesTaxAuthorities.AP_EXP_ACCOUNT = new core_1.StringField('APExpAccount', SalesTaxAuthorities, 'Edm.String');
    /**
     * Static representation of the [[arExpAccount]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SalesTaxAuthorities.AR_EXP_ACCOUNT = new core_1.StringField('ARExpAccount', SalesTaxAuthorities, 'Edm.String');
    /**
     * Static representation of the [[inclInGrossRevenue]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SalesTaxAuthorities.INCL_IN_GROSS_REVENUE = new core_1.EnumField('InclInGrossRevenue', SalesTaxAuthorities);
    /**
     * Static representation of the [[textCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SalesTaxAuthorities.TEXT_CODE = new core_1.NumberField('TextCode', SalesTaxAuthorities, 'Edm.Int32');
    /**
     * Static representation of the [[taxDefinitions]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SalesTaxAuthorities.TAX_DEFINITIONS = new core_1.CollectionField('TaxDefinitions', SalesTaxAuthorities, TaxDefinition_1.TaxDefinition);
    /**
     * Static representation of the one-to-one navigation property [[chartOfAccount]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SalesTaxAuthorities.CHART_OF_ACCOUNT = new core_1.OneToOneLink('ChartOfAccount', SalesTaxAuthorities, ChartOfAccounts_1.ChartOfAccounts);
    /**
     * Static representation of the one-to-one navigation property [[user]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SalesTaxAuthorities.USER = new core_1.OneToOneLink('User', SalesTaxAuthorities, Users_1.Users);
    /**
     * Static representation of the one-to-one navigation property [[salesTaxAuthoritiesType]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    SalesTaxAuthorities.SALES_TAX_AUTHORITIES_TYPE = new core_1.OneToOneLink('SalesTaxAuthoritiesType', SalesTaxAuthorities, SalesTaxAuthoritiesTypes_1.SalesTaxAuthoritiesTypes);
    /**
     ...
     * All fields selector.
     */
    SalesTaxAuthorities.ALL_FIELDS = new core_1.AllFields('*', SalesTaxAuthorities);
    /**
