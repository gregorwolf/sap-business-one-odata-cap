 ...
 */
export declare class ItemPreferredVendorField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, ItemPreferredVendor> {
    /**
...
export declare namespace ItemPreferredVendor {
     ...
     */
    const _propertyMetadata: PropertyMetadata<ItemPreferredVendor>[];
    /**
