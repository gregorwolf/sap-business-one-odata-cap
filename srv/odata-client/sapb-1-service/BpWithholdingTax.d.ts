 ...
 */
export declare class BpWithholdingTaxField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, BpWithholdingTax> {
    /**
...
export declare namespace BpWithholdingTax {
     ...
     */
    const _propertyMetadata: PropertyMetadata<BpWithholdingTax>[];
    /**
