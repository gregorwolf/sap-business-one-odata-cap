...
var ExternalReconciliationParamsField = /** @class */ (function (_super) {
     ...
     */
    function ExternalReconciliationParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, ExternalReconciliationParams) || this;
        /**
...
(function (ExternalReconciliationParams) {
     ...
     */
    ExternalReconciliationParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, ExternalReconciliationParams);
    }
