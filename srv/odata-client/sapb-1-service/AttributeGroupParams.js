...
var AttributeGroupParamsField = /** @class */ (function (_super) {
     ...
     */
    function AttributeGroupParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, AttributeGroupParams) || this;
        /**
...
(function (AttributeGroupParams) {
     ...
     */
    AttributeGroupParams._propertyMetadata = [{
            originalName: 'Code',
            name: 'code',
            type: 'Edm.Int32',
            isCollection: false
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, AttributeGroupParams);
    }
