...
var CreditPaymentMethodsRequestBuilder = /** @class */ (function (_super) {
    ...
    CreditPaymentMethodsRequestBuilder.prototype.getByKey = function (paymentMethodCode) {
        return new core_1.GetByKeyRequestBuilderV4(CreditPaymentMethods_1.CreditPaymentMethods, { PaymentMethodCode: paymentMethodCode });
    };
    /**
    ...
    CreditPaymentMethodsRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(CreditPaymentMethods_1.CreditPaymentMethods);
    };
    /**
    ...
    CreditPaymentMethodsRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(CreditPaymentMethods_1.CreditPaymentMethods, entity);
    };
    /**
    ...
    CreditPaymentMethodsRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(CreditPaymentMethods_1.CreditPaymentMethods, entity);
    };
    CreditPaymentMethodsRequestBuilder.prototype.delete = function (paymentMethodCodeOrEntity) {
        return new core_1.DeleteRequestBuilderV4(CreditPaymentMethods_1.CreditPaymentMethods, paymentMethodCodeOrEntity instanceof CreditPaymentMethods_1.CreditPaymentMethods ? paymentMethodCodeOrEntity : { PaymentMethodCode: paymentMethodCodeOrEntity });
    };
