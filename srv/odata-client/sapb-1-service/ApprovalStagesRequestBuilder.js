...
var ApprovalStagesRequestBuilder = /** @class */ (function (_super) {
    ...
    ApprovalStagesRequestBuilder.prototype.getByKey = function (code) {
        return new v4_1.GetByKeyRequestBuilder(ApprovalStages_1.ApprovalStages, { Code: code });
    };
    /**
    ...
    ApprovalStagesRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(ApprovalStages_1.ApprovalStages);
    };
    /**
    ...
    ApprovalStagesRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(ApprovalStages_1.ApprovalStages, entity);
    };
    /**
    ...
    ApprovalStagesRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(ApprovalStages_1.ApprovalStages, entity);
    };
    ApprovalStagesRequestBuilder.prototype.delete = function (codeOrEntity) {
        return new v4_1.DeleteRequestBuilder(ApprovalStages_1.ApprovalStages, codeOrEntity instanceof ApprovalStages_1.ApprovalStages ? codeOrEntity : { Code: codeOrEntity });
    };
