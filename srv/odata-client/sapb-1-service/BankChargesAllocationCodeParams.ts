 ...
 */
export class BankChargesAllocationCodeParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, BankChargesAllocationCodeParams> {
  /**
  ...
  constructor(fieldName: string, fieldOf: ConstructorOrField<EntityT>) {
    super(fieldName, fieldOf, BankChargesAllocationCodeParams);
  }
}
...
export namespace BankChargesAllocationCodeParams {
   ...
   */
  export const _propertyMetadata: PropertyMetadata<BankChargesAllocationCodeParams>[] = [{
    originalName: 'Code',
    name: 'code',
    type: 'Edm.String',
    isCollection: false
  ...
  export function build(json: { [keys: string]: FieldType }): BankChargesAllocationCodeParams {
    return deserializeComplexTypeV4(json, BankChargesAllocationCodeParams);
  }
}
