 ...
 */
export declare class WarehouseParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, WarehouseParams> {
    /**
...
export declare namespace WarehouseParams {
     ...
     */
    const _propertyMetadata: PropertyMetadata<WarehouseParams>[];
    /**
