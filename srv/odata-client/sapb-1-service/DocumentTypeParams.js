...
var DocumentTypeParamsField = /** @class */ (function (_super) {
     ...
     */
    function DocumentTypeParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, DocumentTypeParams) || this;
        /**
...
(function (DocumentTypeParams) {
     ...
     */
    DocumentTypeParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, DocumentTypeParams);
    }
