...
var ApprovalTemplateDocumentField = /** @class */ (function (_super) {
     ...
     */
    function ApprovalTemplateDocumentField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, ApprovalTemplateDocument) || this;
        /**
...
(function (ApprovalTemplateDocument) {
     ...
     */
    ApprovalTemplateDocument._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, ApprovalTemplateDocument);
    }
