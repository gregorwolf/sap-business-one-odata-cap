...
var IncomingPaymentsRequestBuilder = /** @class */ (function (_super) {
    ...
    IncomingPaymentsRequestBuilder.prototype.getByKey = function (docEntry) {
        return new core_1.GetByKeyRequestBuilderV4(IncomingPayments_1.IncomingPayments, { DocEntry: docEntry });
    };
    /**
    ...
    IncomingPaymentsRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(IncomingPayments_1.IncomingPayments);
    };
    /**
    ...
    IncomingPaymentsRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(IncomingPayments_1.IncomingPayments, entity);
    };
    /**
    ...
    IncomingPaymentsRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(IncomingPayments_1.IncomingPayments, entity);
    };
    IncomingPaymentsRequestBuilder.prototype.delete = function (docEntryOrEntity) {
        return new core_1.DeleteRequestBuilderV4(IncomingPayments_1.IncomingPayments, docEntryOrEntity instanceof IncomingPayments_1.IncomingPayments ? docEntryOrEntity : { DocEntry: docEntryOrEntity });
    };
