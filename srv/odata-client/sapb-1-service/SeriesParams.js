...
var SeriesParamsField = /** @class */ (function (_super) {
     ...
     */
    function SeriesParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, SeriesParams) || this;
        /**
...
(function (SeriesParams) {
     ...
     */
    SeriesParams._propertyMetadata = [{
            originalName: 'Series',
            name: 'series',
            type: 'Edm.Int32',
            isCollection: false
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, SeriesParams);
    }
