...
var IntegrationPackagesConfigureRequestBuilder = /** @class */ (function (_super) {
    ...
    IntegrationPackagesConfigureRequestBuilder.prototype.getByKey = function (absEntry) {
        return new v4_1.GetByKeyRequestBuilder(IntegrationPackagesConfigure_1.IntegrationPackagesConfigure, { AbsEntry: absEntry });
    };
    /**
    ...
    IntegrationPackagesConfigureRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(IntegrationPackagesConfigure_1.IntegrationPackagesConfigure);
    };
    /**
    ...
    IntegrationPackagesConfigureRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(IntegrationPackagesConfigure_1.IntegrationPackagesConfigure, entity);
    };
    /**
    ...
    IntegrationPackagesConfigureRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(IntegrationPackagesConfigure_1.IntegrationPackagesConfigure, entity);
    };
    IntegrationPackagesConfigureRequestBuilder.prototype.delete = function (absEntryOrEntity) {
        return new v4_1.DeleteRequestBuilder(IntegrationPackagesConfigure_1.IntegrationPackagesConfigure, absEntryOrEntity instanceof IntegrationPackagesConfigure_1.IntegrationPackagesConfigure ? absEntryOrEntity : { AbsEntry: absEntryOrEntity });
    };
