...
var QueueMemberField = /** @class */ (function (_super) {
    ...
    function QueueMemberField() {
         ...
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.memberUserId = new v4_1.ComplexTypeNumberPropertyField('MemberUserID', _this, 'Edm.Int32');
        return _this;
    }
...
(function (QueueMember) {
    function build(json) {
        return v4_1.createComplexType(json, {
            ...
            MemberUserID: function (memberUserId) { return ({ memberUserId: v4_1.edmToTs(memberUserId, 'Edm.Int32') }); }
        });
    }
