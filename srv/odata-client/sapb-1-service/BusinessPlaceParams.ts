 ...
 */
export class BusinessPlaceParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, BusinessPlaceParams> {
  /**
  ...
  constructor(fieldName: string, fieldOf: ConstructorOrField<EntityT>) {
    super(fieldName, fieldOf, BusinessPlaceParams);
  }
}
...
export namespace BusinessPlaceParams {
  ...
  export function build(json: { [keys: string]: FieldType }): BusinessPlaceParams {
    return deserializeComplexTypeV4(json, BusinessPlaceParams);
  }
}
