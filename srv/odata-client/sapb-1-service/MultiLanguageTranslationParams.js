...
var MultiLanguageTranslationParamsField = /** @class */ (function (_super) {
     ...
     */
    function MultiLanguageTranslationParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, MultiLanguageTranslationParams) || this;
        /**
...
(function (MultiLanguageTranslationParams) {
     ...
     */
    MultiLanguageTranslationParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, MultiLanguageTranslationParams);
    }
