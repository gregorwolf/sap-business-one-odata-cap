...
var ChartOfAccountsRequestBuilder = /** @class */ (function (_super) {
    ...
    ChartOfAccountsRequestBuilder.prototype.getByKey = function (code) {
        return new v4_1.GetByKeyRequestBuilder(ChartOfAccounts_1.ChartOfAccounts, { Code: code });
    };
    /**
    ...
    ChartOfAccountsRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(ChartOfAccounts_1.ChartOfAccounts);
    };
    /**
    ...
    ChartOfAccountsRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(ChartOfAccounts_1.ChartOfAccounts, entity);
    };
    /**
    ...
    ChartOfAccountsRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(ChartOfAccounts_1.ChartOfAccounts, entity);
    };
    ChartOfAccountsRequestBuilder.prototype.delete = function (codeOrEntity) {
        return new v4_1.DeleteRequestBuilder(ChartOfAccounts_1.ChartOfAccounts, codeOrEntity instanceof ChartOfAccounts_1.ChartOfAccounts ? codeOrEntity : { Code: codeOrEntity });
    };
