...
var ResourcesRequestBuilder = /** @class */ (function (_super) {
    ...
    ResourcesRequestBuilder.prototype.getByKey = function (code) {
        return new core_1.GetByKeyRequestBuilderV4(Resources_1.Resources, { Code: code });
    };
    /**
    ...
    ResourcesRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(Resources_1.Resources);
    };
    /**
    ...
    ResourcesRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(Resources_1.Resources, entity);
    };
    /**
    ...
    ResourcesRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(Resources_1.Resources, entity);
    };
    ResourcesRequestBuilder.prototype.delete = function (codeOrEntity) {
        return new core_1.DeleteRequestBuilderV4(Resources_1.Resources, codeOrEntity instanceof Resources_1.Resources ? codeOrEntity : { Code: codeOrEntity });
    };
