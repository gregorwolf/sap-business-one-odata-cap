...
var NatureOfAssesseesRequestBuilder = /** @class */ (function (_super) {
    ...
    NatureOfAssesseesRequestBuilder.prototype.getByKey = function (absEntry) {
        return new v4_1.GetByKeyRequestBuilder(NatureOfAssessees_1.NatureOfAssessees, { AbsEntry: absEntry });
    };
    /**
    ...
    NatureOfAssesseesRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(NatureOfAssessees_1.NatureOfAssessees);
    };
    /**
    ...
    NatureOfAssesseesRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(NatureOfAssessees_1.NatureOfAssessees, entity);
    };
    /**
    ...
    NatureOfAssesseesRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(NatureOfAssessees_1.NatureOfAssessees, entity);
    };
    NatureOfAssesseesRequestBuilder.prototype.delete = function (absEntryOrEntity) {
        return new v4_1.DeleteRequestBuilder(NatureOfAssessees_1.NatureOfAssessees, absEntryOrEntity instanceof NatureOfAssessees_1.NatureOfAssessees ? absEntryOrEntity : { AbsEntry: absEntryOrEntity });
    };
