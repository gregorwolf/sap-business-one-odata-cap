 ...
 */
export declare class PredefinedTextParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, PredefinedTextParams> {
    /**
...
export declare namespace PredefinedTextParams {
     ...
     */
    const _propertyMetadata: PropertyMetadata<PredefinedTextParams>[];
    /**
