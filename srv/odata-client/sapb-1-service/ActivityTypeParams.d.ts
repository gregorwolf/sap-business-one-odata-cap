 ...
 */
export declare class ActivityTypeParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, ActivityTypeParams> {
    /**
...
export declare namespace ActivityTypeParams {
     ...
     */
    const _propertyMetadata: PropertyMetadata<ActivityTypeParams>[];
    /**
