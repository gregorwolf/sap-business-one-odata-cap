 ...
 */
export class ExternalCallParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, ExternalCallParams> {
  /**
  ...
  constructor(fieldName: string, fieldOf: ConstructorOrField<EntityT>) {
    super(fieldName, fieldOf, ExternalCallParams);
  }
}
...
export namespace ExternalCallParams {
  ...
  export function build(json: { [keys: string]: FieldType }): ExternalCallParams {
    return deserializeComplexTypeV4(json, ExternalCallParams);
  }
}
