...
var UserPermissionTreeRequestBuilder = /** @class */ (function (_super) {
    ...
    UserPermissionTreeRequestBuilder.prototype.getByKey = function (permissionId) {
        return new core_1.GetByKeyRequestBuilderV4(UserPermissionTree_1.UserPermissionTree, { PermissionID: permissionId });
    };
    /**
    ...
    UserPermissionTreeRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(UserPermissionTree_1.UserPermissionTree);
    };
    /**
    ...
    UserPermissionTreeRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(UserPermissionTree_1.UserPermissionTree, entity);
    };
    /**
    ...
    UserPermissionTreeRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(UserPermissionTree_1.UserPermissionTree, entity);
    };
    UserPermissionTreeRequestBuilder.prototype.delete = function (permissionIdOrEntity) {
        return new core_1.DeleteRequestBuilderV4(UserPermissionTree_1.UserPermissionTree, permissionIdOrEntity instanceof UserPermissionTree_1.UserPermissionTree ? permissionIdOrEntity : { PermissionID: permissionIdOrEntity });
    };
