...
var ServiceCallsRequestBuilder = /** @class */ (function (_super) {
    ...
    ServiceCallsRequestBuilder.prototype.getByKey = function (serviceCallId) {
        return new core_1.GetByKeyRequestBuilderV4(ServiceCalls_1.ServiceCalls, { ServiceCallID: serviceCallId });
    };
    /**
    ...
    ServiceCallsRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(ServiceCalls_1.ServiceCalls);
    };
    /**
    ...
    ServiceCallsRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(ServiceCalls_1.ServiceCalls, entity);
    };
    /**
    ...
    ServiceCallsRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(ServiceCalls_1.ServiceCalls, entity);
    };
    ServiceCallsRequestBuilder.prototype.delete = function (serviceCallIdOrEntity) {
        return new core_1.DeleteRequestBuilderV4(ServiceCalls_1.ServiceCalls, serviceCallIdOrEntity instanceof ServiceCalls_1.ServiceCalls ? serviceCallIdOrEntity : { ServiceCallID: serviceCallIdOrEntity });
    };
