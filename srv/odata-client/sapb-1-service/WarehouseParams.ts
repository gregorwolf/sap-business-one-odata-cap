 ...
 */
export class WarehouseParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, WarehouseParams> {
  /**
  ...
  constructor(fieldName: string, fieldOf: ConstructorOrField<EntityT>) {
    super(fieldName, fieldOf, WarehouseParams);
  }
}
...
export namespace WarehouseParams {
  ...
  export function build(json: { [keys: string]: FieldType }): WarehouseParams {
    return deserializeComplexTypeV4(json, WarehouseParams);
  }
}
