...
var ItemBarCodeField = /** @class */ (function (_super) {
     ...
     */
    function ItemBarCodeField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, ItemBarCode) || this;
        /**
...
(function (ItemBarCode) {
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, ItemBarCode);
    }
