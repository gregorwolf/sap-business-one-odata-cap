...
var AccrualTypes = /** @class */ (function (_super) {
    ...
    AccrualTypes.builder = function () {
        return core_1.EntityV4.entityBuilder(AccrualTypes);
    };
    /**
    ...
    AccrualTypes.customField = function (fieldName) {
        return core_1.EntityV4.customFieldSelector(fieldName, AccrualTypes);
    };
    /**
     ...
     */
    AccrualTypes._defaultServicePath = '/b1s/v2/';
    return AccrualTypes;
}(core_1.EntityV4));
...
(function (AccrualTypes) {
     ...
     */
    AccrualTypes.CODE = new core_1.StringField('Code', AccrualTypes, 'Edm.String');
    /**
     * Static representation of the [[name]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AccrualTypes.NAME = new core_1.StringField('Name', AccrualTypes, 'Edm.String');
    /**
     * Static representation of the [[postingAccount]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AccrualTypes.POSTING_ACCOUNT = new core_1.StringField('PostingAccount', AccrualTypes, 'Edm.String');
    /**
     * Static representation of the [[calculationAccount]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AccrualTypes.CALCULATION_ACCOUNT = new core_1.StringField('CalculationAccount', AccrualTypes, 'Edm.String');
    /**
     * Static representation of the [[interimAccount]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AccrualTypes.INTERIM_ACCOUNT = new core_1.StringField('InterimAccount', AccrualTypes, 'Edm.String');
    /**
     * Static representation of the one-to-one navigation property [[chartOfAccount]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    AccrualTypes.CHART_OF_ACCOUNT = new core_1.OneToOneLink('ChartOfAccount', AccrualTypes, ChartOfAccounts_1.ChartOfAccounts);
    /**
     ...
     * All fields selector.
     */
    AccrualTypes.ALL_FIELDS = new core_1.AllFields('*', AccrualTypes);
    /**
