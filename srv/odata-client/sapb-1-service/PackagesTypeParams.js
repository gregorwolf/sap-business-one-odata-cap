...
var PackagesTypeParamsField = /** @class */ (function (_super) {
     ...
     */
    function PackagesTypeParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, PackagesTypeParams) || this;
        /**
...
(function (PackagesTypeParams) {
     ...
     */
    PackagesTypeParams._propertyMetadata = [{
            originalName: 'Code',
            name: 'code',
            type: 'Edm.Int32',
            isCollection: false
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, PackagesTypeParams);
    }
