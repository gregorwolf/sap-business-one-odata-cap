...
var BusinessPartnerProperties = /** @class */ (function (_super) {
    ...
    BusinessPartnerProperties.builder = function () {
        return v4_1.Entity.entityBuilder(BusinessPartnerProperties);
    };
    /**
    ...
    BusinessPartnerProperties.customField = function (fieldName) {
        return v4_1.Entity.customFieldSelector(fieldName, BusinessPartnerProperties);
    };
    /**
     ...
     */
    BusinessPartnerProperties._serviceName = 'SAPB1';
    /**
     * Default url path for the according service.
     */
    BusinessPartnerProperties._defaultServicePath = 'VALUE_IS_UNDEFINED';
...
(function (BusinessPartnerProperties) {
     ...
     */
    BusinessPartnerProperties.PROPERTY_CODE = new v4_1.NumberField('PropertyCode', BusinessPartnerProperties, 'Edm.Int32');
    /**
     * Static representation of the [[propertyName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BusinessPartnerProperties.PROPERTY_NAME = new v4_1.StringField('PropertyName', BusinessPartnerProperties, 'Edm.String');
    /**
     ...
     * All fields selector.
     */
    BusinessPartnerProperties.ALL_FIELDS = new v4_1.AllFields('*', BusinessPartnerProperties);
    /**
