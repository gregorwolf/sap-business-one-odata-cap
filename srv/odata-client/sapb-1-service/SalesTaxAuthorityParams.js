...
var SalesTaxAuthorityParamsField = /** @class */ (function (_super) {
    ...
    function SalesTaxAuthorityParamsField() {
         ...
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.type = new v4_1.ComplexTypeNumberPropertyField('Type', _this, 'Edm.Int32');
        return _this;
    }
...
(function (SalesTaxAuthorityParams) {
    function build(json) {
        return v4_1.createComplexType(json, {
            ...
            Type: function (type) { return ({ type: v4_1.edmToTs(type, 'Edm.Int32') }); }
        });
    }
