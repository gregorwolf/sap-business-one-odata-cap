...
var BudgetParamsField = /** @class */ (function (_super) {
     ...
     */
    function BudgetParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, BudgetParams) || this;
        /**
...
(function (BudgetParams) {
     ...
     */
    BudgetParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, BudgetParams);
    }
