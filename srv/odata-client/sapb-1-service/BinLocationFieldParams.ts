 ...
 */
export function createBinLocationFieldParams(json: any): BinLocationFieldParams {
 ...
 */
export class BinLocationFieldParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, BinLocationFieldParams> {
  /**
  ...
  constructor(fieldName: string, fieldOf: ConstructorOrField<EntityT>) {
    super(fieldName, fieldOf, BinLocationFieldParams);
  }
}
...
export namespace BinLocationFieldParams {
   ...
   */
  export function build(json: { [keys: string]: FieldType }): BinLocationFieldParams {
    return deserializeComplexTypeV4(json, BinLocationFieldParams);
  }
}
