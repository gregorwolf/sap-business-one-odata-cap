...
var ServiceCallProblemSubTypes = /** @class */ (function (_super) {
    ...
    ServiceCallProblemSubTypes.builder = function () {
        return core_1.EntityV4.entityBuilder(ServiceCallProblemSubTypes);
    };
    /**
    ...
    ServiceCallProblemSubTypes.customField = function (fieldName) {
        return core_1.EntityV4.customFieldSelector(fieldName, ServiceCallProblemSubTypes);
    };
    /**
     ...
     */
    ServiceCallProblemSubTypes._defaultServicePath = '/b1s/v2/';
...
(function (ServiceCallProblemSubTypes) {
     ...
     */
    ServiceCallProblemSubTypes.PROBLEM_SUB_TYPE_ID = new core_1.NumberField('ProblemSubTypeID', ServiceCallProblemSubTypes, 'Edm.Int32');
    /**
     * Static representation of the [[name]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ServiceCallProblemSubTypes.NAME = new core_1.StringField('Name', ServiceCallProblemSubTypes, 'Edm.String');
    /**
     * Static representation of the [[description]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ServiceCallProblemSubTypes.DESCRIPTION = new core_1.StringField('Description', ServiceCallProblemSubTypes, 'Edm.String');
    /**
     * Static representation of the one-to-many navigation property [[serviceCalls]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    ServiceCallProblemSubTypes.SERVICE_CALLS = new core_1.OneToManyLink('ServiceCalls', ServiceCallProblemSubTypes, ServiceCalls_1.ServiceCalls);
    /**
     ...
     * All fields selector.
     */
    ServiceCallProblemSubTypes.ALL_FIELDS = new core_1.AllFields('*', ServiceCallProblemSubTypes);
    /**
