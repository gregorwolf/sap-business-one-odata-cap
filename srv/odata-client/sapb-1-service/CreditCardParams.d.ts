 ...
 */
export declare class CreditCardParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, CreditCardParams> {
    /**
...
export declare namespace CreditCardParams {
     ...
     */
    const _propertyMetadata: PropertyMetadata<CreditCardParams>[];
    /**
