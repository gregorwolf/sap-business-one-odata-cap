...
var FormattedSearchParamsField = /** @class */ (function (_super) {
     ...
     */
    function FormattedSearchParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, FormattedSearchParams) || this;
        /**
         * Representation of the [[FormattedSearchParams.index]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.index = new core_1.ComplexTypeNumberPropertyField('Index', _this, 'Edm.Int32');
        return _this;
    }
...
(function (FormattedSearchParams) {
     ...
     */
    FormattedSearchParams._propertyMetadata = [{
            originalName: 'Index',
            name: 'index',
            type: 'Edm.Int32',
            isCollection: false
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, FormattedSearchParams);
    }
