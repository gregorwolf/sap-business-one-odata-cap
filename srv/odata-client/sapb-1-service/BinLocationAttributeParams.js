...
var BinLocationAttributeParamsField = /** @class */ (function (_super) {
    ...
    function BinLocationAttributeParamsField() {
         ...
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.attribute = new v4_1.ComplexTypeNumberPropertyField('Attribute', _this, 'Edm.Int32');
        /**
...
(function (BinLocationAttributeParams) {
    function build(json) {
        return v4_1.createComplexType(json, {
            ...
            Attribute: function (attribute) { return ({ attribute: v4_1.edmToTs(attribute, 'Edm.Int32') }); },
