...
var KpIsRequestBuilder = /** @class */ (function (_super) {
    ...
    KpIsRequestBuilder.prototype.getByKey = function (kpiCode) {
        return new core_1.GetByKeyRequestBuilderV4(KpIs_1.KpIs, { KPICode: kpiCode });
    };
    /**
    ...
    KpIsRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(KpIs_1.KpIs);
    };
    /**
    ...
    KpIsRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(KpIs_1.KpIs, entity);
    };
    /**
    ...
    KpIsRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(KpIs_1.KpIs, entity);
    };
    KpIsRequestBuilder.prototype.delete = function (kpiCodeOrEntity) {
        return new core_1.DeleteRequestBuilderV4(KpIs_1.KpIs, kpiCodeOrEntity instanceof KpIs_1.KpIs ? kpiCodeOrEntity : { KPICode: kpiCodeOrEntity });
    };
