...
var ResourceEmployeeField = /** @class */ (function (_super) {
    ...
    function ResourceEmployeeField() {
         ...
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.employee = new v4_1.ComplexTypeStringPropertyField('Employee', _this, 'Edm.String');
        return _this;
    }
...
(function (ResourceEmployee) {
    function build(json) {
        return v4_1.createComplexType(json, {
            ...
            Employee: function (employee) { return ({ employee: v4_1.edmToTs(employee, 'Edm.String') }); }
        });
    }
