...
var StockTransferTaxExtensionField = /** @class */ (function (_super) {
    ...
    function StockTransferTaxExtensionField() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        /**
         * Representation of the [[StockTransferTaxExtension.formNumber]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.formNumber = new v4_1.ComplexTypeStringPropertyField('FormNumber', _this, 'Edm.String');
        /**
         * Representation of the [[StockTransferTaxExtension.transactionCategory]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.transactionCategory = new v4_1.ComplexTypeStringPropertyField('TransactionCategory', _this, 'Edm.String');
        return _this;
    }
...
(function (StockTransferTaxExtension) {
    function build(json) {
        return v4_1.createComplexType(json, {
            FormNumber: function (formNumber) { return ({ formNumber: v4_1.edmToTs(formNumber, 'Edm.String') }); },
            TransactionCategory: function (transactionCategory) { return ({ transactionCategory: v4_1.edmToTs(transactionCategory, 'Edm.String') }); }
        });
    }
