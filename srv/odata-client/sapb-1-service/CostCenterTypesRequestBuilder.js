...
var CostCenterTypesRequestBuilder = /** @class */ (function (_super) {
    ...
    CostCenterTypesRequestBuilder.prototype.getByKey = function (costCenterTypeCode) {
        return new core_1.GetByKeyRequestBuilderV4(CostCenterTypes_1.CostCenterTypes, { CostCenterTypeCode: costCenterTypeCode });
    };
    /**
    ...
    CostCenterTypesRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(CostCenterTypes_1.CostCenterTypes);
    };
    /**
    ...
    CostCenterTypesRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(CostCenterTypes_1.CostCenterTypes, entity);
    };
    /**
    ...
    CostCenterTypesRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(CostCenterTypes_1.CostCenterTypes, entity);
    };
    CostCenterTypesRequestBuilder.prototype.delete = function (costCenterTypeCodeOrEntity) {
        return new core_1.DeleteRequestBuilderV4(CostCenterTypes_1.CostCenterTypes, costCenterTypeCodeOrEntity instanceof CostCenterTypes_1.CostCenterTypes ? costCenterTypeCodeOrEntity : { CostCenterTypeCode: costCenterTypeCodeOrEntity });
    };
