...
var VmThirdPartyValuesDataField = /** @class */ (function (_super) {
    ...
    function VmThirdPartyValuesDataField() {
         ...
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.thirdPartySystemId = new v4_1.ComplexTypeNumberPropertyField('ThirdPartySystemId', _this, 'Edm.Int32');
        /**
         * Representation of the [[VmThirdPartyValuesData.thirdPartyValue]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.thirdPartyValue = new v4_1.ComplexTypeStringPropertyField('ThirdPartyValue', _this, 'Edm.String');
        return _this;
    }
...
(function (VmThirdPartyValuesData) {
    function build(json) {
        return v4_1.createComplexType(json, {
            ...
            ThirdPartySystemId: function (thirdPartySystemId) { return ({ thirdPartySystemId: v4_1.edmToTs(thirdPartySystemId, 'Edm.Int32') }); },
            ThirdPartyValue: function (thirdPartyValue) { return ({ thirdPartyValue: v4_1.edmToTs(thirdPartyValue, 'Edm.String') }); }
        });
    }
