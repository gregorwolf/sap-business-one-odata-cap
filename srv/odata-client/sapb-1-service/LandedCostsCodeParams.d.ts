 ...
 */
export declare class LandedCostsCodeParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, LandedCostsCodeParams> {
    /**
...
export declare namespace LandedCostsCodeParams {
     ...
     */
    const _propertyMetadata: PropertyMetadata<LandedCostsCodeParams>[];
    /**
