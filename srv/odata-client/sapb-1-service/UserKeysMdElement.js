...
var UserKeysMdElementField = /** @class */ (function (_super) {
     ...
     */
    function UserKeysMdElementField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, UserKeysMdElement) || this;
        /**
         * Representation of the [[UserKeysMdElement.subKeyIndex]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.subKeyIndex = new core_1.ComplexTypeNumberPropertyField('SubKeyIndex', _this, 'Edm.Int32');
        /**
...
(function (UserKeysMdElement) {
     ...
     */
    UserKeysMdElement._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, UserKeysMdElement);
    }
