...
var PurchaseCreditNotesRequestBuilder = /** @class */ (function (_super) {
    ...
    PurchaseCreditNotesRequestBuilder.prototype.getByKey = function (docEntry) {
        return new v4_1.GetByKeyRequestBuilder(PurchaseCreditNotes_1.PurchaseCreditNotes, { DocEntry: docEntry });
    };
    /**
    ...
    PurchaseCreditNotesRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(PurchaseCreditNotes_1.PurchaseCreditNotes);
    };
    /**
    ...
    PurchaseCreditNotesRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(PurchaseCreditNotes_1.PurchaseCreditNotes, entity);
    };
    /**
    ...
    PurchaseCreditNotesRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(PurchaseCreditNotes_1.PurchaseCreditNotes, entity);
    };
    PurchaseCreditNotesRequestBuilder.prototype.delete = function (docEntryOrEntity) {
        return new v4_1.DeleteRequestBuilder(PurchaseCreditNotes_1.PurchaseCreditNotes, docEntryOrEntity instanceof PurchaseCreditNotes_1.PurchaseCreditNotes ? docEntryOrEntity : { DocEntry: docEntryOrEntity });
    };
