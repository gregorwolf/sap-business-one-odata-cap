 ...
 */
export declare class AdditionalExpensesParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, AdditionalExpensesParams> {
    /**
...
export declare namespace AdditionalExpensesParams {
     ...
     */
    const _propertyMetadata: PropertyMetadata<AdditionalExpensesParams>[];
    /**
