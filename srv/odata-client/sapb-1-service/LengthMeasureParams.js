...
var LengthMeasureParamsField = /** @class */ (function (_super) {
     ...
     */
    function LengthMeasureParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, LengthMeasureParams) || this;
        /**
...
(function (LengthMeasureParams) {
     ...
     */
    LengthMeasureParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, LengthMeasureParams);
    }
