 ...
 */
export declare class CashDiscountParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, CashDiscountParams> {
    /**
...
export declare namespace CashDiscountParams {
     ...
     */
    const _propertyMetadata: PropertyMetadata<CashDiscountParams>[];
    /**
