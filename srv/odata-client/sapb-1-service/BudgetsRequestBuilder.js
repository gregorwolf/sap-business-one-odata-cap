...
var BudgetsRequestBuilder = /** @class */ (function (_super) {
    ...
    BudgetsRequestBuilder.prototype.getByKey = function (numerator) {
        return new core_1.GetByKeyRequestBuilderV4(Budgets_1.Budgets, { Numerator: numerator });
    };
    /**
    ...
    BudgetsRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(Budgets_1.Budgets);
    };
    /**
    ...
    BudgetsRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(Budgets_1.Budgets, entity);
    };
    /**
    ...
    BudgetsRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(Budgets_1.Budgets, entity);
    };
    BudgetsRequestBuilder.prototype.delete = function (numeratorOrEntity) {
        return new core_1.DeleteRequestBuilderV4(Budgets_1.Budgets, numeratorOrEntity instanceof Budgets_1.Budgets ? numeratorOrEntity : { Numerator: numeratorOrEntity });
    };
