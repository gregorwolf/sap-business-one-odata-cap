 ...
 */
export declare class BudgetLineField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, BudgetLine> {
    /**
...
export declare namespace BudgetLine {
     ...
     */
    const _propertyMetadata: PropertyMetadata<BudgetLine>[];
    /**
