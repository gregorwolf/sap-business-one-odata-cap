 ...
 */
export declare class SalesStageParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, SalesStageParams> {
    /**
...
export declare namespace SalesStageParams {
     ...
     */
    const _propertyMetadata: PropertyMetadata<SalesStageParams>[];
    /**
