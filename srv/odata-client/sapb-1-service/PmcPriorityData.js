...
var PmcPriorityDataField = /** @class */ (function (_super) {
    ...
    function PmcPriorityDataField() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        /**
         * Representation of the [[PmcPriorityData.priorityId]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.priorityId = new v4_1.ComplexTypeNumberPropertyField('PriorityID', _this, 'Edm.Int32');
        /**
         * Representation of the [[PmcPriorityData.priorityName]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.priorityName = new v4_1.ComplexTypeStringPropertyField('PriorityName', _this, 'Edm.String');
        return _this;
    }
...
(function (PmcPriorityData) {
    function build(json) {
        return v4_1.createComplexType(json, {
            PriorityID: function (priorityId) { return ({ priorityId: v4_1.edmToTs(priorityId, 'Edm.Int32') }); },
            PriorityName: function (priorityName) { return ({ priorityName: v4_1.edmToTs(priorityName, 'Edm.String') }); }
        });
    }
