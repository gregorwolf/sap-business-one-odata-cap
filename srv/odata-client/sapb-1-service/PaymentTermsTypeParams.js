...
var PaymentTermsTypeParamsField = /** @class */ (function (_super) {
     ...
     */
    function PaymentTermsTypeParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, PaymentTermsTypeParams) || this;
        /**
...
(function (PaymentTermsTypeParams) {
     ...
     */
    PaymentTermsTypeParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, PaymentTermsTypeParams);
    }
