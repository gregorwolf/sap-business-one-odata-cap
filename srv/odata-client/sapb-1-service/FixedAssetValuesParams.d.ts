 ...
 */
export declare class FixedAssetValuesParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, FixedAssetValuesParams> {
    /**
...
export declare namespace FixedAssetValuesParams {
     ...
     */
    const _propertyMetadata: PropertyMetadata<FixedAssetValuesParams>[];
    /**
