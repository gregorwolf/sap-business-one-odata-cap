 ...
 */
export class LengthMeasureParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, LengthMeasureParams> {
  /**
  ...
  constructor(fieldName: string, fieldOf: ConstructorOrField<EntityT>) {
    super(fieldName, fieldOf, LengthMeasureParams);
  }
}
...
export namespace LengthMeasureParams {
   ...
   */
  export const _propertyMetadata: PropertyMetadata<LengthMeasureParams>[] = [{
  ...
  export function build(json: { [keys: string]: FieldType }): LengthMeasureParams {
    return deserializeComplexTypeV4(json, LengthMeasureParams);
  }
}
