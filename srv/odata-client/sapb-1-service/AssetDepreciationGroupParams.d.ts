 ...
 */
export declare class AssetDepreciationGroupParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, AssetDepreciationGroupParams> {
    /**
...
export declare namespace AssetDepreciationGroupParams {
     ...
     */
    const _propertyMetadata: PropertyMetadata<AssetDepreciationGroupParams>[];
    /**
