...
var NatureOfAssesseeParamsField = /** @class */ (function (_super) {
     ...
     */
    function NatureOfAssesseeParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, NatureOfAssesseeParams) || this;
        /**
...
(function (NatureOfAssesseeParams) {
     ...
     */
    NatureOfAssesseeParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, NatureOfAssesseeParams);
    }
