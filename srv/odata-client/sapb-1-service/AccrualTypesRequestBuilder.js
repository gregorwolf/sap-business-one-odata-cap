...
var AccrualTypesRequestBuilder = /** @class */ (function (_super) {
    ...
    AccrualTypesRequestBuilder.prototype.getByKey = function (code) {
        return new v4_1.GetByKeyRequestBuilder(AccrualTypes_1.AccrualTypes, { Code: code });
    };
    /**
    ...
    AccrualTypesRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(AccrualTypes_1.AccrualTypes);
    };
    /**
    ...
    AccrualTypesRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(AccrualTypes_1.AccrualTypes, entity);
    };
    /**
    ...
    AccrualTypesRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(AccrualTypes_1.AccrualTypes, entity);
    };
    AccrualTypesRequestBuilder.prototype.delete = function (codeOrEntity) {
        return new v4_1.DeleteRequestBuilder(AccrualTypes_1.AccrualTypes, codeOrEntity instanceof AccrualTypes_1.AccrualTypes ? codeOrEntity : { Code: codeOrEntity });
    };
