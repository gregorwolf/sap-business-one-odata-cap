...
var PmStageDataField = /** @class */ (function (_super) {
     ...
     */
    function PmStageDataField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, PmStageData) || this;
        /**
...
(function (PmStageData) {
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, PmStageData);
    }
