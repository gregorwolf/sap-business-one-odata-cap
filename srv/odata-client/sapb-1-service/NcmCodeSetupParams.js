...
var NcmCodeSetupParamsField = /** @class */ (function (_super) {
    ...
    function NcmCodeSetupParamsField() {
         ...
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.ncmCode = new v4_1.ComplexTypeStringPropertyField('NCMCode', _this, 'Edm.String');
        /**
...
(function (NcmCodeSetupParams) {
    function build(json) {
        return v4_1.createComplexType(json, {
            ...
            NCMCode: function (ncmCode) { return ({ ncmCode: v4_1.edmToTs(ncmCode, 'Edm.String') }); },
