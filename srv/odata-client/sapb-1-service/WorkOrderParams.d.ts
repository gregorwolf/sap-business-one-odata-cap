 ...
 */
export declare class WorkOrderParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, WorkOrderParams> {
    /**
...
export declare namespace WorkOrderParams {
     ...
     */
    const _propertyMetadata: PropertyMetadata<WorkOrderParams>[];
    /**
