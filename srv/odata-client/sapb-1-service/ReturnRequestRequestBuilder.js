...
var ReturnRequestRequestBuilder = /** @class */ (function (_super) {
    ...
    ReturnRequestRequestBuilder.prototype.getByKey = function (docEntry) {
        return new core_1.GetByKeyRequestBuilderV4(ReturnRequest_1.ReturnRequest, { DocEntry: docEntry });
    };
    /**
    ...
    ReturnRequestRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(ReturnRequest_1.ReturnRequest);
    };
    /**
    ...
    ReturnRequestRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(ReturnRequest_1.ReturnRequest, entity);
    };
    /**
    ...
    ReturnRequestRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(ReturnRequest_1.ReturnRequest, entity);
    };
    ReturnRequestRequestBuilder.prototype.delete = function (docEntryOrEntity) {
        return new core_1.DeleteRequestBuilderV4(ReturnRequest_1.ReturnRequest, docEntryOrEntity instanceof ReturnRequest_1.ReturnRequest ? docEntryOrEntity : { DocEntry: docEntryOrEntity });
    };
