...
var ElectronicFileFormatsRequestBuilder = /** @class */ (function (_super) {
    ...
    ElectronicFileFormatsRequestBuilder.prototype.getByKey = function (formatId) {
        return new v4_1.GetByKeyRequestBuilder(ElectronicFileFormats_1.ElectronicFileFormats, { FormatID: formatId });
    };
    /**
    ...
    ElectronicFileFormatsRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(ElectronicFileFormats_1.ElectronicFileFormats);
    };
    /**
    ...
    ElectronicFileFormatsRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(ElectronicFileFormats_1.ElectronicFileFormats, entity);
    };
    /**
    ...
    ElectronicFileFormatsRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(ElectronicFileFormats_1.ElectronicFileFormats, entity);
    };
    ElectronicFileFormatsRequestBuilder.prototype.delete = function (formatIdOrEntity) {
        return new v4_1.DeleteRequestBuilder(ElectronicFileFormats_1.ElectronicFileFormats, formatIdOrEntity instanceof ElectronicFileFormats_1.ElectronicFileFormats ? formatIdOrEntity : { FormatID: formatIdOrEntity });
    };
