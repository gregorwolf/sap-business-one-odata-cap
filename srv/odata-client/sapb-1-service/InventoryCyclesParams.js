...
var InventoryCyclesParamsField = /** @class */ (function (_super) {
     ...
     */
    function InventoryCyclesParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, InventoryCyclesParams) || this;
        /**
...
(function (InventoryCyclesParams) {
     ...
     */
    InventoryCyclesParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, InventoryCyclesParams);
    }
