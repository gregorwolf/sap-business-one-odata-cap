 ...
 */
export declare class Teams extends Entity implements TeamsType {
    /**
...
export declare namespace Teams {
     ...
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    const TEAM_MEMBERS: CollectionField<Teams>;
    /**
     * All fields of the Teams entity.
     */
    const _allFields: Array<NumberField<Teams> | StringField<Teams> | CollectionField<Teams>>;
    /**
     * All fields selector.
     */
