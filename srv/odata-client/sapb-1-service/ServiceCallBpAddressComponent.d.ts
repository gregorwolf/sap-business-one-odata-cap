 ...
 */
export declare class ServiceCallBpAddressComponentField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, ServiceCallBpAddressComponent> {
    /**
...
export declare namespace ServiceCallBpAddressComponent {
     ...
     */
    const _propertyMetadata: PropertyMetadata<ServiceCallBpAddressComponent>[];
    /**
