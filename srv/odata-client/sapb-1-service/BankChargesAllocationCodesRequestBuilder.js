...
var BankChargesAllocationCodesRequestBuilder = /** @class */ (function (_super) {
    ...
    BankChargesAllocationCodesRequestBuilder.prototype.getByKey = function (code) {
        return new v4_1.GetByKeyRequestBuilder(BankChargesAllocationCodes_1.BankChargesAllocationCodes, { Code: code });
    };
    /**
    ...
    BankChargesAllocationCodesRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(BankChargesAllocationCodes_1.BankChargesAllocationCodes);
    };
    /**
    ...
    BankChargesAllocationCodesRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(BankChargesAllocationCodes_1.BankChargesAllocationCodes, entity);
    };
    /**
    ...
    BankChargesAllocationCodesRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(BankChargesAllocationCodes_1.BankChargesAllocationCodes, entity);
    };
    BankChargesAllocationCodesRequestBuilder.prototype.delete = function (codeOrEntity) {
        return new v4_1.DeleteRequestBuilder(BankChargesAllocationCodes_1.BankChargesAllocationCodes, codeOrEntity instanceof BankChargesAllocationCodes_1.BankChargesAllocationCodes ? codeOrEntity : { Code: codeOrEntity });
    };
