...
var TeamParamsField = /** @class */ (function (_super) {
     ...
     */
    function TeamParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, TeamParams) || this;
        /**
...
(function (TeamParams) {
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, TeamParams);
    }
