 ...
 */
export declare class DeductionTaxGroupParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, DeductionTaxGroupParams> {
    /**
...
export declare namespace DeductionTaxGroupParams {
     ...
     */
    const _propertyMetadata: PropertyMetadata<DeductionTaxGroupParams>[];
    /**
