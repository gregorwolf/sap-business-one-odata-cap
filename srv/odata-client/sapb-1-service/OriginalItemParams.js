...
var OriginalItemParamsField = /** @class */ (function (_super) {
     ...
     */
    function OriginalItemParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, OriginalItemParams) || this;
        /**
...
(function (OriginalItemParams) {
     ...
     */
    OriginalItemParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, OriginalItemParams);
    }
