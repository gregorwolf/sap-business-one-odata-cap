...
var TaxReportSeriesField = /** @class */ (function (_super) {
    ...
    function TaxReportSeriesField() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        /**
         * Representation of the [[TaxReportSeries.seriesCode]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.seriesCode = new v4_1.ComplexTypeNumberPropertyField('SeriesCode', _this, 'Edm.Int32');
        return _this;
    }
...
(function (TaxReportSeries) {
    function build(json) {
        return v4_1.createComplexType(json, {
            SeriesCode: function (seriesCode) { return ({ seriesCode: v4_1.edmToTs(seriesCode, 'Edm.Int32') }); }
        });
    }
