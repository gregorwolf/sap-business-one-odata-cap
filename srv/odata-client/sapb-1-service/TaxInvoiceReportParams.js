...
var TaxInvoiceReportParamsField = /** @class */ (function (_super) {
     ...
     */
    function TaxInvoiceReportParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, TaxInvoiceReportParams) || this;
        /**
...
(function (TaxInvoiceReportParams) {
     ...
     */
    TaxInvoiceReportParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, TaxInvoiceReportParams);
    }
