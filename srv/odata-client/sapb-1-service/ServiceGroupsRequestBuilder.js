...
var ServiceGroupsRequestBuilder = /** @class */ (function (_super) {
    ...
    ServiceGroupsRequestBuilder.prototype.getByKey = function (absEntry) {
        return new v4_1.GetByKeyRequestBuilder(ServiceGroups_1.ServiceGroups, { AbsEntry: absEntry });
    };
    /**
    ...
    ServiceGroupsRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(ServiceGroups_1.ServiceGroups);
    };
    /**
    ...
    ServiceGroupsRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(ServiceGroups_1.ServiceGroups, entity);
    };
    /**
    ...
    ServiceGroupsRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(ServiceGroups_1.ServiceGroups, entity);
    };
    ServiceGroupsRequestBuilder.prototype.delete = function (absEntryOrEntity) {
        return new v4_1.DeleteRequestBuilder(ServiceGroups_1.ServiceGroups, absEntryOrEntity instanceof ServiceGroups_1.ServiceGroups ? absEntryOrEntity : { AbsEntry: absEntryOrEntity });
    };
