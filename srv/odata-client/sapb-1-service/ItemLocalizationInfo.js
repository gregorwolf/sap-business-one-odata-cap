...
var ItemLocalizationInfoField = /** @class */ (function (_super) {
     ...
     */
    function ItemLocalizationInfoField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, ItemLocalizationInfo) || this;
        /**
         ...
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.incomeNature = new core_1.ComplexTypeStringPropertyField('IncomeNature', _this, 'Edm.String');
        return _this;
    }
...
(function (ItemLocalizationInfo) {
     ...
     */
    ItemLocalizationInfo._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, ItemLocalizationInfo);
    }
