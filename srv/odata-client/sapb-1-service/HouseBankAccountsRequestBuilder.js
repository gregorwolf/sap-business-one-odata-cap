...
var HouseBankAccountsRequestBuilder = /** @class */ (function (_super) {
    ...
    HouseBankAccountsRequestBuilder.prototype.getByKey = function (absoluteEntry) {
        return new core_1.GetByKeyRequestBuilderV4(HouseBankAccounts_1.HouseBankAccounts, { AbsoluteEntry: absoluteEntry });
    };
    /**
    ...
    HouseBankAccountsRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(HouseBankAccounts_1.HouseBankAccounts);
    };
    /**
    ...
    HouseBankAccountsRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(HouseBankAccounts_1.HouseBankAccounts, entity);
    };
    /**
    ...
    HouseBankAccountsRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(HouseBankAccounts_1.HouseBankAccounts, entity);
    };
    HouseBankAccountsRequestBuilder.prototype.delete = function (absoluteEntryOrEntity) {
        return new core_1.DeleteRequestBuilderV4(HouseBankAccounts_1.HouseBankAccounts, absoluteEntryOrEntity instanceof HouseBankAccounts_1.HouseBankAccounts ? absoluteEntryOrEntity : { AbsoluteEntry: absoluteEntryOrEntity });
    };
