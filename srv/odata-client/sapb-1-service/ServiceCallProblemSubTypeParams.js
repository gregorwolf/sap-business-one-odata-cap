...
var ServiceCallProblemSubTypeParamsField = /** @class */ (function (_super) {
     ...
     */
    function ServiceCallProblemSubTypeParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, ServiceCallProblemSubTypeParams) || this;
        /**
         * Representation of the [[ServiceCallProblemSubTypeParams.problemSubTypeId]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.problemSubTypeId = new core_1.ComplexTypeNumberPropertyField('ProblemSubTypeID', _this, 'Edm.Int32');
        /**
...
(function (ServiceCallProblemSubTypeParams) {
     ...
     */
    ServiceCallProblemSubTypeParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, ServiceCallProblemSubTypeParams);
    }
