...
var CreditCardPayments = /** @class */ (function (_super) {
    ...
    CreditCardPayments.builder = function () {
        return core_1.EntityV4.entityBuilder(CreditCardPayments);
    };
    /**
    ...
    CreditCardPayments.customField = function (fieldName) {
        return core_1.EntityV4.customFieldSelector(fieldName, CreditCardPayments);
    };
    /**
     ...
     */
    CreditCardPayments._defaultServicePath = '/b1s/v2/';
...
(function (CreditCardPayments) {
     ...
     */
    CreditCardPayments.DUE_DATE_CODE = new core_1.StringField('DueDateCode', CreditCardPayments, 'Edm.String');
    /**
     * Static representation of the [[dueDateName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CreditCardPayments.DUE_DATE_NAME = new core_1.StringField('DueDateName', CreditCardPayments, 'Edm.String');
    /**
     * Static representation of the [[dueDatesType]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CreditCardPayments.DUE_DATES_TYPE = new core_1.EnumField('DueDatesType', CreditCardPayments);
    /**
     * Static representation of the [[paymentAfterDays]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CreditCardPayments.PAYMENT_AFTER_DAYS = new core_1.NumberField('PaymentAfterDays', CreditCardPayments, 'Edm.Int32');
    /**
     * Static representation of the [[paymentAfterMonths]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CreditCardPayments.PAYMENT_AFTER_MONTHS = new core_1.NumberField('PaymentAfterMonths', CreditCardPayments, 'Edm.Int32');
    /**
     * Static representation of the [[fromDay1]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CreditCardPayments.FROM_DAY_1 = new core_1.NumberField('FromDay1', CreditCardPayments, 'Edm.Int32');
    /**
     * Static representation of the [[toDay1]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CreditCardPayments.TO_DAY_1 = new core_1.NumberField('ToDay1', CreditCardPayments, 'Edm.Int32');
    /**
     * Static representation of the [[paymentDay1]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CreditCardPayments.PAYMENT_DAY_1 = new core_1.NumberField('PaymentDay1', CreditCardPayments, 'Edm.Int32');
    /**
     * Static representation of the [[noOfMonths1]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CreditCardPayments.NO_OF_MONTHS_1 = new core_1.NumberField('NoOfMonths1', CreditCardPayments, 'Edm.Int32');
    /**
     * Static representation of the [[fromDay2]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CreditCardPayments.FROM_DAY_2 = new core_1.NumberField('FromDay2', CreditCardPayments, 'Edm.Int32');
    /**
     * Static representation of the [[toDay2]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CreditCardPayments.TO_DAY_2 = new core_1.NumberField('ToDay2', CreditCardPayments, 'Edm.Int32');
    /**
     * Static representation of the [[paymentDay2]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CreditCardPayments.PAYMENT_DAY_2 = new core_1.NumberField('PaymentDay2', CreditCardPayments, 'Edm.Int32');
    /**
     * Static representation of the [[noOfMonths2]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CreditCardPayments.NO_OF_MONTHS_2 = new core_1.NumberField('NoOfMonths2', CreditCardPayments, 'Edm.Int32');
    /**
     * Static representation of the [[fromDay3]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CreditCardPayments.FROM_DAY_3 = new core_1.NumberField('FromDay3', CreditCardPayments, 'Edm.Int32');
    /**
     * Static representation of the [[toDay3]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CreditCardPayments.TO_DAY_3 = new core_1.NumberField('ToDay3', CreditCardPayments, 'Edm.Int32');
    /**
     * Static representation of the [[paymentDay3]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CreditCardPayments.PAYMENT_DAY_3 = new core_1.NumberField('PaymentDay3', CreditCardPayments, 'Edm.Int32');
    /**
     * Static representation of the [[noOfMonths3]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CreditCardPayments.NO_OF_MONTHS_3 = new core_1.NumberField('NoOfMonths3', CreditCardPayments, 'Edm.Int32');
    /**
     * Static representation of the [[fromDay4]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CreditCardPayments.FROM_DAY_4 = new core_1.NumberField('FromDay4', CreditCardPayments, 'Edm.Int32');
    /**
     * Static representation of the [[toDay4]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CreditCardPayments.TO_DAY_4 = new core_1.NumberField('ToDay4', CreditCardPayments, 'Edm.Int32');
    /**
     * Static representation of the [[paymentDay4]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CreditCardPayments.PAYMENT_DAY_4 = new core_1.NumberField('PaymentDay4', CreditCardPayments, 'Edm.Int32');
    /**
     * Static representation of the [[noOfMonths4]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CreditCardPayments.NO_OF_MONTHS_4 = new core_1.NumberField('NoOfMonths4', CreditCardPayments, 'Edm.Int32');
    /**
     * Static representation of the one-to-many navigation property [[creditPaymentMethods]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CreditCardPayments.CREDIT_PAYMENT_METHODS = new core_1.OneToManyLink('CreditPaymentMethods', CreditCardPayments, CreditPaymentMethods_1.CreditPaymentMethods);
    /**
     ...
     * All fields selector.
     */
    CreditCardPayments.ALL_FIELDS = new core_1.AllFields('*', CreditCardPayments);
    /**
