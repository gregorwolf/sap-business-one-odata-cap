...
var ActivityLocationsRequestBuilder = /** @class */ (function (_super) {
    ...
    ActivityLocationsRequestBuilder.prototype.getByKey = function (code) {
        return new core_1.GetByKeyRequestBuilderV4(ActivityLocations_1.ActivityLocations, { Code: code });
    };
    /**
    ...
    ActivityLocationsRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(ActivityLocations_1.ActivityLocations);
    };
    /**
    ...
    ActivityLocationsRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(ActivityLocations_1.ActivityLocations, entity);
    };
    /**
    ...
    ActivityLocationsRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(ActivityLocations_1.ActivityLocations, entity);
    };
    ActivityLocationsRequestBuilder.prototype.delete = function (codeOrEntity) {
        return new core_1.DeleteRequestBuilderV4(ActivityLocations_1.ActivityLocations, codeOrEntity instanceof ActivityLocations_1.ActivityLocations ? codeOrEntity : { Code: codeOrEntity });
    };
