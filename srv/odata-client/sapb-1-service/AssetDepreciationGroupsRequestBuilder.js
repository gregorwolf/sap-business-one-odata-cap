...
var AssetDepreciationGroupsRequestBuilder = /** @class */ (function (_super) {
    ...
    AssetDepreciationGroupsRequestBuilder.prototype.getByKey = function (code) {
        return new v4_1.GetByKeyRequestBuilder(AssetDepreciationGroups_1.AssetDepreciationGroups, { Code: code });
    };
    /**
    ...
    AssetDepreciationGroupsRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(AssetDepreciationGroups_1.AssetDepreciationGroups);
    };
    /**
    ...
    AssetDepreciationGroupsRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(AssetDepreciationGroups_1.AssetDepreciationGroups, entity);
    };
    /**
    ...
    AssetDepreciationGroupsRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(AssetDepreciationGroups_1.AssetDepreciationGroups, entity);
    };
    AssetDepreciationGroupsRequestBuilder.prototype.delete = function (codeOrEntity) {
        return new v4_1.DeleteRequestBuilder(AssetDepreciationGroups_1.AssetDepreciationGroups, codeOrEntity instanceof AssetDepreciationGroups_1.AssetDepreciationGroups ? codeOrEntity : { Code: codeOrEntity });
    };
