 ...
 */
export declare class SalesOpportunitiesParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, SalesOpportunitiesParams> {
    /**
...
export declare namespace SalesOpportunitiesParams {
     ...
     */
    const _propertyMetadata: PropertyMetadata<SalesOpportunitiesParams>[];
    /**
