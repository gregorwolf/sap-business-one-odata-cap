...
var DynamicSystemStringsRequestBuilder = /** @class */ (function (_super) {
    ...
    DynamicSystemStringsRequestBuilder.prototype.getByKey = function (formId, itemId, columnId) {
        return new core_1.GetByKeyRequestBuilderV4(DynamicSystemStrings_1.DynamicSystemStrings, {
            FormID: formId,
            ItemID: itemId,
            ColumnID: columnId
        });
    ...
    DynamicSystemStringsRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(DynamicSystemStrings_1.DynamicSystemStrings);
    };
    /**
    ...
    DynamicSystemStringsRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(DynamicSystemStrings_1.DynamicSystemStrings, entity);
    };
    /**
    ...
    DynamicSystemStringsRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(DynamicSystemStrings_1.DynamicSystemStrings, entity);
    };
    DynamicSystemStringsRequestBuilder.prototype.delete = function (formIdOrEntity, itemId, columnId) {
        return new core_1.DeleteRequestBuilderV4(DynamicSystemStrings_1.DynamicSystemStrings, formIdOrEntity instanceof DynamicSystemStrings_1.DynamicSystemStrings ? formIdOrEntity : {
