...
var AdditionalExpensesParamsField = /** @class */ (function (_super) {
    ...
    /**
     * Creates an instance of AdditionalExpensesParamsField.
     *
     * @param fieldName - Actual name of the field as used in the OData request.
     * @param fieldOf - Either the parent entity constructor of the parent complex type this field belongs to.
     */
    function AdditionalExpensesParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, AdditionalExpensesParams) || this;
        /**
         * Representation of the [[AdditionalExpensesParams.expensCode]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.expensCode = new core_1.ComplexTypeNumberPropertyField('ExpensCode', _this, 'Edm.Int32');
        return _this;
    }
...
(function (AdditionalExpensesParams) {
    /**
     * Metadata information on all properties of the `AdditionalExpensesParams` complex type.
     */
    AdditionalExpensesParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, AdditionalExpensesParams);
    }
