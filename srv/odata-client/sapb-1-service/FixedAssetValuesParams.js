...
var FixedAssetValuesParamsField = /** @class */ (function (_super) {
     ...
     */
    function FixedAssetValuesParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, FixedAssetValuesParams) || this;
        /**
...
(function (FixedAssetValuesParams) {
     ...
     */
    FixedAssetValuesParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, FixedAssetValuesParams);
    }
