...
var EmployeeTransferParamsField = /** @class */ (function (_super) {
     ...
     */
    function EmployeeTransferParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, EmployeeTransferParams) || this;
        /**
...
(function (EmployeeTransferParams) {
     ...
     */
    EmployeeTransferParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, EmployeeTransferParams);
    }
