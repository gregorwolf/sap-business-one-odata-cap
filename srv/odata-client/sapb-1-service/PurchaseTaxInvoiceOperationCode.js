...
var PurchaseTaxInvoiceOperationCodeField = /** @class */ (function (_super) {
     ...
     */
    function PurchaseTaxInvoiceOperationCodeField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, PurchaseTaxInvoiceOperationCode) || this;
        /**
...
(function (PurchaseTaxInvoiceOperationCode) {
     ...
     */
    PurchaseTaxInvoiceOperationCode._propertyMetadata = [{
            originalName: 'OpCode',
            name: 'opCode',
            type: 'Edm.Int32',
            isCollection: false
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, PurchaseTaxInvoiceOperationCode);
    }
