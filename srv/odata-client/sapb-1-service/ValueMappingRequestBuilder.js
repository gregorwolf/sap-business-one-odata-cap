...
var ValueMappingRequestBuilder = /** @class */ (function (_super) {
    ...
    ValueMappingRequestBuilder.prototype.getByKey = function (absEntry) {
        return new core_1.GetByKeyRequestBuilderV4(ValueMapping_1.ValueMapping, { AbsEntry: absEntry });
    };
    /**
    ...
    ValueMappingRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(ValueMapping_1.ValueMapping);
    };
    /**
    ...
    ValueMappingRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(ValueMapping_1.ValueMapping, entity);
    };
    /**
    ...
    ValueMappingRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(ValueMapping_1.ValueMapping, entity);
    };
    ValueMappingRequestBuilder.prototype.delete = function (absEntryOrEntity) {
        return new core_1.DeleteRequestBuilderV4(ValueMapping_1.ValueMapping, absEntryOrEntity instanceof ValueMapping_1.ValueMapping ? absEntryOrEntity : { AbsEntry: absEntryOrEntity });
    };
