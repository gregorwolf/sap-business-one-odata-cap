 ...
 */
export declare class PurchaseTaxInvoiceOperationCodeField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, PurchaseTaxInvoiceOperationCode> {
    /**
...
export declare namespace PurchaseTaxInvoiceOperationCode {
     ...
     */
    const _propertyMetadata: PropertyMetadata<PurchaseTaxInvoiceOperationCode>[];
    /**
