...
var DraftsRequestBuilder = /** @class */ (function (_super) {
    ...
    DraftsRequestBuilder.prototype.getByKey = function (docEntry) {
        return new v4_1.GetByKeyRequestBuilder(Drafts_1.Drafts, { DocEntry: docEntry });
    };
    /**
    ...
    DraftsRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(Drafts_1.Drafts);
    };
    /**
    ...
    DraftsRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(Drafts_1.Drafts, entity);
    };
    /**
    ...
    DraftsRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(Drafts_1.Drafts, entity);
    };
    DraftsRequestBuilder.prototype.delete = function (docEntryOrEntity) {
        return new v4_1.DeleteRequestBuilder(Drafts_1.Drafts, docEntryOrEntity instanceof Drafts_1.Drafts ? docEntryOrEntity : { DocEntry: docEntryOrEntity });
    };
