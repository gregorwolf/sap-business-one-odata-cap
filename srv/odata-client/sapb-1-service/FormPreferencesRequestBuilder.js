...
var FormPreferencesRequestBuilder = /** @class */ (function (_super) {
    ...
    FormPreferencesRequestBuilder.prototype.getByKey = function (user, formId, itemNumber, column) {
        return new v4_1.GetByKeyRequestBuilder(FormPreferences_1.FormPreferences, {
            User: user,
            FormID: formId,
    ...
    FormPreferencesRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(FormPreferences_1.FormPreferences);
    };
    /**
    ...
    FormPreferencesRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(FormPreferences_1.FormPreferences, entity);
    };
    /**
    ...
    FormPreferencesRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(FormPreferences_1.FormPreferences, entity);
    };
    FormPreferencesRequestBuilder.prototype.delete = function (userOrEntity, formId, itemNumber, column) {
        return new v4_1.DeleteRequestBuilder(FormPreferences_1.FormPreferences, userOrEntity instanceof FormPreferences_1.FormPreferences ? userOrEntity : {
            User: userOrEntity,
            FormID: formId,
            ItemNumber: itemNumber,
            Column: column
