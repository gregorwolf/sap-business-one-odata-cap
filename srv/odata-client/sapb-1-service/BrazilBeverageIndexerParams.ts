 ...
 */
export class BrazilBeverageIndexerParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, BrazilBeverageIndexerParams> {
  /**
  ...
  constructor(fieldName: string, fieldOf: ConstructorOrField<EntityT>) {
    super(fieldName, fieldOf, BrazilBeverageIndexerParams);
  }
}
...
export namespace BrazilBeverageIndexerParams {
  ...
  export function build(json: { [keys: string]: FieldType }): BrazilBeverageIndexerParams {
    return deserializeComplexTypeV4(json, BrazilBeverageIndexerParams);
  }
}
