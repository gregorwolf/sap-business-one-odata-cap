...
var BudgetDistributions = /** @class */ (function (_super) {
    ...
    BudgetDistributions.builder = function () {
        return core_1.EntityV4.entityBuilder(BudgetDistributions);
    };
    /**
    ...
    BudgetDistributions.customField = function (fieldName) {
        return core_1.EntityV4.customFieldSelector(fieldName, BudgetDistributions);
    };
    /**
     ...
     */
    BudgetDistributions._defaultServicePath = '/b1s/v2/';
...
(function (BudgetDistributions) {
     ...
     */
    BudgetDistributions.SEPTEMBER = new core_1.NumberField('September', BudgetDistributions, 'Edm.Double');
    /**
     * Static representation of the [[august]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BudgetDistributions.AUGUST = new core_1.NumberField('August', BudgetDistributions, 'Edm.Double');
    /**
     * Static representation of the [[july]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BudgetDistributions.JULY = new core_1.NumberField('July', BudgetDistributions, 'Edm.Double');
    /**
     * Static representation of the [[june]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BudgetDistributions.JUNE = new core_1.NumberField('June', BudgetDistributions, 'Edm.Double');
    /**
     * Static representation of the [[may]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BudgetDistributions.MAY = new core_1.NumberField('May', BudgetDistributions, 'Edm.Double');
    /**
     * Static representation of the [[april]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BudgetDistributions.APRIL = new core_1.NumberField('April', BudgetDistributions, 'Edm.Double');
    /**
     * Static representation of the [[march]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BudgetDistributions.MARCH = new core_1.NumberField('March', BudgetDistributions, 'Edm.Double');
    /**
     * Static representation of the [[february]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BudgetDistributions.FEBRUARY = new core_1.NumberField('February', BudgetDistributions, 'Edm.Double');
    /**
     * Static representation of the [[december]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BudgetDistributions.DECEMBER = new core_1.NumberField('December', BudgetDistributions, 'Edm.Double');
    /**
     * Static representation of the [[november]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BudgetDistributions.NOVEMBER = new core_1.NumberField('November', BudgetDistributions, 'Edm.Double');
    /**
     * Static representation of the [[october]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BudgetDistributions.OCTOBER = new core_1.NumberField('October', BudgetDistributions, 'Edm.Double');
    /**
     * Static representation of the [[january]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BudgetDistributions.JANUARY = new core_1.NumberField('January', BudgetDistributions, 'Edm.Double');
    /**
     * Static representation of the [[budgetAmount]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BudgetDistributions.BUDGET_AMOUNT = new core_1.NumberField('BudgetAmount', BudgetDistributions, 'Edm.Double');
    /**
     * Static representation of the [[description]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BudgetDistributions.DESCRIPTION = new core_1.StringField('Description', BudgetDistributions, 'Edm.String');
    /**
     * Static representation of the [[divisionCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BudgetDistributions.DIVISION_CODE = new core_1.NumberField('DivisionCode', BudgetDistributions, 'Edm.Int32');
    /**
     * Static representation of the one-to-many navigation property [[budgets]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    BudgetDistributions.BUDGETS = new core_1.OneToManyLink('Budgets', BudgetDistributions, Budgets_1.Budgets);
    /**
     ...
     * All fields selector.
     */
    BudgetDistributions.ALL_FIELDS = new core_1.AllFields('*', BudgetDistributions);
    /**
