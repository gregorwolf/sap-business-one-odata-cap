...
var EmployeeRoleSetupParamsField = /** @class */ (function (_super) {
     ...
     */
    function EmployeeRoleSetupParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, EmployeeRoleSetupParams) || this;
        /**
         * Representation of the [[EmployeeRoleSetupParams.typeId]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.typeId = new core_1.ComplexTypeNumberPropertyField('TypeID', _this, 'Edm.Int32');
        /**
...
(function (EmployeeRoleSetupParams) {
     ...
     */
    EmployeeRoleSetupParams._propertyMetadata = [{
            originalName: 'TypeID',
            name: 'typeId',
            type: 'Edm.Int32',
            isCollection: false
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, EmployeeRoleSetupParams);
    }
