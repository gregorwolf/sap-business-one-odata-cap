...
var CorrectionPurchaseInvoiceRequestBuilder = /** @class */ (function (_super) {
    ...
    CorrectionPurchaseInvoiceRequestBuilder.prototype.getByKey = function (docEntry) {
        return new v4_1.GetByKeyRequestBuilder(CorrectionPurchaseInvoice_1.CorrectionPurchaseInvoice, { DocEntry: docEntry });
    };
    /**
    ...
    CorrectionPurchaseInvoiceRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(CorrectionPurchaseInvoice_1.CorrectionPurchaseInvoice);
    };
    /**
    ...
    CorrectionPurchaseInvoiceRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(CorrectionPurchaseInvoice_1.CorrectionPurchaseInvoice, entity);
    };
    /**
    ...
    CorrectionPurchaseInvoiceRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(CorrectionPurchaseInvoice_1.CorrectionPurchaseInvoice, entity);
    };
    CorrectionPurchaseInvoiceRequestBuilder.prototype.delete = function (docEntryOrEntity) {
        return new v4_1.DeleteRequestBuilder(CorrectionPurchaseInvoice_1.CorrectionPurchaseInvoice, docEntryOrEntity instanceof CorrectionPurchaseInvoice_1.CorrectionPurchaseInvoice ? docEntryOrEntity : { DocEntry: docEntryOrEntity });
    };
