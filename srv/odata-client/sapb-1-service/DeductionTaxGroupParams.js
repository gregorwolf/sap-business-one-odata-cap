...
var DeductionTaxGroupParamsField = /** @class */ (function (_super) {
     ...
     */
    function DeductionTaxGroupParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, DeductionTaxGroupParams) || this;
        /**
         * Representation of the [[DeductionTaxGroupParams.groupKey]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.groupKey = new core_1.ComplexTypeNumberPropertyField('GroupKey', _this, 'Edm.Int32');
        return _this;
    }
...
(function (DeductionTaxGroupParams) {
     ...
     */
    DeductionTaxGroupParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, DeductionTaxGroupParams);
    }
