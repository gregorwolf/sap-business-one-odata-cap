...
var BpPriorityParamsField = /** @class */ (function (_super) {
     ...
     */
    function BpPriorityParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, BpPriorityParams) || this;
        /**
...
(function (BpPriorityParams) {
     ...
     */
    BpPriorityParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, BpPriorityParams);
    }
