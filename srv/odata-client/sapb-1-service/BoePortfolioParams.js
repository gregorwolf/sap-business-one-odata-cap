...
var BoePortfolioParamsField = /** @class */ (function (_super) {
     ...
     */
    function BoePortfolioParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, BoePortfolioParams) || this;
        /**
         * Representation of the [[BoePortfolioParams.portfolioEntry]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.portfolioEntry = new core_1.ComplexTypeNumberPropertyField('PortfolioEntry', _this, 'Edm.Int32');
        /**
         * Representation of the [[BoePortfolioParams.portfolioId]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.portfolioId = new core_1.ComplexTypeStringPropertyField('PortfolioID', _this, 'Edm.String');
        /**
         * Representation of the [[BoePortfolioParams.portfolioCode]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.portfolioCode = new core_1.ComplexTypeStringPropertyField('PortfolioCode', _this, 'Edm.String');
        return _this;
    }
...
(function (BoePortfolioParams) {
     ...
     */
    BoePortfolioParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, BoePortfolioParams);
    }
