...
var UserMenuParamsField = /** @class */ (function (_super) {
     ...
     */
    function UserMenuParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, UserMenuParams) || this;
        /**
...
(function (UserMenuParams) {
     ...
     */
    UserMenuParams._propertyMetadata = [{
            originalName: 'UserID',
            name: 'userId',
            type: 'Edm.Int32',
            isCollection: false
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, UserMenuParams);
    }
