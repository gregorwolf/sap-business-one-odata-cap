 ...
 */
export declare class DepreciationTypeParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, DepreciationTypeParams> {
    /**
...
export declare namespace DepreciationTypeParams {
     ...
     */
    const _propertyMetadata: PropertyMetadata<DepreciationTypeParams>[];
    /**
