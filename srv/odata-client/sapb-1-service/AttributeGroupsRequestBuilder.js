...
var AttributeGroupsRequestBuilder = /** @class */ (function (_super) {
    ...
    AttributeGroupsRequestBuilder.prototype.getByKey = function (code) {
        return new core_1.GetByKeyRequestBuilderV4(AttributeGroups_1.AttributeGroups, { Code: code });
    };
    /**
    ...
    AttributeGroupsRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(AttributeGroups_1.AttributeGroups);
    };
    /**
    ...
    AttributeGroupsRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(AttributeGroups_1.AttributeGroups, entity);
    };
    /**
    ...
    AttributeGroupsRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(AttributeGroups_1.AttributeGroups, entity);
    };
    AttributeGroupsRequestBuilder.prototype.delete = function (codeOrEntity) {
        return new core_1.DeleteRequestBuilderV4(AttributeGroups_1.AttributeGroups, codeOrEntity instanceof AttributeGroups_1.AttributeGroups ? codeOrEntity : { Code: codeOrEntity });
    };
