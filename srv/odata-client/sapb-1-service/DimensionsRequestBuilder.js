...
var DimensionsRequestBuilder = /** @class */ (function (_super) {
    ...
    DimensionsRequestBuilder.prototype.getByKey = function (dimensionCode) {
        return new core_1.GetByKeyRequestBuilderV4(Dimensions_1.Dimensions, { DimensionCode: dimensionCode });
    };
    /**
    ...
    DimensionsRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(Dimensions_1.Dimensions);
    };
    /**
    ...
    DimensionsRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(Dimensions_1.Dimensions, entity);
    };
    /**
    ...
    DimensionsRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(Dimensions_1.Dimensions, entity);
    };
    DimensionsRequestBuilder.prototype.delete = function (dimensionCodeOrEntity) {
        return new core_1.DeleteRequestBuilderV4(Dimensions_1.Dimensions, dimensionCodeOrEntity instanceof Dimensions_1.Dimensions ? dimensionCodeOrEntity : { DimensionCode: dimensionCodeOrEntity });
    };
