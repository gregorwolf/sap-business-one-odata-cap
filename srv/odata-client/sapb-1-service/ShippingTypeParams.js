...
var ShippingTypeParamsField = /** @class */ (function (_super) {
     ...
     */
    function ShippingTypeParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, ShippingTypeParams) || this;
        /**
...
(function (ShippingTypeParams) {
     ...
     */
    ShippingTypeParams._propertyMetadata = [{
            originalName: 'Code',
            name: 'code',
            type: 'Edm.Int32',
            isCollection: false
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, ShippingTypeParams);
    }
