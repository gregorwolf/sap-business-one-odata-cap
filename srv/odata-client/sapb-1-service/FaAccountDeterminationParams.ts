 ...
 */
export class FaAccountDeterminationParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, FaAccountDeterminationParams> {
  /**
  ...
  constructor(fieldName: string, fieldOf: ConstructorOrField<EntityT>) {
    super(fieldName, fieldOf, FaAccountDeterminationParams);
  }
}
...
export namespace FaAccountDeterminationParams {
  ...
  export function build(json: { [keys: string]: FieldType }): FaAccountDeterminationParams {
    return deserializeComplexTypeV4(json, FaAccountDeterminationParams);
  }
}
