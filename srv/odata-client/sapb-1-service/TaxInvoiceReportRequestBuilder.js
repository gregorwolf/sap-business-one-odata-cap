...
var TaxInvoiceReportRequestBuilder = /** @class */ (function (_super) {
    ...
    TaxInvoiceReportRequestBuilder.prototype.getByKey = function (taxInvoiceReportNumber) {
        return new v4_1.GetByKeyRequestBuilder(TaxInvoiceReport_1.TaxInvoiceReport, { TaxInvoiceReportNumber: taxInvoiceReportNumber });
    };
    /**
    ...
    TaxInvoiceReportRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(TaxInvoiceReport_1.TaxInvoiceReport);
    };
    /**
    ...
    TaxInvoiceReportRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(TaxInvoiceReport_1.TaxInvoiceReport, entity);
    };
    /**
    ...
    TaxInvoiceReportRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(TaxInvoiceReport_1.TaxInvoiceReport, entity);
    };
    TaxInvoiceReportRequestBuilder.prototype.delete = function (taxInvoiceReportNumberOrEntity) {
        return new v4_1.DeleteRequestBuilder(TaxInvoiceReport_1.TaxInvoiceReport, taxInvoiceReportNumberOrEntity instanceof TaxInvoiceReport_1.TaxInvoiceReport ? taxInvoiceReportNumberOrEntity : { TaxInvoiceReportNumber: taxInvoiceReportNumberOrEntity });
    };
