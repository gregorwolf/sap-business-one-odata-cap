...
var InventoryOpeningBalanceParamsField = /** @class */ (function (_super) {
     ...
     */
    function InventoryOpeningBalanceParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, InventoryOpeningBalanceParams) || this;
        /**
...
(function (InventoryOpeningBalanceParams) {
     ...
     */
    InventoryOpeningBalanceParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, InventoryOpeningBalanceParams);
    }
