...
var CommissionGroupsRequestBuilder = /** @class */ (function (_super) {
    ...
    CommissionGroupsRequestBuilder.prototype.getByKey = function (commissionGroupCode) {
        return new core_1.GetByKeyRequestBuilderV4(CommissionGroups_1.CommissionGroups, { CommissionGroupCode: commissionGroupCode });
    };
    /**
    ...
    CommissionGroupsRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(CommissionGroups_1.CommissionGroups);
    };
    /**
    ...
    CommissionGroupsRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(CommissionGroups_1.CommissionGroups, entity);
    };
    /**
    ...
    CommissionGroupsRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(CommissionGroups_1.CommissionGroups, entity);
    };
    CommissionGroupsRequestBuilder.prototype.delete = function (commissionGroupCodeOrEntity) {
        return new core_1.DeleteRequestBuilderV4(CommissionGroups_1.CommissionGroups, commissionGroupCodeOrEntity instanceof CommissionGroups_1.CommissionGroups ? commissionGroupCodeOrEntity : { CommissionGroupCode: commissionGroupCodeOrEntity });
    };
