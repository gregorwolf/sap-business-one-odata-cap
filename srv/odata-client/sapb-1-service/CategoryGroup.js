...
var CategoryGroupField = /** @class */ (function (_super) {
    ...
    function CategoryGroupField() {
         ...
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.categoryId = new v4_1.ComplexTypeNumberPropertyField('CategoryId', _this, 'Edm.Int32');
        return _this;
    }
...
(function (CategoryGroup) {
    function build(json) {
        return v4_1.createComplexType(json, {
            ...
            CategoryId: function (categoryId) { return ({ categoryId: v4_1.edmToTs(categoryId, 'Edm.Int32') }); }
        });
    }
