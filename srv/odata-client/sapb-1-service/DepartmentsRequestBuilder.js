...
var DepartmentsRequestBuilder = /** @class */ (function (_super) {
    ...
    DepartmentsRequestBuilder.prototype.getByKey = function (code) {
        return new core_1.GetByKeyRequestBuilderV4(Departments_1.Departments, { Code: code });
    };
    /**
    ...
    DepartmentsRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(Departments_1.Departments);
    };
    /**
    ...
    DepartmentsRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(Departments_1.Departments, entity);
    };
    /**
    ...
    DepartmentsRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(Departments_1.Departments, entity);
    };
    DepartmentsRequestBuilder.prototype.delete = function (codeOrEntity) {
        return new core_1.DeleteRequestBuilderV4(Departments_1.Departments, codeOrEntity instanceof Departments_1.Departments ? codeOrEntity : { Code: codeOrEntity });
    };
