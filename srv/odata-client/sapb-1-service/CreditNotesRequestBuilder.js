...
var CreditNotesRequestBuilder = /** @class */ (function (_super) {
    ...
    CreditNotesRequestBuilder.prototype.getByKey = function (docEntry) {
        return new v4_1.GetByKeyRequestBuilder(CreditNotes_1.CreditNotes, { DocEntry: docEntry });
    };
    /**
    ...
    CreditNotesRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(CreditNotes_1.CreditNotes);
    };
    /**
    ...
    CreditNotesRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(CreditNotes_1.CreditNotes, entity);
    };
    /**
    ...
    CreditNotesRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(CreditNotes_1.CreditNotes, entity);
    };
    CreditNotesRequestBuilder.prototype.delete = function (docEntryOrEntity) {
        return new v4_1.DeleteRequestBuilder(CreditNotes_1.CreditNotes, docEntryOrEntity instanceof CreditNotes_1.CreditNotes ? docEntryOrEntity : { DocEntry: docEntryOrEntity });
    };
