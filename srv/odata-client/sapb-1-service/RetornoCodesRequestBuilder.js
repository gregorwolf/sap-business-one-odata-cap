...
var RetornoCodesRequestBuilder = /** @class */ (function (_super) {
    ...
    RetornoCodesRequestBuilder.prototype.getByKey = function (absEntry) {
        return new v4_1.GetByKeyRequestBuilder(RetornoCodes_1.RetornoCodes, { AbsEntry: absEntry });
    };
    /**
    ...
    RetornoCodesRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(RetornoCodes_1.RetornoCodes);
    };
    /**
    ...
    RetornoCodesRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(RetornoCodes_1.RetornoCodes, entity);
    };
    /**
    ...
    RetornoCodesRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(RetornoCodes_1.RetornoCodes, entity);
    };
    RetornoCodesRequestBuilder.prototype.delete = function (absEntryOrEntity) {
        return new v4_1.DeleteRequestBuilder(RetornoCodes_1.RetornoCodes, absEntryOrEntity instanceof RetornoCodes_1.RetornoCodes ? absEntryOrEntity : { AbsEntry: absEntryOrEntity });
    };
