...
var InternalReconciliationParamsField = /** @class */ (function (_super) {
     ...
     */
    function InternalReconciliationParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, InternalReconciliationParams) || this;
        /**
         * Representation of the [[InternalReconciliationParams.reconNum]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.reconNum = new core_1.ComplexTypeNumberPropertyField('ReconNum', _this, 'Edm.Int32');
        return _this;
    }
...
(function (InternalReconciliationParams) {
     ...
     */
    InternalReconciliationParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, InternalReconciliationParams);
    }
