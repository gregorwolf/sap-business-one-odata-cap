...
var QueryAuthGroups = /** @class */ (function (_super) {
    ...
    QueryAuthGroups.builder = function () {
        return core_1.EntityV4.entityBuilder(QueryAuthGroups);
    };
    /**
    ...
    QueryAuthGroups.customField = function (fieldName) {
        return core_1.EntityV4.customFieldSelector(fieldName, QueryAuthGroups);
    };
    /**
     ...
     */
    QueryAuthGroups._defaultServicePath = '/b1s/v2/';
...
(function (QueryAuthGroups) {
     ...
     */
    QueryAuthGroups.AUTH_GROUP_CODE = new core_1.StringField('AuthGroupCode', QueryAuthGroups, 'Edm.String');
    /**
     * Static representation of the [[authGroupDes]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    QueryAuthGroups.AUTH_GROUP_DES = new core_1.StringField('AuthGroupDes', QueryAuthGroups, 'Edm.String');
    /**
     * Static representation of the [[authGroupId]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    QueryAuthGroups.AUTH_GROUP_ID = new core_1.NumberField('AuthGroupId', QueryAuthGroups, 'Edm.Int32');
    /**
     * Static representation of the [[categoryGroupCollection]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    QueryAuthGroups.CATEGORY_GROUP_COLLECTION = new core_1.CollectionField('CategoryGroupCollection', QueryAuthGroups, CategoryGroup_1.CategoryGroup);
    /**
     ...
     * All fields selector.
     */
    QueryAuthGroups.ALL_FIELDS = new core_1.AllFields('*', QueryAuthGroups);
    /**
