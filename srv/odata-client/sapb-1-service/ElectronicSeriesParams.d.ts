 ...
 */
export declare class ElectronicSeriesParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, ElectronicSeriesParams> {
    /**
...
export declare namespace ElectronicSeriesParams {
     ...
     */
    const _propertyMetadata: PropertyMetadata<ElectronicSeriesParams>[];
    /**
