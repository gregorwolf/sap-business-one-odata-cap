...
var FactoringIndicatorParamsField = /** @class */ (function (_super) {
     ...
     */
    function FactoringIndicatorParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, FactoringIndicatorParams) || this;
        /**
         * Representation of the [[FactoringIndicatorParams.indicatorCode]] property for query construction.
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.indicatorCode = new core_1.ComplexTypeStringPropertyField('IndicatorCode', _this, 'Edm.String');
        return _this;
    }
...
(function (FactoringIndicatorParams) {
     ...
     */
    FactoringIndicatorParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, FactoringIndicatorParams);
    }
