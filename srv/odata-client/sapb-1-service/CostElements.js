...
var CostElements = /** @class */ (function (_super) {
    ...
    CostElements.builder = function () {
        return core_1.EntityV4.entityBuilder(CostElements);
    };
    /**
    ...
    CostElements.customField = function (fieldName) {
        return core_1.EntityV4.customFieldSelector(fieldName, CostElements);
    };
    /**
     ...
     */
    CostElements._defaultServicePath = '/b1s/v2/';
    return CostElements;
}(core_1.EntityV4));
...
(function (CostElements) {
     ...
     */
    CostElements.CODE = new core_1.StringField('Code', CostElements, 'Edm.String');
    /**
     * Static representation of the [[description]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CostElements.DESCRIPTION = new core_1.StringField('Description', CostElements, 'Edm.String');
    /**
     * Static representation of the [[isActive]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CostElements.IS_ACTIVE = new core_1.EnumField('IsActive', CostElements);
    /**
     * Static representation of the one-to-many navigation property [[chartOfAccounts]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    CostElements.CHART_OF_ACCOUNTS = new core_1.OneToManyLink('ChartOfAccounts', CostElements, ChartOfAccounts_1.ChartOfAccounts);
    /**
     ...
     * All fields selector.
     */
    CostElements.ALL_FIELDS = new core_1.AllFields('*', CostElements);
    /**
