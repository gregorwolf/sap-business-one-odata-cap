...
var Banks = /** @class */ (function (_super) {
    ...
    Banks.builder = function () {
        return v4_1.Entity.entityBuilder(Banks);
    };
    /**
    ...
    Banks.customField = function (fieldName) {
        return v4_1.Entity.customFieldSelector(fieldName, Banks);
    };
    /**
     ...
     */
    Banks._serviceName = 'SAPB1';
    /**
     * Default url path for the according service.
     */
    Banks._defaultServicePath = 'VALUE_IS_UNDEFINED';
    return Banks;
}(v4_1.Entity));
exports.Banks = Banks;
...
(function (Banks) {
     ...
     */
    Banks.BANK_CODE = new v4_1.StringField('BankCode', Banks, 'Edm.String');
    /**
     * Static representation of the [[bankName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Banks.BANK_NAME = new v4_1.StringField('BankName', Banks, 'Edm.String');
    /**
     * Static representation of the [[accountforOutgoingChecks]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Banks.ACCOUNTFOR_OUTGOING_CHECKS = new v4_1.StringField('AccountforOutgoingChecks', Banks, 'Edm.String');
    /**
     * Static representation of the [[branchforOutgoingChecks]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Banks.BRANCHFOR_OUTGOING_CHECKS = new v4_1.StringField('BranchforOutgoingChecks', Banks, 'Edm.String');
    /**
     * Static representation of the [[nextCheckNumber]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Banks.NEXT_CHECK_NUMBER = new v4_1.NumberField('NextCheckNumber', Banks, 'Edm.Int32');
    /**
     * Static representation of the [[swiftNo]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Banks.SWIFT_NO = new v4_1.StringField('SwiftNo', Banks, 'Edm.String');
    /**
     * Static representation of the [[iban]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Banks.IBAN = new v4_1.StringField('IBAN', Banks, 'Edm.String');
    /**
     * Static representation of the [[countryCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Banks.COUNTRY_CODE = new v4_1.StringField('CountryCode', Banks, 'Edm.String');
    /**
     * Static representation of the [[absoluteEntry]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Banks.ABSOLUTE_ENTRY = new v4_1.NumberField('AbsoluteEntry', Banks, 'Edm.Int32');
    /**
     * Static representation of the [[defaultBankAccountKey]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Banks.DEFAULT_BANK_ACCOUNT_KEY = new v4_1.NumberField('DefaultBankAccountKey', Banks, 'Edm.Int32');
    /**
     * Static representation of the one-to-many navigation property [[employeesInfo]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Banks.EMPLOYEES_INFO = new v4_1.OneToManyLink('EmployeesInfo', Banks, EmployeesInfo_1.EmployeesInfo);
    /**
     * Static representation of the one-to-one navigation property [[country]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Banks.COUNTRY = new v4_1.OneToOneLink('Country', Banks, Countries_1.Countries);
    /**
     * Static representation of the one-to-many navigation property [[houseBankAccounts]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    Banks.HOUSE_BANK_ACCOUNTS = new v4_1.OneToManyLink('HouseBankAccounts', Banks, HouseBankAccounts_1.HouseBankAccounts);
    /**
     ...
     * All fields selector.
     */
    Banks.ALL_FIELDS = new v4_1.AllFields('*', Banks);
    /**
