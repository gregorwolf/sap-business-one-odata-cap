...
var QueueRequestBuilder = /** @class */ (function (_super) {
    ...
    QueueRequestBuilder.prototype.getByKey = function (queueId) {
        return new v4_1.GetByKeyRequestBuilder(Queue_1.Queue, { QueueID: queueId });
    };
    /**
    ...
    QueueRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(Queue_1.Queue);
    };
    /**
    ...
    QueueRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(Queue_1.Queue, entity);
    };
    /**
    ...
    QueueRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(Queue_1.Queue, entity);
    };
    QueueRequestBuilder.prototype.delete = function (queueIdOrEntity) {
        return new v4_1.DeleteRequestBuilder(Queue_1.Queue, queueIdOrEntity instanceof Queue_1.Queue ? queueIdOrEntity : { QueueID: queueIdOrEntity });
    };
