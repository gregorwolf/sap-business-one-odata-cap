...
var PmProjectDocumentParamsField = /** @class */ (function (_super) {
     ...
     */
    function PmProjectDocumentParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, PmProjectDocumentParams) || this;
        /**
...
(function (PmProjectDocumentParams) {
     ...
     */
    PmProjectDocumentParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, PmProjectDocumentParams);
    }
