...
var LandedCostsCodes = /** @class */ (function (_super) {
    ...
    LandedCostsCodes.builder = function () {
        return core_1.EntityV4.entityBuilder(LandedCostsCodes);
    };
    /**
    ...
    LandedCostsCodes.customField = function (fieldName) {
        return core_1.EntityV4.customFieldSelector(fieldName, LandedCostsCodes);
    };
    /**
     ...
     */
    LandedCostsCodes._defaultServicePath = '/b1s/v2/';
...
(function (LandedCostsCodes) {
     ...
     */
    LandedCostsCodes.CODE = new core_1.StringField('Code', LandedCostsCodes, 'Edm.String');
    /**
     * Static representation of the [[name]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCostsCodes.NAME = new core_1.StringField('Name', LandedCostsCodes, 'Edm.String');
    /**
     * Static representation of the [[allocationBy]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCostsCodes.ALLOCATION_BY = new core_1.EnumField('AllocationBy', LandedCostsCodes);
    /**
     * Static representation of the [[landedCostsAllocationAccount]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LandedCostsCodes.LANDED_COSTS_ALLOCATION_ACCOUNT = new core_1.StringField('LandedCostsAllocationAccount', LandedCostsCodes, 'Edm.String');
    /**
     ...
     * All fields selector.
     */
    LandedCostsCodes.ALL_FIELDS = new core_1.AllFields('*', LandedCostsCodes);
    /**
