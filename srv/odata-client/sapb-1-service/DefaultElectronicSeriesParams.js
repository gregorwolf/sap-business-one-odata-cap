...
var DefaultElectronicSeriesParamsField = /** @class */ (function (_super) {
     ...
     */
    function DefaultElectronicSeriesParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, DefaultElectronicSeriesParams) || this;
        /**
...
(function (DefaultElectronicSeriesParams) {
     ...
     */
    DefaultElectronicSeriesParams._propertyMetadata = [{
            originalName: 'Series',
            name: 'series',
            type: 'Edm.Int32',
            isCollection: false
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, DefaultElectronicSeriesParams);
    }
