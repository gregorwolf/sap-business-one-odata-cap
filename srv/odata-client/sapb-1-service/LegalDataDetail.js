...
var LegalDataDetailField = /** @class */ (function (_super) {
    ...
    function LegalDataDetailField() {
         ...
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.lineSequence = new v4_1.ComplexTypeNumberPropertyField('LineSequence', _this, 'Edm.Int32');
        /**
...
(function (LegalDataDetail) {
    function build(json) {
        return v4_1.createComplexType(json, {
            ...
            LineSequence: function (lineSequence) { return ({ lineSequence: v4_1.edmToTs(lineSequence, 'Edm.Int32') }); },
