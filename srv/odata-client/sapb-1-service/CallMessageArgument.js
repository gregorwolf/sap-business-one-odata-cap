...
var CallMessageArgumentField = /** @class */ (function (_super) {
     ...
     */
    function CallMessageArgumentField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, CallMessageArgument) || this;
        /**
...
(function (CallMessageArgument) {
     ...
     */
    CallMessageArgument._propertyMetadata = [{
            originalName: 'Name',
            name: 'name',
            type: 'Edm.String',
            isCollection: false
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, CallMessageArgument);
    }
