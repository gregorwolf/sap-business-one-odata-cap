...
var LandedCostsRequestBuilder = /** @class */ (function (_super) {
    ...
    LandedCostsRequestBuilder.prototype.getByKey = function (docEntry) {
        return new v4_1.GetByKeyRequestBuilder(LandedCosts_1.LandedCosts, { DocEntry: docEntry });
    };
    /**
    ...
    LandedCostsRequestBuilder.prototype.getAll = function () {
        return new v4_1.GetAllRequestBuilder(LandedCosts_1.LandedCosts);
    };
    /**
    ...
    LandedCostsRequestBuilder.prototype.create = function (entity) {
        return new v4_1.CreateRequestBuilder(LandedCosts_1.LandedCosts, entity);
    };
    /**
    ...
    LandedCostsRequestBuilder.prototype.update = function (entity) {
        return new v4_1.UpdateRequestBuilder(LandedCosts_1.LandedCosts, entity);
    };
    LandedCostsRequestBuilder.prototype.delete = function (docEntryOrEntity) {
        return new v4_1.DeleteRequestBuilder(LandedCosts_1.LandedCosts, docEntryOrEntity instanceof LandedCosts_1.LandedCosts ? docEntryOrEntity : { DocEntry: docEntryOrEntity });
    };
