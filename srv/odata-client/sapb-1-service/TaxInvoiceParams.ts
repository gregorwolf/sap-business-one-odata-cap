 ...
 */
export class TaxInvoiceParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, TaxInvoiceParams> {
  /**
  ...
  constructor(fieldName: string, fieldOf: ConstructorOrField<EntityT>) {
    super(fieldName, fieldOf, TaxInvoiceParams);
  }
}
...
export namespace TaxInvoiceParams {
   ...
   */
  export const _propertyMetadata: PropertyMetadata<TaxInvoiceParams>[] = [{
  ...
  export function build(json: { [keys: string]: FieldType }): TaxInvoiceParams {
    return deserializeComplexTypeV4(json, TaxInvoiceParams);
  }
}
