...
var ChecksforPaymentParamsField = /** @class */ (function (_super) {
     ...
     */
    function ChecksforPaymentParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, ChecksforPaymentParams) || this;
        /**
...
(function (ChecksforPaymentParams) {
     ...
     */
    ChecksforPaymentParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, ChecksforPaymentParams);
    }
