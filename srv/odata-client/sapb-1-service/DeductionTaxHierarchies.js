...
var DeductionTaxHierarchies = /** @class */ (function (_super) {
    ...
    DeductionTaxHierarchies.builder = function () {
        return core_1.EntityV4.entityBuilder(DeductionTaxHierarchies);
    };
    /**
    ...
    DeductionTaxHierarchies.customField = function (fieldName) {
        return core_1.EntityV4.customFieldSelector(fieldName, DeductionTaxHierarchies);
    };
    /**
     ...
     */
    DeductionTaxHierarchies._defaultServicePath = '/b1s/v2/';
...
(function (DeductionTaxHierarchies) {
     ...
     */
    DeductionTaxHierarchies.ABS_ENTRY = new core_1.NumberField('AbsEntry', DeductionTaxHierarchies, 'Edm.Int32');
    /**
     * Static representation of the [[bpCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    DeductionTaxHierarchies.BP_CODE = new core_1.StringField('BPCode', DeductionTaxHierarchies, 'Edm.String');
    /**
     * Static representation of the [[hierarchyCode]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    DeductionTaxHierarchies.HIERARCHY_CODE = new core_1.StringField('HierarchyCode', DeductionTaxHierarchies, 'Edm.String');
    /**
     * Static representation of the [[hierarchyName]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    DeductionTaxHierarchies.HIERARCHY_NAME = new core_1.StringField('HierarchyName', DeductionTaxHierarchies, 'Edm.String');
    /**
     * Static representation of the [[validFrom]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    DeductionTaxHierarchies.VALID_FROM = new core_1.DateField('ValidFrom', DeductionTaxHierarchies, 'Edm.DateTimeOffset');
    /**
     * Static representation of the [[validUntil]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    DeductionTaxHierarchies.VALID_UNTIL = new core_1.DateField('ValidUntil', DeductionTaxHierarchies, 'Edm.DateTimeOffset');
    /**
     * Static representation of the [[deductionPercent]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    DeductionTaxHierarchies.DEDUCTION_PERCENT = new core_1.NumberField('DeductionPercent', DeductionTaxHierarchies, 'Edm.Double');
    /**
     * Static representation of the [[maximumTotal]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    DeductionTaxHierarchies.MAXIMUM_TOTAL = new core_1.NumberField('MaximumTotal', DeductionTaxHierarchies, 'Edm.Double');
    /**
     * Static representation of the [[lastUpdated]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    DeductionTaxHierarchies.LAST_UPDATED = new core_1.DateField('LastUpdated', DeductionTaxHierarchies, 'Edm.DateTimeOffset');
    /**
     * Static representation of the [[deductionTaxHierarchiesLines]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    DeductionTaxHierarchies.DEDUCTION_TAX_HIERARCHIES_LINES = new core_1.CollectionField('DeductionTaxHierarchies_Lines', DeductionTaxHierarchies, DeductionTaxHierarchiesLine_1.DeductionTaxHierarchiesLine);
    /**
     * Static representation of the one-to-one navigation property [[businessPartner]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    DeductionTaxHierarchies.BUSINESS_PARTNER = new core_1.OneToOneLink('BusinessPartner', DeductionTaxHierarchies, BusinessPartners_1.BusinessPartners);
    /**
     ...
     * All fields selector.
     */
    DeductionTaxHierarchies.ALL_FIELDS = new core_1.AllFields('*', DeductionTaxHierarchies);
    /**
