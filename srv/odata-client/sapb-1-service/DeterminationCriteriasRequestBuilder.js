...
var DeterminationCriteriasRequestBuilder = /** @class */ (function (_super) {
    ...
    DeterminationCriteriasRequestBuilder.prototype.getByKey = function (dmcId) {
        return new core_1.GetByKeyRequestBuilderV4(DeterminationCriterias_1.DeterminationCriterias, { DmcId: dmcId });
    };
    /**
    ...
    DeterminationCriteriasRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(DeterminationCriterias_1.DeterminationCriterias);
    };
    /**
    ...
    DeterminationCriteriasRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(DeterminationCriterias_1.DeterminationCriterias, entity);
    };
    /**
    ...
    DeterminationCriteriasRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(DeterminationCriterias_1.DeterminationCriterias, entity);
    };
    DeterminationCriteriasRequestBuilder.prototype.delete = function (dmcIdOrEntity) {
        return new core_1.DeleteRequestBuilderV4(DeterminationCriterias_1.DeterminationCriterias, dmcIdOrEntity instanceof DeterminationCriterias_1.DeterminationCriterias ? dmcIdOrEntity : { DmcId: dmcIdOrEntity });
    };
