...
var PmTimeSheetParamsField = /** @class */ (function (_super) {
     ...
     */
    function PmTimeSheetParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, PmTimeSheetParams) || this;
        /**
...
(function (PmTimeSheetParams) {
     ...
     */
    PmTimeSheetParams._propertyMetadata = [{
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, PmTimeSheetParams);
    }
