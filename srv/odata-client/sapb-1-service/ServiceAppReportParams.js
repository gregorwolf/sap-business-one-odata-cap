...
var ServiceAppReportParamsField = /** @class */ (function (_super) {
     ...
     */
    function ServiceAppReportParamsField(fieldName, fieldOf) {
        var _this = _super.call(this, fieldName, fieldOf, ServiceAppReportParams) || this;
        /**
...
(function (ServiceAppReportParams) {
     ...
     */
    ServiceAppReportParams._propertyMetadata = [{
            originalName: 'Code',
            name: 'code',
            type: 'Edm.Int32',
            isCollection: false
     ...
     */
    function build(json) {
        return core_1.deserializeComplexTypeV4(json, ServiceAppReportParams);
    }
