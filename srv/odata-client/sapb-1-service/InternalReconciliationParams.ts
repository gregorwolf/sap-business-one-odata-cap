 ...
 */
export class InternalReconciliationParamsField<EntityT extends Entity> extends ComplexTypeField<EntityT> {
  /**
...
export namespace InternalReconciliationParams {
  export function build(json: { [keys: string]: FieldType }): InternalReconciliationParams {
    return createComplexType(json, {
      ReconNum: (reconNum: number) => ({ reconNum: edmToTs(reconNum, 'Edm.Int32') })
    });
  }
}
