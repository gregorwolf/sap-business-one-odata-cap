...
var EmployeeRolesSetup = /** @class */ (function (_super) {
    ...
    EmployeeRolesSetup.builder = function () {
        return core_1.EntityV4.entityBuilder(EmployeeRolesSetup);
    };
    /**
    ...
    EmployeeRolesSetup.customField = function (fieldName) {
        return core_1.EntityV4.customFieldSelector(fieldName, EmployeeRolesSetup);
    };
    /**
     ...
     */
    EmployeeRolesSetup._defaultServicePath = '/b1s/v2/';
...
(function (EmployeeRolesSetup) {
     ...
     */
    EmployeeRolesSetup.TYPE_ID = new core_1.NumberField('TypeID', EmployeeRolesSetup, 'Edm.Int32');
    /**
     * Static representation of the [[name]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmployeeRolesSetup.NAME = new core_1.StringField('Name', EmployeeRolesSetup, 'Edm.String');
    /**
     * Static representation of the [[description]] property for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmployeeRolesSetup.DESCRIPTION = new core_1.StringField('Description', EmployeeRolesSetup, 'Edm.String');
    /**
     * Static representation of the one-to-many navigation property [[employeesInfo]] for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    EmployeeRolesSetup.EMPLOYEES_INFO = new core_1.OneToManyLink('EmployeesInfo', EmployeeRolesSetup, EmployeesInfo_1.EmployeesInfo);
    /**
     ...
     * All fields selector.
     */
    EmployeeRolesSetup.ALL_FIELDS = new core_1.AllFields('*', EmployeeRolesSetup);
    /**
