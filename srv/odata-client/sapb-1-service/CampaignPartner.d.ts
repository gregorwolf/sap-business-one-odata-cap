 ...
 */
export declare class CampaignPartnerField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, CampaignPartner> {
    /**
...
export declare namespace CampaignPartner {
     ...
     */
    const _propertyMetadata: PropertyMetadata<CampaignPartner>[];
    /**
