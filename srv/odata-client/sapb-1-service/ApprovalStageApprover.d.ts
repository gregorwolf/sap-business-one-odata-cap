 ...
 */
export declare class ApprovalStageApproverField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, ApprovalStageApprover> {
    /**
...
export declare namespace ApprovalStageApprover {
     ...
     */
    const _propertyMetadata: PropertyMetadata<ApprovalStageApprover>[];
    /**
