...
var BusinessPlaceIeNumberField = /** @class */ (function (_super) {
    ...
    function BusinessPlaceIeNumberField() {
         ...
         * Use to reference this property in query operations such as 'filter' in the fluent request API.
         */
        _this.ieNumber = new v4_1.ComplexTypeStringPropertyField('IENumber', _this, 'Edm.String');
        return _this;
    }
...
(function (BusinessPlaceIeNumber) {
    function build(json) {
        return v4_1.createComplexType(json, {
            ...
            IENumber: function (ieNumber) { return ({ ieNumber: v4_1.edmToTs(ieNumber, 'Edm.String') }); }
        });
    }
