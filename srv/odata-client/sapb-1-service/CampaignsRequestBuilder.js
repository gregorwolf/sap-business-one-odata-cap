...
var CampaignsRequestBuilder = /** @class */ (function (_super) {
    ...
    CampaignsRequestBuilder.prototype.getByKey = function (campaignNumber) {
        return new core_1.GetByKeyRequestBuilderV4(Campaigns_1.Campaigns, { CampaignNumber: campaignNumber });
    };
    /**
    ...
    CampaignsRequestBuilder.prototype.getAll = function () {
        return new core_1.GetAllRequestBuilderV4(Campaigns_1.Campaigns);
    };
    /**
    ...
    CampaignsRequestBuilder.prototype.create = function (entity) {
        return new core_1.CreateRequestBuilderV4(Campaigns_1.Campaigns, entity);
    };
    /**
    ...
    CampaignsRequestBuilder.prototype.update = function (entity) {
        return new core_1.UpdateRequestBuilderV4(Campaigns_1.Campaigns, entity);
    };
    CampaignsRequestBuilder.prototype.delete = function (campaignNumberOrEntity) {
        return new core_1.DeleteRequestBuilderV4(Campaigns_1.Campaigns, campaignNumberOrEntity instanceof Campaigns_1.Campaigns ? campaignNumberOrEntity : { CampaignNumber: campaignNumberOrEntity });
    };
