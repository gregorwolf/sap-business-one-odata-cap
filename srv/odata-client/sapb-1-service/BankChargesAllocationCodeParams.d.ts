 ...
 */
export declare class BankChargesAllocationCodeParamsField<EntityT extends EntityV4> extends ComplexTypeField<EntityT, BankChargesAllocationCodeParams> {
    /**
...
export declare namespace BankChargesAllocationCodeParams {
     ...
     */
    const _propertyMetadata: PropertyMetadata<BankChargesAllocationCodeParams>[];
    /**
