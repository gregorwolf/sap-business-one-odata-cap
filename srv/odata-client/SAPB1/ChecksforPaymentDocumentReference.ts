 ...
 */
export interface ChecksforPaymentDocumentReference<
...
/**
 * ChecksforPaymentDocumentReferenceField
 * @typeParam EntityT - Type of the entity the complex type field belongs to.
 */
export class ChecksforPaymentDocumentReferenceField<
...
> {
  ...
  /**
   * Representation of the {@link ChecksforPaymentDocumentReference.docEntry} property for query construction.
  ...
  /**
   * Representation of the {@link ChecksforPaymentDocumentReference.lineNumber} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link ChecksforPaymentDocumentReference.referencedDocEntry} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link ChecksforPaymentDocumentReference.referencedDocNumber} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link ChecksforPaymentDocumentReference.externalReferencedDocNumber} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link ChecksforPaymentDocumentReference.referencedObjectType} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link ChecksforPaymentDocumentReference.issueDate} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link ChecksforPaymentDocumentReference.remark} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Creates an instance of ChecksforPaymentDocumentReferenceField.
...
export namespace ChecksforPaymentDocumentReference {
  /**
   * Metadata information on all properties of the `ChecksforPaymentDocumentReference` complex type.
   */
  export const _propertyMetadata: PropertyMetadata<ChecksforPaymentDocumentReference>[] =
    [
      {
