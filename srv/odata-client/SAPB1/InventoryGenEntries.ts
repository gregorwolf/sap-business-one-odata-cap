...
import type { InventoryGenEntriesApi } from './InventoryGenEntriesApi';
 ...
 */
export class InventoryGenEntries<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements InventoryGenEntriesType<T>
{
  /**
  ...
  constructor(readonly _entityApi: InventoryGenEntriesApi<T>) {
    super(_entityApi);
  }
}
