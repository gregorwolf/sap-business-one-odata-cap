...
import type { PurchaseReturnsApi } from './PurchaseReturnsApi';
 ...
 */
export class PurchaseReturns<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements PurchaseReturnsType<T>
{
  /**
  ...
  constructor(readonly _entityApi: PurchaseReturnsApi<T>) {
    super(_entityApi);
  }
}
