 ...
 */
export class EnhancedDiscountGroupParamsField<
...
> {
  ...
  /**
   * Representation of the {@link EnhancedDiscountGroupParams.absEntry} property for query construction.
  ...
  /**
   * Representation of the {@link EnhancedDiscountGroupParams.type} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  type: EnumField<EntityT, DeSerializersT, DiscountGroupTypeEnum, true, false> =
    this._fieldBuilder.buildEnumField('Type', DiscountGroupTypeEnum, true);
  /**
   * Representation of the {@link EnhancedDiscountGroupParams.objectCode} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
