...
import type { CorrectionInvoiceReversalApi } from './CorrectionInvoiceReversalApi';
 ...
 */
export class CorrectionInvoiceReversal<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements CorrectionInvoiceReversalType<T>
{
  /**
  ...
  constructor(readonly _entityApi: CorrectionInvoiceReversalApi<T>) {
    super(_entityApi);
  }
}
