...
import type { UserLanguagesApi } from './UserLanguagesApi';
 ...
 */
export class UserLanguages<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements UserLanguagesType<T>
{
  /**
   ...
   * @nullable
   */
  languageShortName?: DeserializedType<T, 'Edm.String'> | null;
  /**
   * Language Full Name.
   * @nullable
   */
  languageFullName?: DeserializedType<T, 'Edm.String'> | null;
  /**
   * Related System Language.
   * @nullable
   */
  relatedSystemLanguage?: DeserializedType<T, 'Edm.Int32'> | null;
  /**
  ...
  constructor(readonly _entityApi: UserLanguagesApi<T>) {
    super(_entityApi);
  }
}
