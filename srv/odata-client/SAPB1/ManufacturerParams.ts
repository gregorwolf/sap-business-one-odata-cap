 ...
 */
export class ManufacturerParamsField<
...
> {
  ...
  /**
   * Representation of the {@link ManufacturerParams.code} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, ManufacturerParams, fieldOptions);
  }
}
