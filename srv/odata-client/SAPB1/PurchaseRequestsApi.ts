...
> implements EntityApi<PurchaseRequests<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new PurchaseRequestsApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    BUSINESS_PARTNER: OneToOneLink<
      PurchaseRequests<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = PurchaseRequests;

  requestBuilder(): PurchaseRequestsRequestBuilder<DeSerializersT> {
    return new PurchaseRequestsRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<PurchaseRequests<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  ): CustomField<PurchaseRequests<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _fieldBuilder?: FieldBuilder<typeof PurchaseRequests, DeSerializersT>;
  get fieldBuilder() {
  ...
  private _schema?: {
    DOC_ENTRY: OrderableEdmTypeField<
      PurchaseRequests<DeSerializers>,
      DeSerializersT,
      'Edm.Int32',
      false,
      true
    ...
    POS_DAILY_SUMMARY: OneToOneLink<
      ...
      PosDailySummaryApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<PurchaseRequests<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', PurchaseRequests)
      };
    }
