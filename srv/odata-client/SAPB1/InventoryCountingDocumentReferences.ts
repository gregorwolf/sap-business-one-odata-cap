 ...
 */
export interface InventoryCountingDocumentReferences<
...
/**
 * InventoryCountingDocumentReferencesField
 * @typeParam EntityT - Type of the entity the complex type field belongs to.
 */
export class InventoryCountingDocumentReferencesField<
...
> {
  ...
  /**
   * Representation of the {@link InventoryCountingDocumentReferences.docEntry} property for query construction.
  ...
  /**
   * Representation of the {@link InventoryCountingDocumentReferences.lineNumber} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link InventoryCountingDocumentReferences.referencedDocEntry} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link InventoryCountingDocumentReferences.referencedDocNumber} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link InventoryCountingDocumentReferences.externalReferencedDocNumber} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link InventoryCountingDocumentReferences.referencedObjectType} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link InventoryCountingDocumentReferences.issueDate} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link InventoryCountingDocumentReferences.remark} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Creates an instance of InventoryCountingDocumentReferencesField.
...
export namespace InventoryCountingDocumentReferences {
  /**
   * Metadata information on all properties of the `InventoryCountingDocumentReferences` complex type.
   */
  export const _propertyMetadata: PropertyMetadata<InventoryCountingDocumentReferences>[] =
    [
      {
