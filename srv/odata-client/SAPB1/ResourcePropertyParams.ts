 ...
 */
export class ResourcePropertyParamsField<
...
> {
  ...
  /**
   * Representation of the {@link ResourcePropertyParams.code} property for query construction.
  ...
  /**
   * Representation of the {@link ResourcePropertyParams.name} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
