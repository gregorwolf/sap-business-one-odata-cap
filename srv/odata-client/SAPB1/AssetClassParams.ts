 ...
 */
export class AssetClassParamsField<
...
> {
  ...
  /**
   * Representation of the {@link AssetClassParams.code} property for query construction.
  ...
  /**
   * Representation of the {@link AssetClassParams.description} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, AssetClassParams, fieldOptions);
  }
}
