 ...
 */
export class NfTaxCategoryParamsField<
...
> {
  ...
  /**
   * Representation of the {@link NfTaxCategoryParams.absId} property for query construction.
  ...
  /**
   * Representation of the {@link NfTaxCategoryParams.code} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, NfTaxCategoryParams, fieldOptions);
  }
}
