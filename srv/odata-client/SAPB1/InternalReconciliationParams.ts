...
> {
   ...
   * @nullable
   */
  reconNum?: DeserializedType<DeSerializersT, 'Edm.Int32'>;
}
 ...
 */
export class InternalReconciliationParamsField<
...
> {
  ...
  /**
   * Representation of the {@link InternalReconciliationParams.reconNum} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  reconNum: OrderableEdmTypeField<
    EntityT,
    DeSerializersT,
    'Edm.Int32',
    true,
    false
  > = this._fieldBuilder.buildEdmTypeField('ReconNum', 'Edm.Int32', true);
