 ...
 */
export class VatGroupParamsField<
...
> {
  ...
  /**
   * Representation of the {@link VatGroupParams.code} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, VatGroupParams, fieldOptions);
  }
}
