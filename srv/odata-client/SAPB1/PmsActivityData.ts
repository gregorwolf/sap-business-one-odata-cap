 ...
 */
export class PmsActivityDataField<
...
> {
  ...
  /**
   * Representation of the {@link PmsActivityData.lineId} property for query construction.
  ...
  /**
   * Representation of the {@link PmsActivityData.stageId} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link PmsActivityData.activityId} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, PmsActivityData, fieldOptions);
  }
}
