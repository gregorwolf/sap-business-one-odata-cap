 ...
 */
export class BudgetParamsField<
...
> {
  ...
  /**
   * Representation of the {@link BudgetParams.numerator} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, BudgetParams, fieldOptions);
  }
}
