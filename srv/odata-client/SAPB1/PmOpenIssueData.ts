 ...
 */
export class PmOpenIssueDataField<
...
> {
  ...
  /**
   * Representation of the {@link PmOpenIssueData.lineId} property for query construction.
  ...
  /**
   * Representation of the {@link PmOpenIssueData.stageId} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link PmOpenIssueData.area} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link PmOpenIssueData.priority} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link PmOpenIssueData.remarks} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link PmOpenIssueData.closed} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  closed: EnumField<EntityT, DeSerializersT, BoYesNoEnum, true, false> =
    this._fieldBuilder.buildEnumField('Closed', BoYesNoEnum, true);
  /**
   * Representation of the {@link PmOpenIssueData.solutionId} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link PmOpenIssueData.responsible} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link PmOpenIssueData.enteredBy} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link PmOpenIssueData.enteredDate} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link PmOpenIssueData.effort} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, PmOpenIssueData, fieldOptions);
  }
}
