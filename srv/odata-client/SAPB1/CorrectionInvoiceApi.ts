...
export class CorrectionInvoiceApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<CorrectionInvoice<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new CorrectionInvoiceApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    BUSINESS_PARTNER: OneToOneLink<
      CorrectionInvoice<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = CorrectionInvoice;

  requestBuilder(): CorrectionInvoiceRequestBuilder<DeSerializersT> {
    return new CorrectionInvoiceRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<CorrectionInvoice<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  ): CustomField<CorrectionInvoice<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _schema?: {
    DOC_ENTRY: OrderableEdmTypeField<
      CorrectionInvoice<DeSerializers>,
      DeSerializersT,
      'Edm.Int32',
      false,
      true
    ...
    POS_DAILY_SUMMARY: OneToOneLink<
      ...
      PosDailySummaryApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<CorrectionInvoice<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', CorrectionInvoice)
      };
    }
