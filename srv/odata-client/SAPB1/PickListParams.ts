 ...
 */
export class PickListParamsField<
...
> {
  ...
  /**
   * Representation of the {@link PickListParams.absoluteentry} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, PickListParams, fieldOptions);
  }
}
