 ...
 */
export class GovPayCodeParamsField<
...
> {
  ...
  /**
   * Representation of the {@link GovPayCodeParams.absId} property for query construction.
  ...
  /**
   * Representation of the {@link GovPayCodeParams.code} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, GovPayCodeParams, fieldOptions);
  }
}
...
export namespace GovPayCodeParams {
   ...
   */
  export const _propertyMetadata: PropertyMetadata<GovPayCodeParams>[] = [
    {
      originalName: 'AbsId',
      name: 'absId',
      type: 'Edm.Int32',
