 ...
 */
export class TaxCodeDeterminationTcdKeyFieldValuePeriodByUsageField<
...
> {
  ...
  /**
   * Representation of the {@link TaxCodeDeterminationTcdKeyFieldValuePeriodByUsage.absId} property for query construction.
  ...
  /**
   * Representation of the {@link TaxCodeDeterminationTcdKeyFieldValuePeriodByUsage.usageCode} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link TaxCodeDeterminationTcdKeyFieldValuePeriodByUsage.taxCode} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link TaxCodeDeterminationTcdKeyFieldValuePeriodByUsage.expTaxCode} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link TaxCodeDeterminationTcdKeyFieldValuePeriodByUsage.purTaxCode} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
