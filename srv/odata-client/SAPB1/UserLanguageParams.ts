 ...
 */
export class UserLanguageParamsField<
...
> {
  ...
  /**
   * Representation of the {@link UserLanguageParams.code} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, UserLanguageParams, fieldOptions);
  }
}
