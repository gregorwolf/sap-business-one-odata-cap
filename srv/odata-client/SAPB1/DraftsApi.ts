...
> implements EntityApi<Drafts<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new DraftsApi(deSerializers);
  }
  ...
  entityConstructor = Drafts;

  requestBuilder(): DraftsRequestBuilder<DeSerializersT> {
    return new DraftsRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<Drafts<DeSerializersT>, DeSerializersT> {
    return entityBuilder<Drafts<DeSerializersT>, DeSerializersT>(this);
  }

  customField<NullableT extends boolean = false>(
    fieldName: string,
    isNullable: NullableT = false as NullableT
  ): CustomField<Drafts<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _fieldBuilder?: FieldBuilder<typeof Drafts, DeSerializersT>;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(Drafts, this.deSerializers);
    }
  ...
  private _schema?: {
    ...
    POS_DAILY_SUMMARY: OneToOneLink<
      ...
      PosDailySummaryApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<Drafts<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', Drafts)
      };
    }
