...
import type { PurchaseInvoicesApi } from './PurchaseInvoicesApi';
 ...
 */
export class PurchaseInvoices<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements PurchaseInvoicesType<T>
{
  /**
  ...
  constructor(readonly _entityApi: PurchaseInvoicesApi<T>) {
    super(_entityApi);
  }
}
