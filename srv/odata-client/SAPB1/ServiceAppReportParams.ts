 ...
 */
export class ServiceAppReportParamsField<
...
> {
  ...
  /**
   * Representation of the {@link ServiceAppReportParams.code} property for query construction.
  ...
  /**
   * Representation of the {@link ServiceAppReportParams.reportChoice} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
