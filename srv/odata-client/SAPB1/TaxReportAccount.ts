 ...
 */
export class TaxReportAccountField<
...
> {
  ...
  /**
   * Representation of the {@link TaxReportAccount.code} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, TaxReportAccount, fieldOptions);
  }
}
