 ...
 */
export class CallArgumentField<
...
> {
  ...
  /**
   * Representation of the {@link CallArgument.name} property for query construction.
  ...
  /**
   * Representation of the {@link CallArgument.value} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, CallArgument, fieldOptions);
  }
}
