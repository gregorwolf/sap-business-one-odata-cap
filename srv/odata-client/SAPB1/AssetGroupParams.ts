 ...
 */
export class AssetGroupParamsField<
...
> {
  ...
  /**
   * Representation of the {@link AssetGroupParams.code} property for query construction.
  ...
  /**
   * Representation of the {@link AssetGroupParams.description} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, AssetGroupParams, fieldOptions);
  }
}
