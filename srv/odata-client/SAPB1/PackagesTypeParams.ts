 ...
 */
export class PackagesTypeParamsField<
...
> {
  ...
  /**
   * Representation of the {@link PackagesTypeParams.code} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, PackagesTypeParams, fieldOptions);
  }
}
