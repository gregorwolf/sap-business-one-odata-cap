...
import type { PurchaseDownPaymentsApi } from './PurchaseDownPaymentsApi';
 ...
 */
export class PurchaseDownPayments<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements PurchaseDownPaymentsType<T>
{
  /**
  ...
  constructor(readonly _entityApi: PurchaseDownPaymentsApi<T>) {
    super(_entityApi);
  }
}
