...
import type { PaymentBlocksApi } from './PaymentBlocksApi';
import {
  PurchaseQuotations,
 ...
 */
export class PaymentBlocks<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements PaymentBlocksType<T>
{
  /**
   ...
   * @nullable
   */
  paymentBlockCode?: DeserializedType<T, 'Edm.String'> | null;
  /**
  ...
  constructor(readonly _entityApi: PaymentBlocksApi<T>) {
    super(_entityApi);
  }
}
