 ...
 */
export class AttributeGroupParamsField<
...
> {
  ...
  /**
   * Representation of the {@link AttributeGroupParams.code} property for query construction.
  ...
  /**
   * Representation of the {@link AttributeGroupParams.name} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
