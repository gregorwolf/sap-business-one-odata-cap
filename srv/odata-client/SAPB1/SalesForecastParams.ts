 ...
 */
export class SalesForecastParamsField<
...
> {
  ...
  /**
   * Representation of the {@link SalesForecastParams.numerator} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, SalesForecastParams, fieldOptions);
  }
}
