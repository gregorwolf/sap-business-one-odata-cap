 ...
 */
export class CashDiscountParamsField<
...
> {
  ...
  /**
   * Representation of the {@link CashDiscountParams.code} property for query construction.
  ...
  /**
   * Representation of the {@link CashDiscountParams.name} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, CashDiscountParams, fieldOptions);
  }
}
