...
import type { ReturnsApi } from './ReturnsApi';
 ...
 */
export class Returns<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements ReturnsType<T>
{
  /**
  ...
  constructor(readonly _entityApi: ReturnsApi<T>) {
    super(_entityApi);
  }
}

export interface ReturnsType<T extends DeSerializers = DefaultDeSerializers> {
  docEntry: DeserializedType<T, 'Edm.Int32'>;
  docNum?: DeserializedType<T, 'Edm.Int32'> | null;
  docType?: BoDocumentTypes | null;
  handWritten?: BoYesNoEnum | null;
