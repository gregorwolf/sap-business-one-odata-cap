 ...
 */
export class AssetTransfer<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements AssetTransferType<T>
{
  /**
  ...
  constructor(readonly _entityApi: AssetTransferApi<T>) {
    super(_entityApi);
  }
}
