...
export class AssetRetirementApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<AssetRetirement<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new AssetRetirementApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    CURRENCY_2: OneToOneLink<
      AssetRetirement<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = AssetRetirement;

  requestBuilder(): AssetRetirementRequestBuilder<DeSerializersT> {
    return new AssetRetirementRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<AssetRetirement<DeSerializersT>, DeSerializersT>(this);
  }

  customField<NullableT extends boolean = false>(
    fieldName: string,
    isNullable: NullableT = false as NullableT
  ): CustomField<AssetRetirement<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _fieldBuilder?: FieldBuilder<typeof AssetRetirement, DeSerializersT>;
  get fieldBuilder() {
  ...
  private _schema?: {
    ...
    BUSINESS_PLACE: OneToOneLink<
      ...
      BusinessPlacesApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<AssetRetirement<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', AssetRetirement)
      };
    }
