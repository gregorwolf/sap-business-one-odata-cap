...
> implements EntityApi<ReturnRequest<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new ReturnRequestApi(deSerializers);
  }
  ...
  entityConstructor = ReturnRequest;

  requestBuilder(): ReturnRequestRequestBuilder<DeSerializersT> {
    return new ReturnRequestRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<ReturnRequest<DeSerializersT>, DeSerializersT>(this);
  }

  customField<NullableT extends boolean = false>(
    fieldName: string,
    isNullable: NullableT = false as NullableT
  ): CustomField<ReturnRequest<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _fieldBuilder?: FieldBuilder<typeof ReturnRequest, DeSerializersT>;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(ReturnRequest, this.deSerializers);
    }
  ...
  private _schema?: {
    ...
    POS_DAILY_SUMMARY: OneToOneLink<
      ...
      PosDailySummaryApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<ReturnRequest<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', ReturnRequest)
      };
    }
