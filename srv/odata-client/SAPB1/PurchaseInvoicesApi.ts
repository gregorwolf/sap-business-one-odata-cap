...
> implements EntityApi<PurchaseInvoices<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new PurchaseInvoicesApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    BUSINESS_PARTNER: OneToOneLink<
      PurchaseInvoices<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = PurchaseInvoices;

  requestBuilder(): PurchaseInvoicesRequestBuilder<DeSerializersT> {
    return new PurchaseInvoicesRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<PurchaseInvoices<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  ): CustomField<PurchaseInvoices<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _fieldBuilder?: FieldBuilder<typeof PurchaseInvoices, DeSerializersT>;
  get fieldBuilder() {
  ...
  private _schema?: {
    DOC_ENTRY: OrderableEdmTypeField<
      PurchaseInvoices<DeSerializers>,
      DeSerializersT,
      'Edm.Int32',
      false,
      true
    ...
    POS_DAILY_SUMMARY: OneToOneLink<
      ...
      PosDailySummaryApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<PurchaseInvoices<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', PurchaseInvoices)
      };
    }
