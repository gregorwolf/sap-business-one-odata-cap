...
> implements EntityApi<DeliveryNotes<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new DeliveryNotesApi(deSerializers);
  }
  ...
  entityConstructor = DeliveryNotes;

  requestBuilder(): DeliveryNotesRequestBuilder<DeSerializersT> {
    return new DeliveryNotesRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<DeliveryNotes<DeSerializersT>, DeSerializersT>(this);
  }

  customField<NullableT extends boolean = false>(
    fieldName: string,
    isNullable: NullableT = false as NullableT
  ): CustomField<DeliveryNotes<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _fieldBuilder?: FieldBuilder<typeof DeliveryNotes, DeSerializersT>;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(DeliveryNotes, this.deSerializers);
    }
  ...
  private _schema?: {
    ...
    POS_DAILY_SUMMARY: OneToOneLink<
      ...
      PosDailySummaryApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<DeliveryNotes<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', DeliveryNotes)
      };
    }
