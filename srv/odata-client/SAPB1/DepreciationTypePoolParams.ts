 ...
 */
export class DepreciationTypePoolParamsField<
...
> {
  ...
  /**
   * Representation of the {@link DepreciationTypePoolParams.code} property for query construction.
  ...
  /**
   * Representation of the {@link DepreciationTypePoolParams.description} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
