 ...
 */
export class EcmCodeParamsField<
...
> {
  ...
  /**
   * Representation of the {@link EcmCodeParams.absEntry} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, EcmCodeParams, fieldOptions);
  }
}
