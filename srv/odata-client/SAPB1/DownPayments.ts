...
import type { DownPaymentsApi } from './DownPaymentsApi';
 ...
 */
export class DownPayments<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements DownPaymentsType<T>
{
  /**
   * Technical entity name for DownPayments.
   */
  static _entityName = 'DownPayments';
  /**
  ...
  constructor(readonly _entityApi: DownPaymentsApi<T>) {
    super(_entityApi);
  }
}
