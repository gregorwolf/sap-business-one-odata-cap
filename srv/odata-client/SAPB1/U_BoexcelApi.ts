...
import { U_BoexcelRequestBuilder } from './U_BoexcelRequestBuilder';
import {
  CustomField,
...
export class U_BoexcelApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<U_Boexcel<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): U_BoexcelApi<DeSerializersT> {
    return new U_BoexcelApi(deSerializers);
  }
  ...
  entityConstructor = U_Boexcel;

  requestBuilder(): U_BoexcelRequestBuilder<DeSerializersT> {
    return new U_BoexcelRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<
    U_Boexcel<DeSerializersT>,
    DeSerializersT
  > {
    return entityBuilder<U_Boexcel<DeSerializersT>, DeSerializersT>(this);
  }

  customField<NullableT extends boolean = false>(
    fieldName: string,
    isNullable: NullableT = false as NullableT
  ): CustomField<U_Boexcel<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _fieldBuilder?: FieldBuilder<typeof U_Boexcel, DeSerializersT>;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(U_Boexcel, this.deSerializers);
    }
  ...
  private _schema?: {
    ...
    U_REM_UNIT: OrderableEdmTypeField<
      ...
      true
    >;
    ALL_FIELDS: AllFields<U_Boexcel<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', U_Boexcel)
      };
    }
