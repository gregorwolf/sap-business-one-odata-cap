...
export class PurchaseDownPaymentsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<PurchaseDownPayments<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new PurchaseDownPaymentsApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    BUSINESS_PARTNER: OneToOneLink<
      PurchaseDownPayments<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = PurchaseDownPayments;

  requestBuilder(): PurchaseDownPaymentsRequestBuilder<DeSerializersT> {
    return new PurchaseDownPaymentsRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<PurchaseDownPayments<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    DOC_ENTRY: OrderableEdmTypeField<
      PurchaseDownPayments<DeSerializers>,
      DeSerializersT,
      'Edm.Int32',
      false,
      true
    ...
    POS_DAILY_SUMMARY: OneToOneLink<
      ...
      PosDailySummaryApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<PurchaseDownPayments<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', PurchaseDownPayments)
      };
    }
