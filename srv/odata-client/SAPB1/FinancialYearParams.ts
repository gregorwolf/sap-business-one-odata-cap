 ...
 */
export class FinancialYearParamsField<
...
> {
  ...
  /**
   * Representation of the {@link FinancialYearParams.absEntry} property for query construction.
  ...
  /**
   * Representation of the {@link FinancialYearParams.code} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link FinancialYearParams.description} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, FinancialYearParams, fieldOptions);
  }
}
...
export namespace FinancialYearParams {
   ...
   */
  export const _propertyMetadata: PropertyMetadata<FinancialYearParams>[] = [
    {
