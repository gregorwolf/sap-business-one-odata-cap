 ...
 */
export class DunningTermParamsField<
...
> {
  ...
  /**
   * Representation of the {@link DunningTermParams.code} property for query construction.
  ...
  /**
   * Representation of the {@link DunningTermParams.name} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, DunningTermParams, fieldOptions);
  }
}
