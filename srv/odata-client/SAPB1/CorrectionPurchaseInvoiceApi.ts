...
export class CorrectionPurchaseInvoiceApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<CorrectionPurchaseInvoice<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new CorrectionPurchaseInvoiceApi(deSerializers);
  }
  ...
  entityConstructor = CorrectionPurchaseInvoice;

  requestBuilder(): CorrectionPurchaseInvoiceRequestBuilder<DeSerializersT> {
    return new CorrectionPurchaseInvoiceRequestBuilder<DeSerializersT>(this);
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof CorrectionPurchaseInvoice,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DOC_ENTRY: OrderableEdmTypeField<
      CorrectionPurchaseInvoice<DeSerializers>,
      DeSerializersT,
      'Edm.Int32',
      false,
      true
    ...
    POS_DAILY_SUMMARY: OneToOneLink<
      ...
      PosDailySummaryApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<CorrectionPurchaseInvoice<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', CorrectionPurchaseInvoice)
      };
    }
