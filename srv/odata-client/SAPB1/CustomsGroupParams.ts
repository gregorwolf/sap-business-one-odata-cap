 ...
 */
export class CustomsGroupParamsField<
...
> {
  ...
  /**
   * Representation of the {@link CustomsGroupParams.code} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, CustomsGroupParams, fieldOptions);
  }
}
