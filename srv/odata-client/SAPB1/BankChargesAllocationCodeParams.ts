 ...
 */
export class BankChargesAllocationCodeParamsField<
...
> {
  ...
  /**
   * Representation of the {@link BankChargesAllocationCodeParams.code} property for query construction.
  ...
  /**
   * Representation of the {@link BankChargesAllocationCodeParams.description} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
