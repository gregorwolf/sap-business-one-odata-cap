 ...
 */
export class LandedCostParamsField<
...
> {
  ...
  /**
   * Representation of the {@link LandedCostParams.docEntry} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, LandedCostParams, fieldOptions);
  }
}
