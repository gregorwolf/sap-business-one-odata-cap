 ...
 */
export class PmTimeSheetParamsField<
...
> {
  ...
  /**
   * Representation of the {@link PmTimeSheetParams.absEntry} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, PmTimeSheetParams, fieldOptions);
  }
}
