...
import type { ReturnRequestApi } from './ReturnRequestApi';
 ...
 */
export class ReturnRequest<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements ReturnRequestType<T>
{
  /**
  ...
  constructor(readonly _entityApi: ReturnRequestApi<T>) {
    super(_entityApi);
  }
}
