 ...
 */
export class FixedAssetValuesParamsField<
...
> {
  ...
  /**
   * Representation of the {@link FixedAssetValuesParams.itemCode} property for query construction.
  ...
  /**
   * Representation of the {@link FixedAssetValuesParams.fiscalYear} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link FixedAssetValuesParams.depreciationArea} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
