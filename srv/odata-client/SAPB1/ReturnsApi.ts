...
> implements EntityApi<Returns<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new ReturnsApi(deSerializers);
  }
  ...
  entityConstructor = Returns;

  requestBuilder(): ReturnsRequestBuilder<DeSerializersT> {
    return new ReturnsRequestBuilder<DeSerializersT>(this);
  }

  entityBuilder(): EntityBuilderType<Returns<DeSerializersT>, DeSerializersT> {
    return entityBuilder<Returns<DeSerializersT>, DeSerializersT>(this);
  }

  customField<NullableT extends boolean = false>(
    fieldName: string,
    isNullable: NullableT = false as NullableT
  ): CustomField<Returns<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _fieldBuilder?: FieldBuilder<typeof Returns, DeSerializersT>;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(Returns, this.deSerializers);
    }
  ...
  private _schema?: {
    ...
    POS_DAILY_SUMMARY: OneToOneLink<
      ...
      PosDailySummaryApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<Returns<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', Returns)
      };
    }
