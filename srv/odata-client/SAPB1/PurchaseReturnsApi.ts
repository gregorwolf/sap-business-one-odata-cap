...
> implements EntityApi<PurchaseReturns<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new PurchaseReturnsApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    BUSINESS_PARTNER: OneToOneLink<
      PurchaseReturns<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = PurchaseReturns;

  requestBuilder(): PurchaseReturnsRequestBuilder<DeSerializersT> {
    return new PurchaseReturnsRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<PurchaseReturns<DeSerializersT>, DeSerializersT>(this);
  }

  customField<NullableT extends boolean = false>(
    fieldName: string,
    isNullable: NullableT = false as NullableT
  ): CustomField<PurchaseReturns<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _fieldBuilder?: FieldBuilder<typeof PurchaseReturns, DeSerializersT>;
  get fieldBuilder() {
  ...
  private _schema?: {
    ...
    POS_DAILY_SUMMARY: OneToOneLink<
      ...
      PosDailySummaryApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<PurchaseReturns<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', PurchaseReturns)
      };
    }
