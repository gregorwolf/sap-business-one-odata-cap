 ...
 */
export class DepreciationAreaParamsField<
...
> {
  ...
  /**
   * Representation of the {@link DepreciationAreaParams.code} property for query construction.
  ...
  /**
   * Representation of the {@link DepreciationAreaParams.description} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
