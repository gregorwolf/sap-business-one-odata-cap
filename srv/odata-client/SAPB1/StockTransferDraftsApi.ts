...
export class StockTransferDraftsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<StockTransferDrafts<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new StockTransferDraftsApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    BUSINESS_PARTNER: OneToOneLink<
      StockTransferDrafts<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = StockTransferDrafts;

  requestBuilder(): StockTransferDraftsRequestBuilder<DeSerializersT> {
    return new StockTransferDraftsRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<StockTransferDrafts<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    DOC_ENTRY: OrderableEdmTypeField<
      StockTransferDrafts<DeSerializers>,
      DeSerializersT,
      'Edm.Int32',
      false,
      true
    ...
    BUSINESS_PLACE: OneToOneLink<
      ...
      BusinessPlacesApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<StockTransferDrafts<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', StockTransferDrafts)
      };
    }
