...
import type { AssetCapitalizationApi } from './AssetCapitalizationApi';
 ...
 */
export class AssetCapitalization<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements AssetCapitalizationType<T>
{
  /**
  ...
  constructor(readonly _entityApi: AssetCapitalizationApi<T>) {
    super(_entityApi);
  }
}
