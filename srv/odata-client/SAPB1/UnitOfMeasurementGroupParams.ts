 ...
 */
export class UnitOfMeasurementGroupParamsField<
...
> {
  ...
  /**
   * Representation of the {@link UnitOfMeasurementGroupParams.absEntry} property for query construction.
  ...
  /**
   * Representation of the {@link UnitOfMeasurementGroupParams.code} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
