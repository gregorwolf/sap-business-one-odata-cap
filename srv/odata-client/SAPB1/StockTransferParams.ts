 ...
 */
export class StockTransferParamsField<
...
> {
  ...
  /**
   * Representation of the {@link StockTransferParams.docEntry} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, StockTransferParams, fieldOptions);
  }
}
