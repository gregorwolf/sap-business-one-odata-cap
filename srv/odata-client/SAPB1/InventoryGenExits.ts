...
import type { InventoryGenExitsApi } from './InventoryGenExitsApi';
 ...
 */
export class InventoryGenExits<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements InventoryGenExitsType<T>
{
  /**
   * Technical entity name for InventoryGenExits.
   */
  static _entityName = 'InventoryGenExits';
  /**
  ...
  constructor(readonly _entityApi: InventoryGenExitsApi<T>) {
    super(_entityApi);
  }
}
