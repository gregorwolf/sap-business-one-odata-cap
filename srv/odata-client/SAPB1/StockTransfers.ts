...
import type { StockTransfersApi } from './StockTransfersApi';
 ...
 */
export class StockTransfers<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements StockTransfersType<T>
{
  /**
  ...
  constructor(readonly _entityApi: StockTransfersApi<T>) {
    super(_entityApi);
  }
}
