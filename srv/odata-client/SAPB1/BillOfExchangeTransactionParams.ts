...
> {
   ...
   * @nullable
   */
  boeTransactionkey?: DeserializedType<DeSerializersT, 'Edm.Int32'>;
}
 ...
 */
export class BillOfExchangeTransactionParamsField<
...
> {
  ...
  /**
   * Representation of the {@link BillOfExchangeTransactionParams.boeTransactionkey} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  boeTransactionkey: OrderableEdmTypeField<
    EntityT,
    DeSerializersT,
    'Edm.Int32',
    true,
