...
import type { U_Ba_Odrn3Api } from './U_Ba_Odrn3Api';

/**
 * This class represents the entity "U_BA_ODRN3" of service "SAPB1".
 */
export class U_Ba_Odrn3<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements U_Ba_Odrn3Type<T>
{
  /**
   * Technical entity name for U_Ba_Odrn3.
   */
  static _entityName = 'U_BA_ODRN3';
  /**
   * Default url path for the according service.
   */
  static _defaultBasePath = '/';
  /**
   * All key fields of the U_Ba_Odrn3 entity
   */
  static _keys = ['Code'];
  /**
   * Code.
  ...
  constructor(readonly _entityApi: U_Ba_Odrn3Api<T>) {
    super(_entityApi);
  }
}

export interface U_Ba_Odrn3Type<
