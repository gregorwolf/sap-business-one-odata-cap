...
export class PurchaseCreditNotesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<PurchaseCreditNotes<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new PurchaseCreditNotesApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    BUSINESS_PARTNER: OneToOneLink<
      PurchaseCreditNotes<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = PurchaseCreditNotes;

  requestBuilder(): PurchaseCreditNotesRequestBuilder<DeSerializersT> {
    return new PurchaseCreditNotesRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<PurchaseCreditNotes<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    DOC_ENTRY: OrderableEdmTypeField<
      PurchaseCreditNotes<DeSerializers>,
      DeSerializersT,
      'Edm.Int32',
      false,
      true
    ...
    POS_DAILY_SUMMARY: OneToOneLink<
      ...
      PosDailySummaryApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<PurchaseCreditNotes<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', PurchaseCreditNotes)
      };
    }
