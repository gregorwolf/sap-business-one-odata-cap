...
import type { DeliveryNotesApi } from './DeliveryNotesApi';
 ...
 */
export class DeliveryNotes<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements DeliveryNotesType<T>
{
  /**
  ...
  constructor(readonly _entityApi: DeliveryNotesApi<T>) {
    super(_entityApi);
  }
}
