...
> {
   ...
   * @nullable
   */
  positionId?: DeserializedType<DeSerializersT, 'Edm.Int32'>;
  /**
   * Name.
   * @nullable
   */
 ...
 */
export class EmployeePositionParamsField<
...
> {
  ...
  /**
   * Representation of the {@link EmployeePositionParams.positionId} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  positionId: OrderableEdmTypeField<
    EntityT,
    DeSerializersT,
    'Edm.Int32',
    true,
    false
  > = this._fieldBuilder.buildEdmTypeField('PositionID', 'Edm.Int32', true);
  /**
   * Representation of the {@link EmployeePositionParams.name} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link EmployeePositionParams.description} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
