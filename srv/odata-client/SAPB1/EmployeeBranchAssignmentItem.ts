 ...
 */
export class EmployeeBranchAssignmentItemField<
...
> {
  ...
  /**
   * Representation of the {@link EmployeeBranchAssignmentItem.employeeId} property for query construction.
  ...
  /**
   * Representation of the {@link EmployeeBranchAssignmentItem.bplid} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
