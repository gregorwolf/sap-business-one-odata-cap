 ...
 */
export class AssetDepreciationGroupParamsField<
...
> {
  ...
  /**
   * Representation of the {@link AssetDepreciationGroupParams.code} property for query construction.
  ...
  /**
   * Representation of the {@link AssetDepreciationGroupParams.description} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
