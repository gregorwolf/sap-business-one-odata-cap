...
import type { ShippingTypesApi } from './ShippingTypesApi';
 ...
 */
export class ShippingTypes<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements ShippingTypesType<T>
{
  /**
  ...
  constructor(readonly _entityApi: ShippingTypesApi<T>) {
    super(_entityApi);
  }
}
