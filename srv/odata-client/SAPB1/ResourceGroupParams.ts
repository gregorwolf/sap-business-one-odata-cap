 ...
 */
export class ResourceGroupParamsField<
...
> {
  ...
  /**
   * Representation of the {@link ResourceGroupParams.code} property for query construction.
  ...
  /**
   * Representation of the {@link ResourceGroupParams.name} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, ResourceGroupParams, fieldOptions);
  }
}
