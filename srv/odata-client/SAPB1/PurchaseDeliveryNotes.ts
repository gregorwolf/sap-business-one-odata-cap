...
import type { PurchaseDeliveryNotesApi } from './PurchaseDeliveryNotesApi';
 ...
 */
export class PurchaseDeliveryNotes<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements PurchaseDeliveryNotesType<T>
{
  /**
  ...
  /**
   * One-to-one navigation property to the {@link LandedCosts} entity.
   */
  landedCost?: LandedCosts<T> | null;
  /**
  ...
  constructor(readonly _entityApi: PurchaseDeliveryNotesApi<T>) {
    super(_entityApi);
  }
}
...
> {
  ...
  landedCost?: LandedCostsType<T> | null;
