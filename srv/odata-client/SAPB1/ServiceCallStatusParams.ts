 ...
 */
export class ServiceCallStatusParamsField<
...
> {
  ...
  /**
   * Representation of the {@link ServiceCallStatusParams.statusId} property for query construction.
  ...
  /**
   * Representation of the {@link ServiceCallStatusParams.name} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
