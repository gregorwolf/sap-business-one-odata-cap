...
> {
   ...
   * @nullable
   */
  warehouseSublevel?: DeserializedType<DeSerializersT, 'Edm.Int32'>;
  /**
   * Code.
   * @nullable
   */
 ...
 */
export class WarehouseSublevelCodeParamsField<
...
> {
  ...
  /**
   * Representation of the {@link WarehouseSublevelCodeParams.absEntry} property for query construction.
  ...
  /**
   * Representation of the {@link WarehouseSublevelCodeParams.warehouseSublevel} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  warehouseSublevel: OrderableEdmTypeField<
    EntityT,
    DeSerializersT,
    'Edm.Int32',
    true,
  ...
  /**
   * Representation of the {@link WarehouseSublevelCodeParams.code} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
