...
export class GoodsReturnRequestApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<GoodsReturnRequest<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new GoodsReturnRequestApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    BUSINESS_PARTNER: OneToOneLink<
      GoodsReturnRequest<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = GoodsReturnRequest;

  requestBuilder(): GoodsReturnRequestRequestBuilder<DeSerializersT> {
    return new GoodsReturnRequestRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<GoodsReturnRequest<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    DOC_ENTRY: OrderableEdmTypeField<
      GoodsReturnRequest<DeSerializers>,
      DeSerializersT,
      'Edm.Int32',
      false,
      true
    ...
    POS_DAILY_SUMMARY: OneToOneLink<
      ...
      PosDailySummaryApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<GoodsReturnRequest<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', GoodsReturnRequest)
      };
    }
