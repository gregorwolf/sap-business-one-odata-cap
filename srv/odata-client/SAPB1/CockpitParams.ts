...
> {
   ...
   * @nullable
   */
  cockpitType?: DeserializedType<DeSerializersT, 'Edm.Enum'>;
}
 ...
 */
export class CockpitParamsField<
...
> {
  ...
  /**
   * Representation of the {@link CockpitParams.absEntry} property for query construction.
  ...
  /**
   * Representation of the {@link CockpitParams.cockpitType} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  cockpitType: EnumField<
    EntityT,
    DeSerializersT,
    BoCockpitTypeEnum,
    true,
    false
  > = this._fieldBuilder.buildEnumField('CockpitType', BoCockpitTypeEnum, true);
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, CockpitParams, fieldOptions);
  }
}
