 ...
 */
export class BpPriorityParamsField<
...
> {
  ...
  /**
   * Representation of the {@link BpPriorityParams.priority} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, BpPriorityParams, fieldOptions);
  }
}
