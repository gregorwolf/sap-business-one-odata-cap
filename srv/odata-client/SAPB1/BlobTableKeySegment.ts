 ...
 */
export class BlobTableKeySegmentField<
...
> {
  ...
  /**
   * Representation of the {@link BlobTableKeySegment.name} property for query construction.
  ...
  /**
   * Representation of the {@link BlobTableKeySegment.value} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, BlobTableKeySegment, fieldOptions);
  }
}
