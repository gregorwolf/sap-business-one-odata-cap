 ...
 */
export class QueryCategoryParamsField<
...
> {
  ...
  /**
   * Representation of the {@link QueryCategoryParams.code} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, QueryCategoryParams, fieldOptions);
  }
}
