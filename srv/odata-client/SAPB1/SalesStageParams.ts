 ...
 */
export class SalesStageParamsField<
...
> {
  ...
  /**
   * Representation of the {@link SalesStageParams.sequenceNo} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, SalesStageParams, fieldOptions);
  }
}
