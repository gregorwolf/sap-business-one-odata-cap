...
import type { PurchaseQuotationsApi } from './PurchaseQuotationsApi';
 ...
 */
export class PurchaseQuotations<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements PurchaseQuotationsType<T>
{
  /**
  ...
  constructor(readonly _entityApi: PurchaseQuotationsApi<T>) {
    super(_entityApi);
  }
}
