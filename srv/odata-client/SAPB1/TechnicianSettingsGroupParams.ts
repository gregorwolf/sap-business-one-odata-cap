 ...
 */
export class TechnicianSettingsGroupParamsField<
...
> {
  ...
  /**
   * Representation of the {@link TechnicianSettingsGroupParams.code} property for query construction.
  ...
  /**
   * Representation of the {@link TechnicianSettingsGroupParams.name} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
