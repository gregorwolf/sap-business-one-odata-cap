...
> {
   ...
   * @nullable
   */
  divisionCode?: DeserializedType<DeSerializersT, 'Edm.Int32'>;
}
 ...
 */
export class BudgetDistributionParamsField<
...
> {
  ...
  /**
   * Representation of the {@link BudgetDistributionParams.divisionCode} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  divisionCode: OrderableEdmTypeField<
    EntityT,
    DeSerializersT,
    'Edm.Int32',
    true,
    false
  > = this._fieldBuilder.buildEdmTypeField('DivisionCode', 'Edm.Int32', true);
