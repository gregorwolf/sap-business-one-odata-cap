...
export class PaymentDraftsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<PaymentDrafts<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new PaymentDraftsApi(deSerializers);
  }
  ...
  entityConstructor = PaymentDrafts;

  requestBuilder(): PaymentDraftsRequestBuilder<DeSerializersT> {
    return new PaymentDraftsRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<PaymentDrafts<DeSerializersT>, DeSerializersT>(this);
  }

  customField<NullableT extends boolean = false>(
    fieldName: string,
    isNullable: NullableT = false as NullableT
  ): CustomField<PaymentDrafts<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _fieldBuilder?: FieldBuilder<typeof PaymentDrafts, DeSerializersT>;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(PaymentDrafts, this.deSerializers);
    }
  ...
  private _schema?: {
    ...
    ATTACHMENTS_2: OneToOneLink<
      ...
      Attachments2Api<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<PaymentDrafts<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', PaymentDrafts)
      };
    }
