...
> implements EntityApi<PurchaseOrders<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new PurchaseOrdersApi(deSerializers);
  }
  ...
  entityConstructor = PurchaseOrders;

  requestBuilder(): PurchaseOrdersRequestBuilder<DeSerializersT> {
    return new PurchaseOrdersRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<PurchaseOrders<DeSerializersT>, DeSerializersT>(this);
  }

  customField<NullableT extends boolean = false>(
    fieldName: string,
    isNullable: NullableT = false as NullableT
  ): CustomField<PurchaseOrders<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _fieldBuilder?: FieldBuilder<typeof PurchaseOrders, DeSerializersT>;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(PurchaseOrders, this.deSerializers);
    }
  ...
  private _schema?: {
    ...
    POS_DAILY_SUMMARY: OneToOneLink<
      ...
      PosDailySummaryApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<PurchaseOrders<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', PurchaseOrders)
      };
    }
