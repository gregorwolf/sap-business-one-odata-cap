 ...
 */
export class ShippingTypeParamsField<
...
> {
  ...
  /**
   * Representation of the {@link ShippingTypeParams.code} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, ShippingTypeParams, fieldOptions);
  }
}
