 ...
 */
export class ActivityTypeParamsField<
...
> {
  ...
  /**
   * Representation of the {@link ActivityTypeParams.code} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, ActivityTypeParams, fieldOptions);
  }
}
