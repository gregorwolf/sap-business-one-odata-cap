...
> {
  ...
  /**
   * Representation of the {@link StateParams.code} property for query construction.
  ...
  /**
   * Representation of the {@link StateParams.country} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link StateParams.name} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, StateParams, fieldOptions);
  }
}
...
export namespace StateParams {
   ...
   */
  export const _propertyMetadata: PropertyMetadata<StateParams>[] = [
    {
      originalName: 'Code',
      name: 'code',
      type: 'Edm.String',
