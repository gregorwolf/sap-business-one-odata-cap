...
import type { GoodsReturnRequestApi } from './GoodsReturnRequestApi';
 ...
 */
export class GoodsReturnRequest<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements GoodsReturnRequestType<T>
{
  /**
  ...
  constructor(readonly _entityApi: GoodsReturnRequestApi<T>) {
    super(_entityApi);
  }
}
