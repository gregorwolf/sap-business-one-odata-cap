...
> {
   ...
   * @nullable
   */
  problemTypeId?: DeserializedType<DeSerializersT, 'Edm.Int32'>;
  /**
   * Name.
   * @nullable
   */
 ...
 */
export class ServiceCallProblemTypeParamsField<
...
> {
  ...
  /**
   * Representation of the {@link ServiceCallProblemTypeParams.problemTypeId} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  problemTypeId: OrderableEdmTypeField<
    EntityT,
    DeSerializersT,
    'Edm.Int32',
    true,
    false
  > = this._fieldBuilder.buildEdmTypeField('ProblemTypeID', 'Edm.Int32', true);
  /**
   * Representation of the {@link ServiceCallProblemTypeParams.name} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
