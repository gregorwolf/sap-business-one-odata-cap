 ...
 */
export class PmsWorkOrderDataField<
...
> {
  ...
  /**
   * Representation of the {@link PmsWorkOrderData.lineId} property for query construction.
  ...
  /**
   * Representation of the {@link PmsWorkOrderData.stageId} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link PmsWorkOrderData.docNumber} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link PmsWorkOrderData.docEntry} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, PmsWorkOrderData, fieldOptions);
  }
}
