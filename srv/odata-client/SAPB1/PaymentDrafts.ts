...
import type { PaymentDraftsApi } from './PaymentDraftsApi';
 ...
 */
export class PaymentDrafts<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements PaymentDraftsType<T>
{
  /**
  ...
  constructor(readonly _entityApi: PaymentDraftsApi<T>) {
    super(_entityApi);
  }
}
