 ...
 */
export class CreditLineParamsField<
...
> {
  ...
  /**
   * Representation of the {@link CreditLineParams.absId} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, CreditLineParams, fieldOptions);
  }
}
