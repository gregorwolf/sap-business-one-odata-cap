...
import type { CorrectionPurchaseInvoiceReversalApi } from './CorrectionPurchaseInvoiceReversalApi';
 ...
 */
export class CorrectionPurchaseInvoiceReversal<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements CorrectionPurchaseInvoiceReversalType<T>
{
  /**
  ...
  constructor(readonly _entityApi: CorrectionPurchaseInvoiceReversalApi<T>) {
    super(_entityApi);
  }
}
