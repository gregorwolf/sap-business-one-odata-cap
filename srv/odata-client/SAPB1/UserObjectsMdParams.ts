 ...
 */
export class UserObjectsMdParamsField<
...
> {
  ...
  /**
   * Representation of the {@link UserObjectsMdParams.code} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, UserObjectsMdParams, fieldOptions);
  }
}
