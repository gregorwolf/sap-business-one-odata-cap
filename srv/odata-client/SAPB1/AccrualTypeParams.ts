 ...
 */
export class AccrualTypeParamsField<
...
> {
  ...
  /**
   * Representation of the {@link AccrualTypeParams.code} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, AccrualTypeParams, fieldOptions);
  }
}
