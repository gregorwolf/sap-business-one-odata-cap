...
> {
   ...
   * @nullable
   */
  attribute?: DeserializedType<DeSerializersT, 'Edm.Int32'>;
  /**
   * Code.
   * @nullable
   */
 ...
 */
export class BinLocationAttributeParamsField<
...
> {
  ...
  /**
   * Representation of the {@link BinLocationAttributeParams.absEntry} property for query construction.
  ...
  /**
   * Representation of the {@link BinLocationAttributeParams.attribute} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  attribute: OrderableEdmTypeField<
    ...
    true,
    false
  > = this._fieldBuilder.buildEdmTypeField('Attribute', 'Edm.Int32', true);
  /**
   * Representation of the {@link BinLocationAttributeParams.code} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
