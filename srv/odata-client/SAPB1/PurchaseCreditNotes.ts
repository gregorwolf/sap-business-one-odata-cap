...
import type { PurchaseCreditNotesApi } from './PurchaseCreditNotesApi';
 ...
 */
export class PurchaseCreditNotes<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements PurchaseCreditNotesType<T>
{
  /**
  ...
  constructor(readonly _entityApi: PurchaseCreditNotesApi<T>) {
    super(_entityApi);
  }
}
