...
export class CorrectionInvoiceReversalApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements
    EntityApi<CorrectionInvoiceReversal<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new CorrectionInvoiceReversalApi(deSerializers);
  }
  ...
  entityConstructor = CorrectionInvoiceReversal;

  requestBuilder(): CorrectionInvoiceReversalRequestBuilder<DeSerializersT> {
    return new CorrectionInvoiceReversalRequestBuilder<DeSerializersT>(this);
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof CorrectionInvoiceReversal,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DOC_ENTRY: OrderableEdmTypeField<
      CorrectionInvoiceReversal<DeSerializers>,
      DeSerializersT,
      'Edm.Int32',
      false,
      true
    ...
    POS_DAILY_SUMMARY: OneToOneLink<
      ...
      PosDailySummaryApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<CorrectionInvoiceReversal<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', CorrectionInvoiceReversal)
      };
    }
