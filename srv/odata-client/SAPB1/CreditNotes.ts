...
import type { CreditNotesApi } from './CreditNotesApi';
 ...
 */
export class CreditNotes<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements CreditNotesType<T>
{
  /**
  ...
  constructor(readonly _entityApi: CreditNotesApi<T>) {
    super(_entityApi);
  }
}
