 ...
 */
export class ValueMappingParamsField<
...
> {
  ...
  /**
   * Representation of the {@link ValueMappingParams.absEntry} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, ValueMappingParams, fieldOptions);
  }
}
