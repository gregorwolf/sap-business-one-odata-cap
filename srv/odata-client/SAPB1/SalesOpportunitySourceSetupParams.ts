 ...
 */
export class SalesOpportunitySourceSetupParamsField<
...
> {
  ...
  /**
   * Representation of the {@link SalesOpportunitySourceSetupParams.sequenceNo} property for query construction.
  ...
  /**
   * Representation of the {@link SalesOpportunitySourceSetupParams.description} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
