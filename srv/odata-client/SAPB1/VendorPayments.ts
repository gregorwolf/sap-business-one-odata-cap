...
import type { VendorPaymentsApi } from './VendorPaymentsApi';
 ...
 */
export class VendorPayments<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements VendorPaymentsType<T>
{
  /**
  ...
  constructor(readonly _entityApi: VendorPaymentsApi<T>) {
    super(_entityApi);
  }
}
