...
> implements EntityApi<PurchaseDeliveryNotes<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new PurchaseDeliveryNotesApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    >;
    /**
     * Static representation of the one-to-one navigation property {@link landedCost} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    LANDED_COST: OneToOneLink<
      PurchaseDeliveryNotes<DeSerializersT>,
      DeSerializersT,
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      ...
      LANDED_COST: new OneToOneLink('LandedCost', this, linkedApis[5]),
      ...
      JOURNAL_ENTRY: new OneToOneLink('JournalEntry', this, linkedApis[8]),
      FORMS_1099: new OneToOneLink('Forms1099', this, linkedApis[9]),
      WIZARD_PAYMENT_METHOD: new OneToOneLink(
        'WizardPaymentMethod',
        this,
        linkedApis[10]
      ),
      PAYMENT_BLOCK_2: new OneToOneLink('PaymentBlock2', this, linkedApis[11]),
      PROJECT_2: new OneToOneLink('Project2', this, linkedApis[12]),
      EMPLOYEE_INFO: new OneToOneLink('EmployeeInfo', this, linkedApis[13]),
      COUNTRY: new OneToOneLink('Country', this, linkedApis[14]),
      BUSINESS_PLACE: new OneToOneLink('BusinessPlace', this, linkedApis[15]),
      USER_LANGUAGE: new OneToOneLink('UserLanguage', this, linkedApis[16]),
      NF_MODEL: new OneToOneLink('NFModel', this, linkedApis[17]),
      CHART_OF_ACCOUNT: new OneToOneLink(
        'ChartOfAccount',
        this,
        linkedApis[18]
      ),
      TAX_WEB_SITE: new OneToOneLink('TaxWebSite', this, linkedApis[19]),
      BRANCH: new OneToOneLink('Branch', this, linkedApis[20]),
      DEPARTMENT: new OneToOneLink('Department', this, linkedApis[21]),
  ...
  entityConstructor = PurchaseDeliveryNotes;

  requestBuilder(): PurchaseDeliveryNotesRequestBuilder<DeSerializersT> {
    return new PurchaseDeliveryNotesRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<PurchaseDeliveryNotes<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    DOC_ENTRY: OrderableEdmTypeField<
      PurchaseDeliveryNotes<DeSerializers>,
      DeSerializersT,
      'Edm.Int32',
      false,
      true
    ...
    POS_DAILY_SUMMARY: OneToOneLink<
      ...
      PosDailySummaryApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<PurchaseDeliveryNotes<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', PurchaseDeliveryNotes)
      };
    }
