...
import type { SalesOpportunityInterestsSetupApi } from './SalesOpportunityInterestsSetupApi';
import {
  SalesOpportunities,
 ...
 */
export class SalesOpportunityInterestsSetup<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements SalesOpportunityInterestsSetupType<T>
{
  /**
  ...
  constructor(readonly _entityApi: SalesOpportunityInterestsSetupApi<T>) {
    super(_entityApi);
  }
}
