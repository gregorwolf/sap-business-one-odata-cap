...
> {
   ...
   * @nullable
   */
  webSiteName?: DeserializedType<DeSerializersT, 'Edm.String'>;
}
 ...
 */
export class TaxWebSiteParamsField<
...
> {
  ...
  /**
   * Representation of the {@link TaxWebSiteParams.absEntry} property for query construction.
  ...
  /**
   * Representation of the {@link TaxWebSiteParams.webSiteName} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  webSiteName: OrderableEdmTypeField<
    EntityT,
    DeSerializersT,
    'Edm.String',
    true,
    false
  > = this._fieldBuilder.buildEdmTypeField('WebSiteName', 'Edm.String', true);
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, TaxWebSiteParams, fieldOptions);
  }
}
