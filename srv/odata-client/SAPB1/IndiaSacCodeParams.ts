 ...
 */
export class IndiaSacCodeParamsField<
...
> {
  ...
  /**
   * Representation of the {@link IndiaSacCodeParams.absEntry} property for query construction.
  ...
  /**
   * Representation of the {@link IndiaSacCodeParams.serviceCode} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, IndiaSacCodeParams, fieldOptions);
  }
}
