...
import type { PurchaseRequestsApi } from './PurchaseRequestsApi';
 ...
 */
export class PurchaseRequests<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements PurchaseRequestsType<T>
{
  /**
  ...
  constructor(readonly _entityApi: PurchaseRequestsApi<T>) {
    super(_entityApi);
  }
}
