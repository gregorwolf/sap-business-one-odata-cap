...
export class CorrectionPurchaseInvoiceReversalApi<
    ...
    >
{
  ...
  >(
    ...
    return new CorrectionPurchaseInvoiceReversalApi(deSerializers);
  }
  ...
  entityConstructor = CorrectionPurchaseInvoiceReversal;

  requestBuilder(): CorrectionPurchaseInvoiceReversalRequestBuilder<DeSerializersT> {
    return new CorrectionPurchaseInvoiceReversalRequestBuilder<DeSerializersT>(
      this
    );
  }
  ...
  private _fieldBuilder?: FieldBuilder<
    typeof CorrectionPurchaseInvoiceReversal,
    DeSerializersT
  >;
  get fieldBuilder() {
  ...
  private _schema?: {
    DOC_ENTRY: OrderableEdmTypeField<
      CorrectionPurchaseInvoiceReversal<DeSerializers>,
      DeSerializersT,
      'Edm.Int32',
      false,
      true
    ...
    POS_DAILY_SUMMARY: OneToOneLink<
      ...
      PosDailySummaryApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<CorrectionPurchaseInvoiceReversal<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', CorrectionPurchaseInvoiceReversal)
      };
    }
