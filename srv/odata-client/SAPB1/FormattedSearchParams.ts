 ...
 */
export class FormattedSearchParamsField<
...
> {
  ...
  /**
   * Representation of the {@link FormattedSearchParams.index} property for query construction.
  ...
  index: OrderableEdmTypeField<
    ...
    true,
    false
  > = this._fieldBuilder.buildEdmTypeField('Index', 'Edm.Int32', true);
