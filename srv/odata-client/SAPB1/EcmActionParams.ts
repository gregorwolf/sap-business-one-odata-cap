 ...
 */
export class EcmActionParamsField<
...
> {
  ...
  /**
   * Representation of the {@link EcmActionParams.actionId} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, EcmActionParams, fieldOptions);
  }
}
