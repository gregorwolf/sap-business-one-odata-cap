 ...
 */
export class ValidValueMdField<
...
> {
  ...
  /**
   * Representation of the {@link ValidValueMd.value} property for query construction.
  ...
  /**
   * Representation of the {@link ValidValueMd.description} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, ValidValueMd, fieldOptions);
  }
}
