...
export class InventoryGenEntriesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<InventoryGenEntries<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new InventoryGenEntriesApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    BUSINESS_PARTNER: OneToOneLink<
      InventoryGenEntries<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = InventoryGenEntries;

  requestBuilder(): InventoryGenEntriesRequestBuilder<DeSerializersT> {
    return new InventoryGenEntriesRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<InventoryGenEntries<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    DOC_ENTRY: OrderableEdmTypeField<
      InventoryGenEntries<DeSerializers>,
      DeSerializersT,
      'Edm.Int32',
      false,
      true
    ...
    POS_DAILY_SUMMARY: OneToOneLink<
      ...
      PosDailySummaryApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<InventoryGenEntries<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', InventoryGenEntries)
      };
    }
