 ...
 */
export class PaymentParamsField<
...
> {
  ...
  /**
   * Representation of the {@link PaymentParams.docEntry} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, PaymentParams, fieldOptions);
  }
}
