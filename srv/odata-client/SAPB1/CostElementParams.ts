 ...
 */
export class CostElementParamsField<
...
> {
  ...
  /**
   * Representation of the {@link CostElementParams.code} property for query construction.
  ...
  /**
   * Representation of the {@link CostElementParams.description} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, CostElementParams, fieldOptions);
  }
}
...
export namespace CostElementParams {
   ...
   */
  export const _propertyMetadata: PropertyMetadata<CostElementParams>[] = [
    {
      originalName: 'Code',
      name: 'code',
      type: 'Edm.String',
