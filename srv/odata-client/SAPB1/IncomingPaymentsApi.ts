...
export class IncomingPaymentsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<IncomingPayments<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new IncomingPaymentsApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    CHART_OF_ACCOUNT: OneToOneLink<
      IncomingPayments<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = IncomingPayments;

  requestBuilder(): IncomingPaymentsRequestBuilder<DeSerializersT> {
    return new IncomingPaymentsRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<IncomingPayments<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  ): CustomField<IncomingPayments<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _fieldBuilder?: FieldBuilder<typeof IncomingPayments, DeSerializersT>;
  get fieldBuilder() {
  ...
  private _schema?: {
    DOC_NUM: OrderableEdmTypeField<
      IncomingPayments<DeSerializers>,
      DeSerializersT,
      'Edm.Int32',
      true,
      true
    ...
    ATTACHMENTS_2: OneToOneLink<
      ...
      Attachments2Api<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<IncomingPayments<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', IncomingPayments)
      };
    }
