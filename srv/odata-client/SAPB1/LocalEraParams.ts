 ...
 */
export class LocalEraParamsField<
...
> {
  ...
  /**
   * Representation of the {@link LocalEraParams.code} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, LocalEraParams, fieldOptions);
  }
}
