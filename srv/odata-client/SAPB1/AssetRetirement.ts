...
import type { AssetRetirementApi } from './AssetRetirementApi';
 ...
 */
export class AssetRetirement<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements AssetRetirementType<T>
{
  /**
  ...
  constructor(readonly _entityApi: AssetRetirementApi<T>) {
    super(_entityApi);
  }
}
