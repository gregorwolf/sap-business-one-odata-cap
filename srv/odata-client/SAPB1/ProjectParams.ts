 ...
 */
export class ProjectParamsField<
...
> {
  ...
  /**
   * Representation of the {@link ProjectParams.code} property for query construction.
  ...
  /**
   * Representation of the {@link ProjectParams.name} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, ProjectParams, fieldOptions);
  }
}
...
export namespace ProjectParams {
   ...
   */
  export const _propertyMetadata: PropertyMetadata<ProjectParams>[] = [
    {
      originalName: 'Code',
      name: 'code',
      type: 'Edm.String',
