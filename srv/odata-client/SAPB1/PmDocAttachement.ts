 ...
 */
export class PmDocAttachementField<
...
> {
  ...
  /**
   * Representation of the {@link PmDocAttachement.absEntry} property for query construction.
  ...
  /**
   * Representation of the {@link PmDocAttachement.lineId} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link PmDocAttachement.sourcePath} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link PmDocAttachement.fileName} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link PmDocAttachement.fileExtension} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link PmDocAttachement.attachementDate} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, PmDocAttachement, fieldOptions);
  }
}
