 ...
 */
export class TransactionCodeParamsField<
...
> {
  ...
  /**
   * Representation of the {@link TransactionCodeParams.code} property for query construction.
  ...
  /**
   * Representation of the {@link TransactionCodeParams.description} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
