...
import type { StockTransferDraftsApi } from './StockTransferDraftsApi';
 ...
 */
export class StockTransferDrafts<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements StockTransferDraftsType<T>
{
  /**
  ...
  constructor(readonly _entityApi: StockTransferDraftsApi<T>) {
    super(_entityApi);
  }
}
