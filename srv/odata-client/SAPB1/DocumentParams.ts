 ...
 */
export class DocumentParamsField<
...
> {
  ...
  /**
   * Representation of the {@link DocumentParams.docEntry} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, DocumentParams, fieldOptions);
  }
}
