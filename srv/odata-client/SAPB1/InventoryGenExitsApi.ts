...
export class InventoryGenExitsApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<InventoryGenExits<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new InventoryGenExitsApi(deSerializers);
  }
  ...
  private navigationPropertyFields!: {
    ...
    BUSINESS_PARTNER: OneToOneLink<
      InventoryGenExits<DeSerializersT>,
      DeSerializersT,
  ...
  entityConstructor = InventoryGenExits;

  requestBuilder(): InventoryGenExitsRequestBuilder<DeSerializersT> {
    return new InventoryGenExitsRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<InventoryGenExits<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  ): CustomField<InventoryGenExits<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _schema?: {
    DOC_ENTRY: OrderableEdmTypeField<
      InventoryGenExits<DeSerializers>,
      DeSerializersT,
      'Edm.Int32',
      false,
      true
    ...
    POS_DAILY_SUMMARY: OneToOneLink<
      ...
      PosDailySummaryApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<InventoryGenExits<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', InventoryGenExits)
      };
    }
