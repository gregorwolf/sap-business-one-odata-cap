...
> {
   ...
   * @nullable
   */
  instanceCount?: DeserializedType<DeSerializersT, 'Edm.Int32'>;
}
 ...
 */
export class ActivityInstancesListParamsField<
...
> {
  ...
  /**
   * Representation of the {@link ActivityInstancesListParams.startDate} property for query construction.
  ...
  /**
   * Representation of the {@link ActivityInstancesListParams.instanceCount} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  instanceCount: OrderableEdmTypeField<
    EntityT,
    DeSerializersT,
    'Edm.Int32',
    true,
    false
  > = this._fieldBuilder.buildEdmTypeField('InstanceCount', 'Edm.Int32', true);
