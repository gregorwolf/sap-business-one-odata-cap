...
import type { CorrectionPurchaseInvoiceApi } from './CorrectionPurchaseInvoiceApi';
 ...
 */
export class CorrectionPurchaseInvoice<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements CorrectionPurchaseInvoiceType<T>
{
  /**
  ...
  constructor(readonly _entityApi: CorrectionPurchaseInvoiceApi<T>) {
    super(_entityApi);
  }
}
