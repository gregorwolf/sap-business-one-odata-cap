...
> {
   ...
   * @nullable
   */
  materialGroupCode?: DeserializedType<DeSerializersT, 'Edm.String'>;
}
 ...
 */
export class MaterialGroupParamsField<
...
> {
  ...
  /**
   * Representation of the {@link MaterialGroupParams.absEntry} property for query construction.
  ...
  /**
   * Representation of the {@link MaterialGroupParams.materialGroupCode} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  materialGroupCode: OrderableEdmTypeField<
    EntityT,
    DeSerializersT,
    'Edm.String',
    true,
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, MaterialGroupParams, fieldOptions);
  }
}
