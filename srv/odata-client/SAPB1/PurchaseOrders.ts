...
import type { PurchaseOrdersApi } from './PurchaseOrdersApi';
 ...
 */
export class PurchaseOrders<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements PurchaseOrdersType<T>
{
  /**
  ...
  constructor(readonly _entityApi: PurchaseOrdersApi<T>) {
    super(_entityApi);
  }
}
