...
import type { CorrectionInvoiceApi } from './CorrectionInvoiceApi';
 ...
 */
export class CorrectionInvoice<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements CorrectionInvoiceType<T>
{
  /**
  ...
  constructor(readonly _entityApi: CorrectionInvoiceApi<T>) {
    super(_entityApi);
  }
}
