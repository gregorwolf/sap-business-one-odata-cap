 ...
 */
export class SalesTaxCodeParamsField<
...
> {
  ...
  /**
   * Representation of the {@link SalesTaxCodeParams.code} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, SalesTaxCodeParams, fieldOptions);
  }
}
