 ...
 */
export class ApprovalTemplateParamsField<
...
> {
  ...
  /**
   * Representation of the {@link ApprovalTemplateParams.code} property for query construction.
  ...
  /**
   * Representation of the {@link ApprovalTemplateParams.name} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
