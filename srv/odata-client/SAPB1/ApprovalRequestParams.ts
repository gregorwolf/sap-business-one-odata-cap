 ...
 */
export class ApprovalRequestParamsField<
...
> {
  ...
  /**
   * Representation of the {@link ApprovalRequestParams.code} property for query construction.
  ...
  /**
   * Representation of the {@link ApprovalRequestParams.remarks} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link ApprovalRequestParams.status} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  status: EnumField<
    EntityT,
