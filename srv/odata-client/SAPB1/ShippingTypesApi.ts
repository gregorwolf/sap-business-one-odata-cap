...
export class ShippingTypesApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<ShippingTypes<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    ...
    return new ShippingTypesApi(deSerializers);
  }
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      ...
      ORDERS: new OneToManyLink('Orders', this, linkedApis[8]),
      INVENTORY_GEN_EXITS: new OneToManyLink(
        'InventoryGenExits',
        this,
        linkedApis[9]
      ),
      DRAFTS: new OneToManyLink('Drafts', this, linkedApis[10]),
      ...
      INVOICES: new OneToManyLink('Invoices', this, linkedApis[15]),
      CREDIT_NOTES: new OneToManyLink('CreditNotes', this, linkedApis[16]),
      ...
      DOWN_PAYMENTS: new OneToManyLink('DownPayments', this, linkedApis[19]),
      ...
      QUOTATIONS: new OneToManyLink('Quotations', this, linkedApis[23]),
      RETURNS: new OneToManyLink('Returns', this, linkedApis[24]),
  ...
  entityConstructor = ShippingTypes;

  requestBuilder(): ShippingTypesRequestBuilder<DeSerializersT> {
    return new ShippingTypesRequestBuilder<DeSerializersT>(this);
  }
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<ShippingTypes<DeSerializersT>, DeSerializersT>(this);
  }

  customField<NullableT extends boolean = false>(
    fieldName: string,
    isNullable: NullableT = false as NullableT
  ): CustomField<ShippingTypes<DeSerializersT>, DeSerializersT, NullableT> {
  ...
  private _fieldBuilder?: FieldBuilder<typeof ShippingTypes, DeSerializersT>;
  get fieldBuilder() {
    if (!this._fieldBuilder) {
      this._fieldBuilder = new FieldBuilder(ShippingTypes, this.deSerializers);
    }
  ...
  private _schema?: {
    ...
    PURCHASE_REQUESTS: OneToManyLink<
      ...
      PurchaseRequestsApi<DeSerializersT>
    >;
    ALL_FIELDS: AllFields<ShippingTypes<DeSerializers>>;
  };
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link website} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        WEBSITE: fieldBuilder.buildEdmTypeField('Website', 'Edm.String', true),
        ...this.navigationPropertyFields,
        /**
         *
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', ShippingTypes)
      };
    }
