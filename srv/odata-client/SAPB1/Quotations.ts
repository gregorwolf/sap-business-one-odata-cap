...
import type { QuotationsApi } from './QuotationsApi';
 ...
 */
export class Quotations<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements QuotationsType<T>
{
  /**
  ...
  constructor(readonly _entityApi: QuotationsApi<T>) {
    super(_entityApi);
  }
}
