 ...
 */
export class SeriesParamsField<
...
> {
  ...
  /**
   * Representation of the {@link SeriesParams.series} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, SeriesParams, fieldOptions);
  }
}
