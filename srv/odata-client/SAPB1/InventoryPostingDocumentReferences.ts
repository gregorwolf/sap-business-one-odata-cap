 ...
 */
export interface InventoryPostingDocumentReferences<
...
/**
 * InventoryPostingDocumentReferencesField
 * @typeParam EntityT - Type of the entity the complex type field belongs to.
 */
export class InventoryPostingDocumentReferencesField<
...
> {
  ...
  /**
   * Representation of the {@link InventoryPostingDocumentReferences.docEntry} property for query construction.
  ...
  /**
   * Representation of the {@link InventoryPostingDocumentReferences.lineNumber} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link InventoryPostingDocumentReferences.referencedDocEntry} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link InventoryPostingDocumentReferences.referencedDocNumber} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link InventoryPostingDocumentReferences.externalReferencedDocNumber} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link InventoryPostingDocumentReferences.referencedObjectType} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link InventoryPostingDocumentReferences.issueDate} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link InventoryPostingDocumentReferences.remark} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Creates an instance of InventoryPostingDocumentReferencesField.
...
export namespace InventoryPostingDocumentReferences {
  /**
   * Metadata information on all properties of the `InventoryPostingDocumentReferences` complex type.
   */
  export const _propertyMetadata: PropertyMetadata<InventoryPostingDocumentReferences>[] =
    [
      {
