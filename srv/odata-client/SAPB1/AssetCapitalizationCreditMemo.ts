...
import type { AssetCapitalizationCreditMemoApi } from './AssetCapitalizationCreditMemoApi';
 ...
 */
export class AssetCapitalizationCreditMemo<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements AssetCapitalizationCreditMemoType<T>
{
  /**
  ...
  constructor(readonly _entityApi: AssetCapitalizationCreditMemoApi<T>) {
    super(_entityApi);
  }
}
