 ...
 */
export class ResourceParamsField<
...
> {
  ...
  /**
   * Representation of the {@link ResourceParams.code} property for query construction.
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, ResourceParams, fieldOptions);
  }
}
