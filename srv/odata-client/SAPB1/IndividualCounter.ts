 ...
 */
export class IndividualCounterField<
...
> {
  ...
  /**
   * Representation of the {@link IndividualCounter.documentEntry} property for query construction.
  ...
  /**
   * Representation of the {@link IndividualCounter.counterId} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link IndividualCounter.counterType} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link IndividualCounter.counterName} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link IndividualCounter.counterNumber} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  /**
   * Representation of the {@link IndividualCounter.counterVisualOrder} property for query construction.
   * Use to reference this property in query operations such as 'filter' in the fluent request API.
   */
  ...
  constructor(
    ...
    super(fieldName, fieldOf, deSerializers, IndividualCounter, fieldOptions);
  }
}
